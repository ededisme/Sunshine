<script type="text/javascript">
    $(document).ready(function(){       
        $(".btnBackPatientCertificate").click(function(event){
...
<fieldset>
    ...
    <table style="width:100% !important" class="info">
        ...
        <tr>
            ...
            <td>: <?php echo $patient['PatientIpd']['authorized_issue_date']; ?></td>        
            <th><?php __(TABLE_EXPIRATION_DATE); ?></th>
            <td>: <?php echo $patient['PatientIpd']['authorized_expiration_date'];?></td>
        </tr>
        <tr>
...
<fieldset>
    ...
    <table style="width:100% !important" class="info">        
        <tr>
            <th><?php __(TABLE_PARENT_IPD_DATE_CERTIFICATE_FROM); ?></th>
            <td>: <?php echo date("d/m/Y", strtotime($patient['PatientIpdCertificate']['date_certificate_from']));?></td>
            <th><?php __(TABLE_PARENT_IPD_DATE_CERTIFICATE_TO); ?></th>
            <td>: <?php echo date("d/m/Y", strtotime($patient['PatientIpdCertificate']['date_certificate_to']));?></td>                    
        </tr>
    </table>
</fieldset>