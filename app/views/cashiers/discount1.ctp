...
<table class="table" style="width: 100%; padding: 0px; margin: 0px; " cellspacing="0" >
    <thead>
        <tr>
    ...
    <table class="table" style="" cellspacing="0" >
        <tbody style="width: 774px; ">
            ...
            ?>">
                    ...
                    <input type="hidden" name="patientDiscountAmount" value="<?php echo $discount['Discount']['amount']; ?>" />
                    <input type="hidden" name="patientDiscountPercent" value="<?php echo $discount['Discount']['percent']; ?>" />
                </td>
