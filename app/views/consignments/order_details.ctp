<script type="text/javascript">
    ...
    function searchAllProductConsignment(){
        if($("#ConsignmentCompanyId").val() == "" || $("#ConsignmentBranchId").val() == "" || $("#ConsignmentLocationGroupId").val() == "" || $("#ConsignmentCustomerId").val() == ""){
            ...
            $.ajax({
                type:   "POST",
                url:    "<?php echo $this->base . "/consignments/product/"; ?>" + $("#ConsignmentCompanyId").val()+"/"+$("#ConsignmentLocationGroupId").val()+"/"+$("#ConsignmentBranchId").val(),
    ...
    function searchProductByCodeConsignment(productCode, uomSelected, qtyOrder){
        if($("#ConsignmentCompanyId").val() == "" || $("#ConsignmentBranchId").val() == "" || $("#ConsignmentLocationGroupId").val() == "" || $("#ConsignmentCustomerId").val() == ""){
            ...
            $.ajax({
                dataType: "json",
                type:   "POST",
                url:    "<?php echo $this->base . "/consignments/searchProductByCode"; ?>/"+$("#ConsignmentCompanyId").val()+"/"+$("#ConsignmentCustomerId").val()+"/"+$("#ConsignmentBranchId").val(),
    ...
    function getTotalQtyOrderConsignment(id){
        ...
        $("input[name='product_id[]']").each(function(){
            if($(this).val() == id){
                totalProduct += replaceNum($(this).closest("tr").find(".totalQtyOrderConsignment").val());
            }
        });
        return totalProduct;
    }
