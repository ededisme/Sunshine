...
<script type="text/javascript">
    ...
    function searchProductPR(){
        if($("#PurchaseReturnCompanyId").val()== "" || $("#PurchaseReturnBranchId").val()== "" || $("#PurchaseReturnLocationId").val()==""){
            ...
            $.ajax({
                type:   "POST",
                url:    "<?php echo $this->base . "/purchase_returns/product/"; ?>"+$("#PurchaseReturnCompanyId").val()+"/"+$("#PurchaseReturnBranchId").val()+"/"+$("#PurchaseReturnLocationId").val()+"/"+dateOrder+"/<?php echo $purchase_returns['PurchaseReturn']['id']; ?>",
                beforeSend: function(){
                    $(".loader").attr('src','<?php echo $this->webroot; ?>img/layout/spinner.gif');
                },
                success: function(msg){
    ...
    function searchProductByCodePR(productCode, expDate){
        ...
        if(companyId != '' && branchId != ''){
            $.ajax({
                type:   "POST",
                url:    "<?php echo $this->base . "/purchase_returns/searchProductByCode"; ?>/"+companyId+"/"+branchId+"/<?php echo $purchase_returns['PurchaseReturn']['id']; ?>",
    ...
    <table id="tblPurchaseReturn" class="table" cellspacing="0" style="padding: 0px; width:100%">
        ...
        if($purchaseReturnDetails){
            ...
            foreach($purchaseReturnDetails as $purchaseReturnDetail){
                // Total Current Stock
                $sqlInv = mysql_query("SELECT SUM(IFNULL(total_qty,0) - IFNULL(total_order,0)) AS total_qty FROM ".$purchase_returns['PurchaseReturn']['location_id']."_inventory_totals WHERE product_id = ".$purchaseReturnDetail['Product']['id']." AND expired_date = '".$purchaseReturnDetail['PurchaseReturnDetail']['expired_date']."'");
        ...
        ?>
        <tr id="OrderListPR" class="tblPurchaseReturnList">
            <td class="first" style="width:7%; text-align: center;padding: 0px; height: 30px;"><?php echo $i; ?></td>
            <td style="width:10%; text-align: left; padding: 5px;">
                <input type="text" class="lblSKU" value="<?php echo $purchaseReturnDetail['Product']['code']; ?>" readonly="readonly" style="width: 90%;" />
            </td>
            <td style="width:24%; text-align: center;padding: 0px;">
                <div class="inputContainer" style="width:100%;">
                    ...
                    <input type="text" id="product<?php echo $i; ?>" readonly="readonly" name="product[]" class="product validate[required]" style="width: 80%;" value="<?php echo $purchaseReturnDetail['Product']['name']; ?>" />
            ...
            <td style="width:11%; text-align: center;padding: 0px;">
                <div class="inputContainer" style="width:100%">
                    ...
                    if($purchaseReturnDetail['PurchaseReturnDetail']['expired_date'] != '' && $purchaseReturnDetail['PurchaseReturnDetail']['expired_date'] != '0000-00-00'){
                        $dateExp = dateShort($purchaseReturnDetail['PurchaseReturnDetail']['expired_date']);
                    }
                    ?>
                    <input type="text" id="expired_date<?php echo $i; ?>" name="expired_date[]" style="width:80%; <?php if($purchaseReturnDetail['Product']['is_expired_date'] == 0){ ?>visibility: hidden;<?php } ?>" class="expired_date <?php if($purchaseReturnDetail['Product']['is_expired_date'] == 1){ ?>validate[required]<?php } ?>" value="<?php echo $dateExp; ?>" />
                </div>
            </td>
            <td style="width:8%; text-align: center;padding: 0px;">
                <div class="inputContainer" style="width:100%">
                    <input type="text" id="qty_<?php echo $i; ?>" name="qty[]" value="<?php echo $purchaseReturnDetail['PurchaseReturnDetail']['qty']; ?>" style="width:80%;" class="qty validate[required,min[1]]" />
                </div>
            </td>
            <td style="width:10%; padding: 0px; text-align: center;">
                <div class="inputContainer" style="width:100%">
                    <select id="qty_uom_id<?php echo $i; ?>" style="width:80%; height: 20px;" name="qty_uom_id[]" class="qty_uom_id validate[required]" >
                        <?php
            ...
            <td style="width: 10%; padding: 0px; text-align: center;">
                <div class="inputContainer" style="width:100%">
                    <input type="hidden" class="org_price" />
                    <input type="text" id="unit_price_<?php echo $i; ?>" name="unit_price[]" value="<?php echo number_format($purchaseReturnDetail['PurchaseReturnDetail']['unit_price'],2); ?>" style="width:80%;" class="float unit_price validate[required]" />
                </div>
            </td>
            <td style="width:10%; text-align: center; padding: 0px;">
                <div class="inputContainer" style="width:100%">
                    <input type="text" id="total_price<?php echo $i; ?>" name="total_price[]" style="width:80%" class="total_price float" value="<?php echo number_format($purchaseReturnDetail['PurchaseReturnDetail']['total_price'],2); ?>" />
                </div>
            </td>
            <td style="width:10%;">
                <img alt="Remove" src="<?php echo $this->webroot . 'img/button/cross.png'; ?>" class="btnRemoveBR" align="absmiddle" style="cursor: pointer;" onmouseover="Tip('Remove')" />
        ...
        <tr id="OrderListPR" class="tblPurchaseReturnList">
            <td class="first" style="width:7%; text-align: center;padding: 0px; height: 30px;"><?php echo $i; ?></td>
            <td style="width:10%; text-align: left; padding: 5px;">
                <input type="text" class="lblSKU" value="<?php echo $purchaseReturnService['Service']['code']; ?>" readonly="readonly" style="width: 90%;" />
            </td>
            <td style="width:24%; text-align: center;padding: 0px;">
                <div class="inputContainer" style="width:100%;">
                    <input type="hidden" name="inv_qty[]" />
                    ...
                    <input type="text" id="product<?php echo $i; ?>" readonly="readonly" name="product[]" class="product validate[required]" style="width: 80%;" value="<?php echo $purchaseReturnService['Service']['code']." - ".$purchaseReturnService['Service']['name']; ?>" />
                    <img alt="Note" id="notePR<?php echo $i;?>" src="<?php echo $this->webroot . 'img/button/note.png'; ?>" class="notePR" align="absmiddle" style="cursor: pointer;" onmouseover="Tip('Note')" />
                </div>
            </td>
            <td style="width:11%; text-align: center;padding: 0px;">
            ...
            <td style="width:8%; text-align: center;padding: 0px;">
                <div class="inputContainer" style="width:100%;">
                    <input type="text" id="qty_<?php echo $i; ?>" name="qty[]" value="<?php echo $purchaseReturnService['PurchaseReturnService']['qty']; ?>" style="width:80%;" class="qty validate[required,min[1]]" />
                </div>
            </td>
            <td style="width:10%; padding: 0px; text-align: center;">
                <div class="inputContainer" style="width:100%;">
                    <select id="qty_uom_id_<?php echo $i;?>" style="width:80%; height: 20px; <?php if($uomName == 'None'){ ?>visibility: hidden;<?php } ?>" name="qty_uom_id[]" class="qty_uom_id validate[required]" >
            ...
            <td style="width:10%; padding: 0px; text-align: center;">
                <div class="inputContainer" style="width:100%;">
                    <input type="hidden" class="org_price" />
                    <input type="text" id="unit_price_<?php echo $i; ?>" name="unit_price[]" value="<?php echo number_format($purchaseReturnService['PurchaseReturnService']['unit_price'],2); ?>" style="width:80%;" class="float unit_price validate[required]" />
                </div>
            </td>
            <td style="width:10%; text-align: center; padding: 0px;">
                <div class="inputContainer" style="width:100%;">
                    <input type="text" id="total_price<?php echo $i; ?>" name="total_price[]" style="width:80%" class="total_price float" value="<?php echo number_format($purchaseReturnService['PurchaseReturnService']['total_price'],2); ?>" />
                </div>
            </td>
            <td style="width:10%;">
                <img alt="Remove" src="<?php echo $this->webroot . 'img/button/cross.png'; ?>" class="btnRemoveBR" align="absmiddle" style="cursor: pointer;" onmouseover="Tip('Remove')" />
        ...
        <tr id="OrderListPR" class="tblPurchaseReturnList">
            ...
            <td style="width:24%; text-align: center;padding: 0px;">
                <div class="inputContainer" style="width:100%;">
                    ...
                    <input type="hidden" id="total_qty_<?php echo $i; ?>" name="total_qty[]" value="0">
                    <input type="hidden" id="product_id_<?php echo $i; ?>" name="product_id[]"  />
                    <input type="hidden" id="service_id_<?php echo $i; ?>" name="service_id[]" value="" />
                    <input type="hidden" value="1" name="small_val_uom[]" class="small_val_uom" />
                    <input type="hidden" value="1" name="conversion[]" class="conversion" />
                    <input type="hidden" name="note[]" class="note" value="<?php echo $purchaseReturnMisc['PurchaseReturnMisc']['note']; ?>" />
                    <input type="text" id="product<?php echo $i; ?>" readonly="readonly" name="product[]" class="product validate[required]" style="width: 80%;" value="<?php echo $purchaseReturnMisc['PurchaseReturnMisc']['description']; ?>" />
                    <img alt="Note" id="notePR<?php echo $i;?>" src="<?php echo $this->webroot . 'img/button/note.png'; ?>" class="notePR" align="absmiddle" style="cursor: pointer;" onmouseover="Tip('Note')" />
                </div>
            </td>
            <td style="width:11%; text-align: center;padding: 0px;">
            ...
            <td style="width:8%; text-align: center;padding: 0px;">
                <div class="inputContainer" style="width:100%;">
                    <input type="text" id="qty_<?php echo $i; ?>" name="qty[]" value="<?php echo $purchaseReturnMisc['PurchaseReturnMisc']['qty']; ?>" style="width:80%;" class="qty validate[required]" />
                </div>
            </td>
            <td style="width:10%; padding: 0px; text-align: center;">
                <div class="inputContainer" style="width:100%">
                    <select id="qty_uom_id<?php echo $i; ?>" style="width:80%; height: 20px;" name="qty_uom_id[]" class="qty_uom_id validate[required]" >
                        <?php
                        $query=mysql_query("    SELECT id,name,abbr,1 AS conversion FROM uoms WHERE id=".$purchaseReturnMisc['PurchaseReturnMisc']['qty_uom_id']."
                                                UNION
                                                SELECT id,name,abbr,(SELECT value FROM uom_conversions WHERE is_active=1 AND from_uom_id=uoms.id AND to_uom_id=".$purchaseReturnMisc['PurchaseReturnMisc']['qty_uom_id'].") AS conversion FROM uoms WHERE id IN (SELECT from_uom_id FROM uom_conversions WHERE is_active=1 AND to_uom_id=".$purchaseReturnMisc['PurchaseReturnMisc']['qty_uom_id'].")
                                                UNION
                                                SELECT id,name,abbr,(SELECT 1/value FROM uom_conversions WHERE is_active=1 AND from_uom_id=".$purchaseReturnMisc['PurchaseReturnMisc']['qty_uom_id']." AND to_uom_id=uoms.id) AS conversion FROM uoms WHERE id IN (SELECT to_uom_id FROM uom_conversions WHERE is_active=1 AND from_uom_id=".$purchaseReturnMisc['PurchaseReturnMisc']['qty_uom_id'].")
                                                ORDER BY conversion");
                        $j = 1;
                        while($data=mysql_fetch_array($query)){?>
                        <option label="<?php if($data['id'] == $purchaseReturnMisc['PurchaseReturnMisc']['qty_uom_id']){ echo "first"; }else{ echo "other";} ?>" <?php if($data['id'] == $purchaseReturnMisc['PurchaseReturnMisc']['qty_uom_id']){ ?> selected="selected" <?php }?> value="<?php echo $data['id']; ?>" conversion="<?php echo $data['conversion']; ?>"><?php echo $data['abbr']; ?></option>
                        <?php 
                        $j++;
                        } ?>
                    </select>
            ...
            <td style="width:10%; padding: 0px; text-align: center;">
                <div class="inputContainer" style="width:100%;">
                    <input type="hidden" class="org_price" />
                    <input type="text" id="unit_price<?php echo $i; ?>" name="unit_price[]" value="<?php echo number_format($purchaseReturnMisc['PurchaseReturnMisc']['unit_price'],2); ?>" style="width:80%;" class="float unit_price validate[required]" />
                </div>
            </td>
            <td style="width:10%; text-align: center; padding: 0px;">
                <div class="inputContainer" style="width:100%;">
                    <input type="text" id="total_price<?php echo $i; ?>" name="total_price[]" style="width:80%" class="total_price float" value="<?php echo number_format($purchaseReturnMisc['PurchaseReturnMisc']['total_price'],2); ?>" />
                </div>
            </td>
            <td style="width:10%;">
                <img alt="Remove" src="<?php echo $this->webroot . 'img/button/cross.png'; ?>" class="btnRemoveBR" align="absmiddle" style="cursor: pointer;" onmouseover="Tip('Remove')" />
