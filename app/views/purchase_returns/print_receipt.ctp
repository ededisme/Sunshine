    ...
    <div>
        <div>
            <table class="table_print">
                <tr>
                    ...
                    <th style="width: 140px !important;"><?php echo SALES_ORDER_UNIT_PRICE ?> <?php TABLE_CURRENCY_DEFAULT; ?></th>
                    <th style="width: 140px !important;"><?php echo SALES_ORDER_TOTAL_PRICE; ?> <?php TABLE_CURRENCY_DEFAULT; ?></th>
                </tr>
                <?php
                $index = 0;
        ...
        <div style="float: right; width: 250px">
            <table align="right">
                ...
                <tr>
                    <td class="first" style="border-bottom: none; border-left: none;text-align: right" colspan="5"><?php echo TABLE_VAT; ?> (<?php echo number_format($purchaseReturn['PurchaseReturn']['vat_percent'], 2); ?>%)</td>
                ...
                <tr>
                    ...
                    <td style="text-align: right;width: 100px;"><b><?php echo number_format(($purchaseReturn['PurchaseReturn']['total_amount'] - $purchaseReturn['PurchaseReturn']['balance']), 2); ?></b> <?php echo TABLE_CURRENCY_DEFAULT_BIG;?></td>
                </tr>
                <tr>
                    ...
                    <td style="text-align: right;width: 100px;"><b><?php echo number_format($purchaseReturn['PurchaseReturn']['balance'], 2); ?></b> <?php echo TABLE_CURRENCY_DEFAULT_BIG;?></td>
                </tr>
            </table>
        </div>
