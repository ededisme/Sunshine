        ...
        $(".addVendorPurchaseReturn").click(function(){
            $.ajax({
                ...
                beforeSend: function(){
                    ...
                    $(".addVendorPurchaseReturn").attr("disabled", true);
                    $("#txtAddVendorPurchaseReturn").text('<?php echo ACTION_LOADING; ?>');
                },
                success: function(msg){
                    $(".loader").attr('src', '<?php echo $this->webroot; ?>img/layout/spinner-placeholder.gif');
                    $(".addVendorPurchaseReturn").attr("disabled", false);
                    $("#txtAddVendorPurchaseReturn").text('<?php echo MENU_VENDOR_ADD; ?>');
                    $("#dialog3").html(msg);
                    $("#dialog3").dialog({
...
<div style="padding: 5px;border: 1px dashed #bbbbbb; margin-bottom: 5px;">
    <div class="buttons">
        <a href="#" class="positive addVendorPurchaseReturn">
            <img src="<?php echo $this->webroot; ?>img/button/plus.png" alt=""/>
            <span id="txtAddVendorPurchaseReturn"><?php echo MENU_VENDOR_ADD; ?></span>
        </a>
    </div> 
