...
<script type="text/javascript">
    ...
    function addProductPO(name, uom, product_id, unit_cost, smallUomValPro){
        ...
        tr.find("td .total_cost").attr("id", "total_cost"+indexRowPO).val(Number(unit_cost).toFixed(<?php echo $rowOption[0]; ?>));
    ...
    function checkCurrencyWithBranchPO(){
        var currency = $("#PurchaseRequestBranchId").find("option:selected").attr("currency");
        // Currency Filter
        $("#PurchaseRequestCurrencyCenterId").filterOptions('branch', $("#PurchaseRequestBranchId").val(), '');
                ...
                <td style="width: 50%">
                    <table cellpadding="0" style="width: 100%">
                        <tr>
                            ...
                            <td style="width: 33%"><label for="PurchaseRequestPrCode"><?php echo TABLE_PO_NUMBER; ?> <span class="red">*</span></label></td>
                        </tr>
                        <tr>
                            <td>
                            ...
                            <td>
                                <div class="inputContainer" style="width:100%">
                                    <?php echo $this->Form->text('pr_code', array('class' => 'validate[required]', 'style' => 'width:70%', 'readonly' => TRUE)); ?>
                                </div>
                            </td>
                        </tr>
                    </table>
                        ...
                        <tr>
                            <td>
                                <div class="inputContainer" style="width:100%">
                                    ...
                                    <?php echo $this->Form->text('vendor_name', array('class' => 'validate[required,funcCall[checkVendorPO]]', 'style' => 'width:70%')); ?>
                                    &nbsp;&nbsp; <img alt="Search" align="absmiddle" style="cursor: pointer; width:22px; height: 22px;" id="searchVendorPO" onmouseover="Tip('<?php echo GENERAL_SEARCH; ?>')" src="<?php echo $this->webroot . 'img/button/search.png'; ?>" />
                                    <img alt="Delete" align="absmiddle" id="deleteSearchVendorPO" onmouseover="Tip('<?php echo ACTION_DELETE; ?>')" src="<?php echo $this->webroot . 'img/button/delete.png'; ?>" style="display:none; cursor: pointer;" />
                                </div>
                            </td>
                            <td>
                                <div class="inputContainer" style="width:100%">
                                    <select name="data[PurchaseRequest][currency_center_id]" id="PurchaseRequestCurrencyCenterId" class="validate[required]" style="width: 75%;">
                                        ...
                                        ?>
                                        <option branch="<?php echo $rowCurrencyCom[0]; ?>" value="<?php echo $currencyCenter['CurrencyCenter']['id']; ?>" symbol="<?php echo $currencyCenter['CurrencyCenter']['symbol']; ?>"><?php echo $currencyCenter['CurrencyCenter']['name']; ?></option>
                                        <?php
                                        }
                                        ?>
                                    </select>
...
<table id="tblHeaderPO" class="table" cellspacing="0" style="padding:0px; width:99%;">
    <tr>
        ...
        <th style="width:13%"><?php echo TABLE_UNIT_COST; ?></th>
        <th style="width:14%"><?php echo TABLE_TOTAL_COST; ?></th>
        ...
        <tr id="detailPO" class="listBodyPO" style="visibility: hidden;">
            ...
            <td style="padding:0px; text-align: center; width:13%">
                <div class="inputContainer" style="width:100%">                                        
                    ...
                    <select id="qty_uom_id" name="qty_uom_id[]" style="width:80%; height: 20px;" class="qty_uom_id validate[required]">
                        <?php
                        foreach ($uoms as $uom) {
            ...
            <td style="padding:0px; text-align: center; width:14%">
                ...
                <input type="text" name="total_cost[]" id="total_cost" <?php if(!$allowEditCost){ ?>readonly=""<?php } ?> style="width:80%" class="total_cost float" />
