...
<script type="text/javascript">
    var oTableEchoCardia;
    $(document).ready(function(){
        // Prevent Key Enter
        preventKeyEnter();
        $("#<?php echo $tblName; ?> td:first-child").addClass('first');
        oTableEchoCardia = $("#<?php echo $tblName; ?>").dataTable({
            "bProcessing": true,
            "bServerSide": true,
            ...
            "fnInfoCallback": function( oSettings, iStart, iEnd, iMax, iTotal, sPre ) {
                ...
                $(".btnPrintEchoCardia").click(function(event){
                    event.preventDefault();
                    var id = $(this).attr('rel');
                    $("#dialog").html('<div class="buttons"><button type="submit" class="positive printEcho" ><img src="<?php echo $this->webroot; ?>img/button/printer.png" alt=""/><span class="txtRePrintLabo"><?php echo ACTION_PRINT; ?></span></button></div> ');
                    $(".printEcho").click(function(){
                        $.ajax({
                            type: "POST",
                ...
                $(".btnViewEchoCardia").click(function(event){
                    event.preventDefault();
                    var id = $(this).attr('rel');
                ...
                $(".btnEditEchoCardia").click(function(event){
                    event.preventDefault();
                    var id = $(this).attr('rel');
                    var leftPanel  = $(this).parent().parent().parent().parent().parent().parent().parent();
                    var rightPanel = leftPanel.parent().find(".rightPanel");
