...
<script type="text/javascript">
    $(document).ready(function(){
        ...
        clearOrderDetailVendorConsignmentReturn();
        // Hide Branch
        $("#VendorConsignmentReturnBranchId").filterOptions('com', '0', '');
        $("#VendorConsignmentReturnLocationGroupId").chosen();
        // Hide Location
        $("#VendorConsignmentReturnLocationId").filterOptions('location-group', '0', '');
        $("#VendorConsignmentReturnAddForm").validationEngine();
        ...
        $("#VendorConsignmentReturnAddForm").ajaxForm({
            dataType: 'json',
        ...
        $("#VendorConsignmentReturnVendorName").autocomplete("<?php echo $this->base . "/vendor_consignment_returns/searchVendor"; ?>", {
            ...
            formatItem: function(data, i, n, value) {
                if(checkCompanyVendorConsignmentReturn(value.split(".*")[4])){
        ...
        if($.cookie('VendorConsignmentReturnLocationGroupId')!=null || $("#VendorConsignmentReturnLocationGroupId").find("option:selected").val() != ''){
            if($.cookie('VendorConsignmentLocationGroupReturnId') != null){
        ...
        if($.cookie('VendorConsignmentReturnDate')!=null){
        ...
        if($.cookie('companyIdVendorConsignmentReturn') != null || $("#VendorConsignmentReturnCompanyId").find("option:selected").val() != ''){
            if($.cookie('companyIdVendorConsignmentReturn') != null){
                $("#VendorConsignmentReturnCompanyId").val($.cookie('companyIdVendorConsignmentReturn'));
            }
            $("#VendorConsignmentReturnBranchId").filterOptions('com', $("#VendorConsignmentReturnCompanyId").val(), '');
            $("#VendorConsignmentReturnBranchId").change();
        }
        // Reset Form
        resetFormVendorConsignmentReturn();
    ...
    function backVendorConsignmentReturn(){
        ...
        $("#VendorConsignmentReturnAddForm").validationEngine("hideAll");
        var rightPanel = $("#VendorConsignmentReturnAddForm").parent();
    ...
    function checkBfSaveVendorConsignmentReturn(){
        var formName = "#VendorConsignmentReturnAddForm";
    ...
    function changeInputCSSVendorConsignmentReturn(){
        ...
        // Label
        $("#VendorConsignmentReturnAddForm").find("label").removeAttr("class");
        $("#VendorConsignmentReturnAddForm").find("label").each(function(){
        ...
        // Input & Select
        $("#VendorConsignmentReturnAddForm").find("input").each(function(){
            $(this).removeClass(cssRemove);
            $(this).addClass(cssStyle);
        });
        $("#VendorConsignmentReturnAddForm").find("select").each(function(){
            ...
            <td style="width: 50%; vertical-align: top;">
                <table cellpadding="0" style="width: 100%">
                    <tr>
                        ...
                        <td style="width: 33%"><label for="VendorConsignmentReturnLocationGroupId"><?php echo TABLE_LOCATION_GROUP; ?> <span class="red">*</span></td>
                    </tr>
                    <tr>
                        <td>
                            <div class="inputContainer" style="width:100%">
                                <select name="data[VendorConsignmentReturn][company_id]" id="VendorConsignmentReturnCompanyId" class="validate[required]" style="width: 75%;">
                                    <?php
                        ...
                        <td>
                           <div class="inputContainer" style="width:100%">
                                <select name="data[VendorConsignmentReturn][branch_id]" id="VendorConsignmentReturnBranchId" class="validate[required]" style="width: 75%;">
                                    ...
                                    ?>
                                    <option value="<?php echo $branch['Branch']['id']; ?>" com="<?php echo $branch['Branch']['company_id']; ?>" mcode="<?php echo $branch['ModuleCodeBranch']['ven_consign_return_code']; ?>" currency="<?php echo $branch['Branch']['currency_center_id']; ?>" symbol="<?php echo $branch['CurrencyCenter']['symbol']; ?>"><?php echo $branch['Branch']['name']; ?></option>
                                    <?php
                                    }
                                    ?>
                                </select>
                        ...
                        <td>
                            <div class="inputContainer" style="width:100%">
                               <?php
                                ...
                                echo $this->Form->input('location_group_id', array('empty' => $empty, 'label' => false, 'style' => 'width:200px')); 
                                ?>
                           </div>
                        </td>
                    </tr>
            ...
            <td style="width: 50%; vertical-align: top;">
                <table cellpadding="0" style="width: 100%">
                    ...
                    <tr>
                        <td>
                            <div class="inputContainer" style="width:100%">
                                <?php echo $this->Form->text('vendor_name', array('class' => 'validate[required,funcCall[checkVendorVendorConsignmentReturn]]', 'style' => 'width:70%')); ?>
                        ...
                        <td>
                            <div class="inputContainer" style="width:100%">
                                <?php echo $this->Form->hidden('vendor_consignment_id'); ?>
                                <?php echo $this->Form->text('vendor_consignment', array('class' => 'validate[required]', 'style' => 'width:70%')); ?>
                                <img alt="Search" search="1" align="absmiddle" style="cursor: pointer; width: 22px; height: 22px;" class="searchVendorConsignmentReturnVendorConsignment" onmouseover="Tip('<?php echo GENERAL_SEARCH; ?>')" src="<?php echo $this->webroot . 'img/button/search.png'; ?>" />
                                <img alt="Delete" search="0" align="absmiddle" style="display: none; cursor: pointer;" class="deleteVendorConsignmentReturnVendorConsignment" onmouseover="Tip('<?php echo ACTION_DELETE; ?>')" src="<?php echo $this->webroot . 'img/button/delete.png'; ?>" />
                            </div>
                        </td>
                        <td>
                            <div class="inputContainer" style="width:100%">
...
<div class="orderDetailVendorConsignmentReturn" style=" margin-top: 5px; text-align: center;">
</div>
<div class="footerFormVendorConsignmentReturn">
