...
<script type="text/javascript">
    $(document).ready(function(){ 
        // Prevent Key Enter
        preventKeyEnter();     
        $("#PatientIpdAddForm").validationEngine();
        $("#PatientIpdAddForm").ajaxForm({
            dataType: 'json',
            ...
            success: function(result) {
                ...
                $("#dialog").html('<div class="buttons"><button type="submit" class="positive printPatientIPDForm" ><img src="<?php echo $this->webroot; ?>img/button/printer.png" alt=""/><span class="txtPrintInvoice"><?php echo ACTION_PRINT_PATIENT_IPD; ?></span></button></div>');
                $(".printPatientIPDForm").click(function(){
                    $.ajax({
                        type: "POST",
        ...
        $(".btnBackPatientIPD").dblclick(function(event){
            ...
            $('#PatientIpdAddForm').validationEngine('hideAll');
    ...
    function checkBfSavePatient(){
        var formName = "#PatientIpdAddForm";
