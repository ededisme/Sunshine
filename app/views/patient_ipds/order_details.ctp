...
<script type="text/javascript">
    ...
    $(document).ready(function(){
        ...
        $("#prescriptionType").click(function(){
            if($(this).val()==0){
                $("#tdDischargeDiagnosis").show();
            }else{
                $("#tdDischargeDiagnosis").hide();
                $("#dischargeDiagnosis").val("");
            }
        });
    ...
    function searchProductListOrder(){
        ...
        if($("#DoctorCompanyId").val() == "" || $("#OrderBranchId").val() == ""){
            ...
            $.ajax({
                type:   "POST",
                url:    "<?php echo $this->base . "/doctors/product/"; ?>"+$("#DoctorCompanyId").val()+"/"+$("#DoctorLocationGroupId").val()+"/"+$("#OrderBranchId").val(),
...
<div class="inputContainer" style="width:100%;" id="orderSearchForm">
    <table style="width: 100%;">
        <tr>
            ...
            <td style="width: 5%; text-align: left;" id="divSearchOrder">
            ...
            <td id="tdDischargeDiagnosis" style="display: none;">
                <label for="dischargeDiagnosis"><?php echo 'Discharge diagnosis'; ?><span class="red"> *</span> </label>
                <?php echo $this->Form->text('diagnotist_after', array('id' => 'dischargeDiagnosis', 'name' => 'data[Doctor][note]', 'class' => 'validate[required]', 'style' => 'width: 65%;')); ?>
            </td>
            <td style="text-align: right;">
                <label for="prescriptionType"><?php echo TABLE_PRESCRIPTION_TYPE; ?></label>
                <select id="prescriptionType" style="width: 150px" name="data[Doctor][prescription_type]">
                    <option value="0"><?php echo TABLE_HOME_MEDICAL;?></option>
                    <option selected="selected" value="1"><?php echo TABLE_HOSPITAL_MEDICAL;?></option>
                </select>
            </td>
...
<table id="tblOrderHeader" class="table" cellspacing="0" style="margin-top: 5px; padding:0px; width: 100%">
    <tr>
        ...
        <th style="width:18%;"><?php echo TABLE_NUM_DAYS; ?></th>
