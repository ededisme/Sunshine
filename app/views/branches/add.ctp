        ...
        $("#BranchAddForm").ajaxForm({
            ...
            success: function(result) {
                ...
                if(result != '<?php echo MESSAGE_DATA_HAS_BEEN_SAVED; ?>' && result != '<?php echo MESSAGE_DATA_COULD_NOT_BE_SAVED; ?>'){
                    createSysAct('Branch', 'Add', 2, result);
                    $("#dialog").html('<p><span class="ui-icon ui-icon-info" style="float:left; margin:0 7px 20px 0;"></span><?php echo MESSAGE_PROBLEM; ?></p>');
                }else {
                    createSysAct('Branch', 'Add', 1, '');
                    // alert message
            ...
            <fieldset>
                ...
                <table>
                    <tr>
                        ...
                        <td>
                            <div class="inputContainer">
                                ...
                                echo $this->Form->input('company_id', array('class'=>'validate[required]', 'label' => false, 'empty' => $emptySelect, 'style' => 'width: 250px;')); ?>
                            </div>
                        </td>
                    </tr>
                    <tr>
                    ...
                    <!-- <tr>
                        ...
                        <td>
                            <div class="inputContainer">
                                <?php // echo $this->Form->input('currency_center_id', array('class'=>'validate[required]', 'label' => false, 'empty' => INPUT_SELECT, 'style' => 'width: 250px;')); ?>
                            </div>
                        </td>
                    </tr> -->
                    <tr>
                        ...
                        <td>
                            <div class="inputContainer">
                                <?php echo $this->Form->text('work_start', array('class'=>'validate[required]', 'style' => 'width: 170px;', 'placeholder' => TABLE_TIME_START)); ?>
                                <?php echo $this->Form->text('work_end', array('class'=>'validate[required]', 'style' => 'width: 170px;', 'placeholder' => TABLE_TIME_END)); ?>
                            </div>
                        </td>
                    </tr>
                    <tr>
            ...
            <fieldset style="height: 415px;">
                ...
                <table>
                    ...
                    <tr>
                        ...
                        <td style="vertical-align: top;">
                            <select id="userBranchSelected" name="data[Branch][user_id][]" multiple="multiple" style="width: 300px; height: 200px;"></select>
                        </td>
                    </tr>
                </table>
            </fieldset>
