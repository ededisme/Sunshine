...
<div id="bodyListQuotation">
    <table id="tblQuotation" class="table" cellspacing="0" style="padding: 0px; width:100%">
        ...
        <tr class="tblQuotationList">
            ...
            <td style="width:9%; text-align: center;padding: 0px;">
                <div class="inputContainer" style="width:100%">
                    <input type="text" id="qty_<?php echo $index; ?>" value="<?php echo $quotationDetail['QuotationDetail']['qty']; ?>" name="qty[]" style="width:70%;" class="qty interger" />
                </div>
            </td>
            <td style="width:12%; padding: 0px; text-align: center">
                <div class="inputContainer" style="width:100%">
            ...
            <td style="width:10%; padding: 0px; text-align: center">
                <div class="inputContainer" style="width:100%">
                    ...
                    <input type="text" id="unit_price_<?php echo $index; ?>" <?php if(!$allowEditPrice){ ?>readonly="readonly"<?php } ?> value="<?php echo number_format($quotationDetail['QuotationDetail']['unit_price'], 2); ?>" name="unit_price[]" style="width:60%; <?php if($quotationDetail['QuotationDetail']['unit_price'] < $costSelected){ ?>color: red;"<?php } ?>" class="float unit_price" />
            ...
            <td style="width:10%; padding: 0px; text-align: center">
                <div class="inputContainer" style="width:100%">
                    ...
                    <input type="text" id="discount_<?php echo $index; ?>" class="discount" name="discount[]" value="<?php echo number_format($quotationDetail['QuotationDetail']['discount_amount'], 2); ?>" style="width: 60%;" readonly="readonly" />
            ...
            <td style="width:10%; text-align: center; padding: 0px;">
                ...
                <input type="text" id="total_price_<?php echo $index; ?>" <?php if(!$allowEditPrice){ ?>readonly="readonly"<?php } ?> value="<?php echo number_format($quotationDetail['QuotationDetail']['total_price'] - $quotationDetail['QuotationDetail']['discount_amount'], 2); ?>" name="total_price[]" style="width:84%" class="float total_price" />
            </td>
            <td style="width:9%;">
        ...
        <tr class="tblQuotationList">
            ...
            <td style="width:22%; text-align: left; padding-left: 5px;">
                <div class="inputContainer" style="width:100%">
                    ...
                    <input type="hidden" class="orgProName" />
                    <input type="text" id="product_<?php echo $index; ?>" value="<?php echo str_replace('"', '&quot;', $quotationService['Service']['name']); ?>" readonly="readonly" name="product[]" class="product validate[required]" style="width: 85%;" />
                </div>
            </td>
            <td style="width:9%; text-align: center;padding: 0px;">
                <div class="inputContainer" style="width:100%">
                    <input type="text" id="qty_<?php echo $index; ?>" value="<?php echo $quotationService['QuotationService']['qty']; ?>" name="qty[]" style="width:70%;" class="qty interger" />
                </div>
            </td>
            <td style="width:12%; padding: 0px; text-align: center">
                <div class="inputContainer" style="width:100%">
            ...
            <td style="width:10%; padding: 0px; text-align: center">
                <div class="inputContainer" style="width:100%">
                    <input type="hidden" class="float unit_cost" name="unit_cost[]" value="0" />
                    <input type="text" id="unit_price_<?php echo $index; ?>" <?php if(!$allowEditPrice){ ?>readonly="readonly"<?php } ?> value="<?php echo number_format($quotationService['QuotationService']['unit_price'], 2); ?>" name="unit_price[]" style="width:60%;" class="float unit_price" />
                </div>
            </td>
            <td style="width:10%; padding: 0px; text-align: center">
                <div class="inputContainer" style="width:100%">
                    ...
                    <input type="text" id="discount_<?php echo $index; ?>" class="discount" name="discount[]" value="<?php echo number_format($quotationService['QuotationService']['discount_amount'], 2); ?>" style="width: 60%;" readonly="readonly" />
            ...
            <td style="width:10%; text-align: center; padding: 0px;">
                ...
                <input type="text" id="total_price_<?php echo $index; ?>" <?php if(!$allowEditPrice){ ?>readonly="readonly"<?php } ?> value="<?php echo number_format($quotationService['QuotationService']['total_price'] - $quotationService['QuotationService']['discount_amount'], 2); ?>" name="total_price[]" style="width:84%" class="float total_price" />
            </td>
            <td style="width:9%;">
                <img alt="Remove" src="<?php echo $this->webroot . 'img/button/cross.png'; ?>" class="btnRemoveQuotationList" id="btnRemoveQuotationList_<?php echo $index; ?>" align="absmiddle" style="cursor: pointer;" onmouseover="Tip('Remove')" />
                &nbsp; <img alt="Up" src="<?php echo $this->webroot . 'img/button/move_up.png'; ?>" class="btnMoveUpQuotation" align="absmiddle" style="cursor: pointer;" onmouseover="Tip('Up')" />
        ...
        <tr class="tblQuotationList">
            ...
            <td style="width:22%; text-align: left; padding-left: 5px;">
                <div class="inputContainer" style="width:100%">
                    ...
                    <input type="hidden" name="service_id[]" value="" />
                    <input type="hidden" class="orgProName" />
                    <input type="text" id="product_<?php echo $index; ?>" value="<?php echo str_replace('"', '&quot;', $quotationMisc['QuotationMisc']['description']); ?>" readonly="readonly" name="product[]" class="product validate[required]" style="width: 85%;" />
                </div>
            </td>
            <td style="width:9%; text-align: center;padding: 0px;">
                <div class="inputContainer" style="width:100%">
                    <input type="text" id="qty_<?php echo $index; ?>" value="<?php echo $quotationMisc['QuotationMisc']['qty']; ?>" name="qty[]" style="width:70%;" class="qty interger" />
                </div>
            </td>
            <td style="width:12%; padding: 0px; text-align: center">
                <div class="inputContainer" style="width:100%">
                    ...
                    <select id="qty_uom_id_<?php echo $index; ?>" style="width:80%; height: 20px;" name="qty_uom_id[]" class="qty_uom_id validate[required]">
                        ...
                        foreach($uoms as $uom){
                        ?>
                        <option conversion="1" value="<?php echo $uom['Uom']['id']; ?>" <?php if($uom['Uom']['id'] == $quotationMisc['QuotationMisc']['qty_uom_id']){ ?>selected="selected"<?php } ?>><?php echo $uom['Uom']['name']; ?></option>
                        <?php } ?>
                    </select>
                </div>
            </td>
            <td style="width:10%; padding: 0px; text-align: center">
                <div class="inputContainer" style="width:100%">
                    <input type="hidden" class="float unit_cost" name="unit_cost[]" value="0" />
                    <input type="text" id="unit_price_<?php echo $index; ?>" <?php if(!$allowEditPrice){ ?>readonly="readonly"<?php } ?> value="<?php echo number_format($quotationMisc['QuotationMisc']['unit_price'], 2); ?>" name="unit_price[]" style="width:60%;" class="float unit_price" />
                </div>
            </td>
            <td style="width:10%; padding: 0px; text-align: center">
                <div class="inputContainer" style="width:100%">
                    <input type="hidden" name="discount_id[]" value="<?php echo $quotationMisc['QuotationMisc']['discount_id']; ?>" />
                    <input type="hidden" name="discount_amount[]" value="<?php echo $quotationMisc['QuotationMisc']['discount_amount']; ?>" />
                    <input type="hidden" name="discount_percent[]" value="<?php echo $quotationMisc['QuotationMisc']['discount_percent']; ?>" />
                    <input type="text" id="discount_<?php echo $index; ?>" class="discount" name="discount[]" value="<?php echo number_format($quotationMisc['QuotationMisc']['discount_amount'], 2); ?>" style="width: 60%;" readonly="readonly" />
                    <img alt="Remove" src="<?php echo $this->webroot . 'img/button/cross.png'; ?>" class="btnRemoveDiscountQu" align="absmiddle" style="cursor: pointer; <?php if(empty($quotationMisc['QuotationMisc']['discount_id'])){ ?> display: none;<?php } ?>" onmouseover="Tip('Remove')" />
                </div>
            </td>
            <td style="width:10%; text-align: center; padding: 0px;">
                <input type="hidden" value="<?php echo number_format($quotationMisc['QuotationMisc']['total_price'], 2); ?>" class="total_price_bf_dis float" name="total_price_bf_dis[]" />
                <input type="text" id="total_price_<?php echo $index; ?>" <?php if(!$allowEditPrice){ ?>readonly="readonly"<?php } ?> value="<?php echo number_format($quotationMisc['QuotationMisc']['total_price'] - $quotationMisc['QuotationMisc']['discount_amount'], 2); ?>" name="total_price[]" style="width:84%" class="float total_price" />
            </td>
            <td style="width:9%;">
                <img alt="Remove" src="<?php echo $this->webroot . 'img/button/cross.png'; ?>" class="btnRemoveQuotationList" id="btnRemoveQuotationList_<?php echo $index; ?>" align="absmiddle" style="cursor: pointer;" onmouseover="Tip('Remove')" />
                &nbsp; <img alt="Up" src="<?php echo $this->webroot . 'img/button/move_up.png'; ?>" class="btnMoveUpQuotation" align="absmiddle" style="cursor: pointer;" onmouseover="Tip('Up')" />
