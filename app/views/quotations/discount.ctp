    ...
    <table class="table" style="" cellspacing="0" >
        ...
        <tbody style="width: 774px; ">
            ...
            ?>">
                    ...
                    <input type="hidden" name="salesOrderDiscountAmount" value="<?php echo $discount['Discount']['amount']; ?>" />
                    <input type="hidden" name="salesOrderDiscountPercent" value="<?php echo $discount['Discount']['percent']; ?>" />
                </td>
