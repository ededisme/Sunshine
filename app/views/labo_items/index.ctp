...
<script type="text/javascript">
    ...
    $(document).ready(function(){
        ...
        oTableLaboItem = $("#<?php echo $tblName; ?>").dataTable({
            "bProcessing": true,
            "bServerSide": true,
            ...
            "fnInfoCallback": function( oSettings, iStart, iEnd, iMax, iTotal, sPre ) {
                ...
                $(".btnEditLaboItem").click(function(event){
                ...
                $(".btnDeleteLaboItem").click(function(event){
                    event.preventDefault();
                    var id = $(this).attr('rel');
                    var name = $(this).attr('name');
        ...
        $(".btnAddLaboItem").click(function(event){
            event.preventDefault();
...
<div class="leftPanel">
    <div style="padding: 5px;border: 1px dashed #3C69AD;">
        <?php if($allowAdd){ ?>
        <div class="buttons">
            <a href="" class="positive btnAddLaboItem">
                <img src="<?php echo $this->webroot; ?>img/button/plus.png" alt=""/>
                <?php echo MENU_LABO_ITEMS_ADD; ?>
                <img src="<?php echo $this->webroot; ?>img/icon/labo_item.png" alt=""/>
            </a>
        </div>
        <?php } ?>       
        ...
        <table id="<?php echo $tblName; ?>" class="table" cellspacing="0">
            <thead>
                <tr>
                    ...
                    <th><?php echo GENERAL_CATEGORY; ?></th>
