...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        $("#LaboItemAddForm").ajaxForm({
            beforeSubmit: function(arr, $form, options) {
                $(".txtSaveLaboItem").html("<?php echo ACTION_LOADING; ?>");
...
<fieldset>
    ...
    <table>
        <tr>
            ...
            <td><?php echo $this->Form->input('category', array('empty' => SELECT_OPTION, 'label' => false, 'class' => 'validate[required]')); ?></td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td><?php echo $this->Form->input('normal_value_type', array('empty' => SELECT_OPTION, 'label' => false, 'class' => 'validate[required]')); ?></td>
        </tr>
        ...
        <tr class="set_normal">
            ...
            <td>
                <?php echo $this->Form->input('item_labo_unit', array('empty' => SELECT_OPTION, 'label' => false, 'div' => false)); ?>
                ...
                <td>
                    <table>
                        <tr>                                     
                            ...
                            <td>Min Value</td>
                            <td><input type="text" name="data[LaboItem][min_value][]"/></td>
                            <td>Max Value</td>
                            <td><input type="text" name="data[LaboItem][max_value][]"/></td>
                        </tr>
                    </table>
                </td>
            </tr>
...
<div class="buttons">
    <button type="submit" class="positive">
        ...
        <span class="txtSaveLaboItem"><?php echo ACTION_SAVE; ?></span>
    </button>
</div>
<div style="clear: both;"></div>
