...
<script type="text/javascript">
    $(document).ready(function(){
        // Prevent Key Enter
        preventKeyEnter();
        $("#MedicalHistoryEditForm").validationEngine();
        $("#MedicalHistoryEditForm").ajaxForm({
...
<br />
<?php 
echo $this->Form->create('MedicalHistory'); ?>
<fieldset>
    <legend><?php __(MENU_MEDICAL_HISTORY); ?></legend>
    <table>
        <input type="hidden" name="data[MedicalHistory][id]" value="<?php echo $this->data['MedicalHistory']['id']; ?>">
        <tr>
        ...
        <tr>
            ...
            <td><textarea id="Description" name="data[MedicalHistory][description]" style="width:97%;" class ="validate[required]" ><?php echo $this->data['MedicalHistory']['description']; ?></textarea></td>
        </tr> 
    </table>
</fieldset>
<br />
