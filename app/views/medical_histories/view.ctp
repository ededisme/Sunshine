...
<fieldset>
    ...
    <table style="width: 100%;" cellpadding="5">
        <tr>
            ...
            <td style="font-size: 12px;"><?php echo $this->data['MedicalHistory']['name']; ?></td>
        </tr>
        
        <tr>
            <th style="font-size: 12px;"><?php echo  TABLE_DESCRIPTION ;  ?> :</th>
            <td style="font-size: 12px;"><?php echo $this->data['MedicalHistory']['description']; ?></td>
        </tr>
        </tr>
        <tr>
            <th style="font-size: 12px;"><?php echo TABLE_CREATED; ?> :</th>
            <td style="font-size: 12px;" colspan="5"><?php echo $this->data['MedicalHistory']['created']; ?></td>
        </tr>
    </table>
</fieldset>
<br />   