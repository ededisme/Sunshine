    ...
    function searchProductByCodeOrder(productCode, uomSelected, qtyOrder){
        if($("#OrderCustomerId").val() == "" || $("#OrderCompanyId").val() == "" || $("#OrderBranchId").val() == ""){
            ...
            $.ajax({
                dataType: "json",
                type:   "POST",
                url:    "<?php echo $this->base . "/orders/searchProductByCode/"; ?>"+$("#OrderCompanyId").val()+"/"+$("#OrderCustomerId").val()+"/"+$("#OrderBranchId").val(),
...
<div class="inputContainer" style="width:100%;" id="orderSearchForm">
    <table style="width: 100%;">
        <tr>
            ...
            <td style="width: 300px; text-align: left;">
                <?php echo $this->Form->text('code', array('id' => 'SearchProductSkuOrder', 'style' => 'width: 90%; height:15px;', 'placeholder' => TABLE_SEARCH_SKU_NAME)); ?>
            </td>
            <td style="width: 15%; text-align: left;" id="divSearchOrder">
                ...
                <?php
                    ...
                    if ($allowAddMisc) {
                ?>
                &nbsp;&nbsp;<img alt="<?php echo SALES_ORDER_ADD_MISCELLANEOUS; ?>" style="cursor: pointer; height: 20px;" align="absmiddle" class="addMiscellaneousOrder" onmouseover="Tip('<?php echo SALES_ORDER_ADD_MISCELLANEOUS; ?>')" src="<?php echo $this->webroot . 'img/button/plus.png'; ?>" />
                <?php
                    }
                ?>
            </td>
...
<table id="tblOrderHeader" class="table" cellspacing="0" style="margin-top: 5px; padding:0px; width: 99%">
    <tr>
        ...
        <th style="width:11%"><?php echo TABLE_SKU; ?></th>
        ...
        <th style="width:9%"><?php echo POS_DISCOUNTS; ?></th>
...
<div id="bodyListOrder">
    <table id="tblOrder" class="table" cellspacing="0" style="padding: 0px; width:100%">
        <tr id="OrderListOrder" class="tblOrderList" style="visibility: hidden;">
            ...
            <td style="width:8%; text-align: center;padding: 0px;">
                <div class="inputContainer" style="width:100%">
                    <input type="text" id="qty_free" name="qty_free[]" style="width:80%;" class="qty_free interger" />
                </div>
            </td>
