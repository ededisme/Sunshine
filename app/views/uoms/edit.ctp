...
<script type="text/javascript">
    $(document).ready(function(){
        // Prevent Key Enter
        preventKeyEnter();
        $("#UomEditForm").validationEngine('attach', {
            isOverflown: true,
            overflownDIV: ".ui-tabs-panel"
        });
        $("#UomEditForm").ajaxForm({
...
<fieldset>
    ...
    <table>
        <tr>
            <td><label for="UomType"><?php echo GENERAL_TYPE; ?> <span class="red">*</span> :</label></td>
            <td>
                <div class="inputContainer">
                    <?php echo $this->data['Uom']['type']; ?>
                </div>
            </td>
        </tr>
        <tr>
