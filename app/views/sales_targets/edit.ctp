    ...
    $(document).ready(function(){
        ...
        $(".btnBackSalesTarget").click(function(event){
            event.preventDefault();
             var rightPanel = $("#SalesTargetEditForm").parent();
            ...
            <td>
                <div class="inputContainer">
                    <select name="data[SalesTarget][year]" id="SalesTargetYear" class="validate[required]">
                        ...
                        <option <?php if($i == $this->data['SalesTarget']['year']){ ?>selected="selected"<?php } ?> value="<?php echo $i; ?>"><?php echo $i; ?></option>
                        <?php } ?>
                    </select>
                </div>
            </td>
    ...
    <table class="table" cellspacing="0">
        ...
        <tr>
            ...
            <td style="text-align: center; width: 6%;" class="<?php echo $class; ?>">
                <?php echo $this->Form->input('m'.$mIndex, array('class'=>'validate[required]', 'style' => 'width: 95%;', 'class' => 'float', 'value' => number_format($this->data['SalesTarget']['m'.$mIndex], 2))); ?>
            </td>
            <?php } ?>
