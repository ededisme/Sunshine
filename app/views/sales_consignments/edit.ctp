...
<script type="text/javascript">
    $(document).ready(function(){
        ...
        clearOrderDetailSo();
        // Hide Branch
        $("#SalesConsignmentBranchId").filterOptions('com', '<?php echo $this->data['SalesOrder']['company_id']; ?>', '<?php echo $this->data['SalesOrder']['branch_id']; ?>');
        $("#SalesConsignmentEditForm").validationEngine();
        ...
        $("#SalesConsignmentEditForm").ajaxForm({
            dataType: 'json',
    ...
    function checkVatCompanySales(selected){
        // VAT Filter
        $("#SalesConsignmentVatSettingId").filterOptions('com-id', $("#SalesConsignmentCompanyId").val(), selected);
    }
    
    function backSalesConsignment(){
        oCache.iCacheLower = -1;
        oTableSalesConsignment.fnDraw(false);
        $("#SalesConsignmentEditForm").validationEngine("hideAll");
        var rightPanel = $("#SalesConsignmentEditForm").parent();
        ...
        $("#dialog").dialog({
            ...
            buttons: {
                '<?php echo ACTION_OK; ?>': function() {
                    ...
                    // Action Click Save
                    $("#SalesConsignmentEditForm").submit();
                    $(this).dialog("close");
                },
                '<?php echo ACTION_CANCEL; ?>': function() {
                    $(this).dialog("close");
    ...
    function checkBfSaveSo(){
        var formName = "#SalesConsignmentEditForm";
    ...
    function changeInputCSSSales(){
        ...
        // Label
        $("#SalesConsignmentEditForm").find("label").removeAttr("class");
        $("#SalesConsignmentEditForm").find("label").each(function(){
        ...
        // Input & Select
        $("#SalesConsignmentEditForm").find("input").each(function(){
            $(this).removeClass(cssRemove);
            $(this).addClass(cssStyle);
        });
        $("#SalesConsignmentEditForm").find("select").each(function(){
...
<?php echo $this->Form->create('SalesConsignment', array('inputDefaults' => array('div' => false, 'label' => false), 'action' => '/edit/'.$this->data['SalesOrder']['id'], 'id' => 'SalesConsignmentEditForm')); ?>
<input type="hidden" value="<?php echo $rowSettingUomDetail[1]; ?>" name="data[calculate_cogs]" />
<input type="hidden" value="<?php echo $this->data['SalesOrder']['total_deposit']; ?>" name="data[total_deposit]" id="SalesConsignmentTotalDeposit" />
<input type="hidden" value="1" id="SalesConsignmentIsApprove" name="data[SalesConsignment][is_approve]" />
<input type="hidden" value="<?php echo $this->data['SalesOrder']['currency_center_id']; ?>" id="SalesConsignmentCurrencyCenterId" name="data[SalesConsignment][currency_center_id]" />
...
<input type="hidden" value="<?php echo $this->data['SalesOrder']['vat_calculate']; ?>" name="data[SalesConsignment][vat_calculate]" id="SalesConsignmentVatCalculate" />
<input type="hidden" value="<?php echo $this->data['SalesOrder']['location_group_id']; ?>" name="data[SalesConsignment][location_group_id]" id="SalesConsignmentLocationGroupId" />
<?php
$pType = "";
    ...
    <table cellpadding="0" cellspacing="0" style="width: 100%;" id="saleInvoiceInformation">
        <tr>
                    ...
                    <tr>
                        <td>
                            <div class="inputContainer" style="width:100%">
                                <select name="data[SalesConsignment][company_id]" id="SalesConsignmentCompanyId" class="validate[required]" style="width: 70%;">
                                    <?php
                        ...
                        <td>
                            <div class="inputContainer" style="width:100%">
                               <?php echo $this->Form->text('so_code', array('class' => 'validate[required]', 'style' => 'width:70%', 'readonly' => true, 'value' => $this->data['SalesOrder']['so_code'])); ?>
                            </div>
                        </td>
                    </tr>
                </table>
                    ...
                    <tr>
                        <td>
                            <div class="inputContainer" style="width:100%">
                                ...
                                echo $this->Form->text('order_date', array('value' => $dateOrder, 'class' => 'validate[required]', 'readonly' => 'readonly', 'style' => 'width:85%')); 
                                ?>
                            </div>
                        </td>
                    </tr>
            ...
            <td style="width: 16%; vertical-align: top;">
                <table cellpadding="0" style="width: 100%">
                    <tr>
                        <td><label for="SalesConsignmentConsignmentCode"><?php echo MENU_CONSIGNMENT; ?></label></td>
                    </tr>
                    <tr>
                        <td>
                            <div class="inputContainer" style="width:100%">
                                <?php echo $this->Form->hidden('consignment_id', array('value' => $this->data['SalesOrder']['consignment_id'])); ?>
                                <?php 
                                echo $this->Form->text('consignment_code', array('style' => 'width:70%', 'class' => 'validate[required]', 'value' => $this->data['SalesOrder']['consignment_code'])); 
                                if($this->data['SalesOrder']['consignment_code'] != ''){
                                    $searchConsignment = 'display: none;';
                                    $deleteConsignment = '';
                                }else{
                                    $searchConsignment = '';
                                    $deleteConsignment = 'display: none;';
                                }
                                ?>
                                <img alt="Search" align="absmiddle" style="cursor: pointer; width: 22px; height: 22px; <?php echo $searchConsignment; ?>" class="searchConsignmentSales" onmouseover="Tip('<?php echo GENERAL_SEARCH; ?>')" src="<?php echo $this->webroot . 'img/button/search.png'; ?>" />
                                <img alt="Delete" align="absmiddle" style="cursor: pointer; <?php echo $deleteConsignment; ?>" class="deleteConsignmentSales" onmouseover="Tip('<?php echo ACTION_DELETE; ?>')" src="<?php echo $this->webroot . 'img/button/delete.png'; ?>" />
                            </div>
                        </td>
                    </tr>
                </table>
        ...
        <tr>
            <td style="width: 50%; vertical-align: top;">
                ...
                while($rowEmployee=mysql_fetch_array($sqlEmployee)){
                    ...
                    if($rowEmployee['id'] == $this->data['SalesOrder']['deliver_id']){
                        $deliverName = $rowEmployee['name'];
                    }
                ...
                <table cellpadding="0" style="width: 100%">
                    ...
                    <tr>
                        <td>
                            <div class="inputContainer" style="width:100%">
                                <?php echo $this->Form->text('customer_number', array('value' => $this->data['Customer']['customer_code'], 'readonly' => true, 'class' => 'validate[required]', 'style' => 'width:70%')); ?>
                            </div>
                        </td>
                        <td>
                            <div class="inputContainer" style="width:100%">
                                <?php echo $this->Form->text('customer_name', array('value' => $this->data['Customer']['name'], 'readonly' => true, 'class' => 'validate[required,funcCall[checkCustomerAddSO]]', 'style' => 'width:70%')); ?>
                                <?php echo $this->Form->hidden('customer_id', array('value' => $this->data['SalesOrder']['customer_id'])); ?>
                                <img alt="Search" align="absmiddle" style="display: none; cursor: pointer; width: 22px; height: 22px;" class="searchCustomerSales" onmouseover="Tip('<?php echo GENERAL_SEARCH; ?>')" src="<?php echo $this->webroot . 'img/button/search.png'; ?>" />
                                <img alt="Delete" align="absmiddle" style="cursor: pointer;" class="deleteCustomerSales" onmouseover="Tip('<?php echo ACTION_DELETE; ?>')" src="<?php echo $this->webroot . 'img/button/delete.png'; ?>" />
                            </div>
                        </td>
                        <td>
                            <div class="inputContainer" style="width:100%">
                                <select name="data[SalesConsignment][customer_contact_id]" id="SalesConsignmentCustomerContactId" style="width: 75%;">
                                    ...
                                    <?php
                                    $sqlCusContact = mysql_query("SELECT * FROM customer_contacts WHERE customer_id = ".$this->data['SalesOrder']['customer_id']);
                                    while($rowCusContact = mysql_fetch_array($sqlCusContact)){
                                    ?>
                                    <option value="<?php echo $rowCusContact['id']; ?>" <?php if($rowCusContact['id'] == $this->data['SalesOrder']['customer_contact_id']){ ?>selected="selected"<?php } ?>><?php echo $rowCusContact['contact_name']; ?></option>
                                    <?php
                                    }
                                    ?>
                                </select>
            ...
            <td style="width: 17%; vertical-align: top;">
                <table cellpadding="0" style="width: 100%">
                    ...
                    <tr>
                        <td>
                            <div class="inputContainer" style="width:100%">
                                <?php echo $this->Form->input('payment_term_id', array('style' => 'width:90%', 'label' => false, 'empty' => INPUT_SELECT, 'class' => 'validate[required]', 'div' => false, 'selected' => $this->data['SalesOrder']['payment_term_id'])); ?>
                            </div>
                        </td>
                    </tr>
                </table>
            ...
            <td style="width: 16%; vertical-align: top;" rowspan="2" colspan="2">
                <table cellpadding="0" style="width: 100%">
                    ...
                    <tr>
                        <td>
                            <div class="inputContainer" style="width:100%">
                                <?php echo $this->Form->textarea('memo', array('style' => 'width:90%; height: 70px;', 'value' => $this->data['SalesOrder']['memo'])); ?>
                            </div>
                        </td>
                    </tr>
                </table>
            ...
            <td style="width: 50%; vertical-align: top;">
                <table cellpadding="0" style="width: 100%">
                    ...
                    <tr>
                        <td>
                            <div class="inputContainer" style="width:100%">
                                <?php echo $this->Form->text('customer_po_number', array('style' => 'width:70%', 'value' => $this->data['SalesOrder']['customer_po_number'])); ?>
                            </div>
                        </td>
                        <td>
                            <div class="inputContainer" style="width:100%">
                                <?php echo $this->Form->hidden('sales_rep_id', array('value' => $this->data['SalesOrder']['sales_rep_id'])); ?>
                        ...
                        <td>
                            <div class="inputContainer" style="width:100%">
                               <?php echo $this->Form->hidden('collector_id', array('value' => $this->data['SalesOrder']['collector_id'])); ?>
                               <?php echo $this->Form->text('collector_name', array('value' => $collectorName, 'readonly' => true, 'style' => 'width:70%')); ?>
                               <img alt="Search" search="1" align="absmiddle" style="<?php if($collectorName != ''){ ?>display: none;<?php } ?> cursor: pointer; width: 22px; height: 22px;" class="searchSalesCollector" onmouseover="Tip('<?php echo GENERAL_SEARCH; ?>')" src="<?php echo $this->webroot . 'img/button/search.png'; ?>" />
                               <img alt="Delete" search="0" align="absmiddle" style="<?php if($collectorName == ''){ ?>display: none;<?php } ?> cursor: pointer;" class="deleteSalesCollector" onmouseover="Tip('<?php echo ACTION_DELETE; ?>')" src="<?php echo $this->webroot . 'img/button/delete.png'; ?>" />
                            </div>
                        </td>
                    </tr>
                </table>
            ...
            <td style="width: 17%; vertical-align: top;">
                <table cellpadding="0" style="width: 100%">
                    ...
                    <tr>
                        <td>
                            <?php
                            $filter="AND chart_account_type_id IN (2) AND id IN (SELECT chart_account_id FROM chart_account_companies WHERE company_id IN (SELECT company_id FROM user_companies WHERE user_id = ".$user['User']['id']."))";
                            ?>
                        ...
                        <td style=" vertical-align: top; height: 155px;">
                            <table cellpadding="0" cellspacing="0" style="width: 100%;">
                                ...
                                foreach($termForms AS $termForm){
                                    ...
                                    $input3 = '';
                                    if(!empty($termForm[0])){
                                        $sqlQTerm1 = mysql_query("SELECT term_condition_id FROM sales_order_term_conditions WHERE sales_order_id = ".$this->data['SalesOrder']['id']." AND term_condition_type_id =".$termData1[0]." LIMIT 1");
                                    ...
                                    if(!empty($termForm[1])){
                                        $sqlQTerm2 = mysql_query("SELECT term_condition_id FROM sales_order_term_conditions WHERE sales_order_id = ".$this->data['SalesOrder']['id']." AND term_condition_type_id =".$termData2[0]." LIMIT 1");
                                    ...
                                    if(!empty($termForm[2])){
                                        $sqlQTerm3 = mysql_query("SELECT term_condition_id FROM sales_order_term_conditions WHERE sales_order_id = ".$this->data['SalesOrder']['id']." AND term_condition_type_id =".$termData3[0]." LIMIT 1");
    ...
    <div style="float: right; width: 80%;">
        <table style="width:100%">
            <tr>
                ...
                <td style="width:8%; text-align: right;"><label for="SalesConsignmentDiscountPercent"><?php echo GENERAL_DISCOUNT; ?>:</label></td>
                <td style="width:18%;">
                    <div class="inputContainer" style="width:100%">
                ...
                <td style="width:9%;">
                    <div class="inputContainer" style="width:100%">
                        ...
                        <?php echo $this->Form->text('vat_percent', array('readonly' => true, 'style' => 'width: 50%; height:15px; font-size:12px; font-weight: bold', 'class' => 'float', 'value' => number_format($this->data['SalesOrder']['vat_percent'], 2))); ?> <span class="lblSymbolSalesPercent">(%)</span>
                    </div>
                </td>
