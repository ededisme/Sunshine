...
<script type="text/javascript">
    ...
    $(document).ready(function(){
        ...
        preventKeyEnter();
        // Hide Branch
        $("#VendorConsignmentBranchId").filterOptions('com', '0', '');
        ...
        // Form Validate
        $("#VendorConsignmentAddForm").validationEngine('detach');
        $("#VendorConsignmentAddForm").validationEngine('attach');
        ...
        $("#VendorConsignmentAddForm").ajaxForm({
            dataType: 'json',
            ...
            error: function (result) {
                ...
                createSysAct('Vendor Consignment', 'Add', 2, result.responseText);
            ...
            success: function(result) {
                ...
                if(result.code == "1"){
                    ...
                    createSysAct('Vendor Consignment', 'Add', 1, '');
        ...
        if($.cookie('VendorConsignmentLocationGroupId')!=null || $("#VendorConsignmentLocationGroupId").find("option:selected").val() != ''){
            if($.cookie('VendorConsignmentLocationGroupId') != null){
                $("#VendorConsignmentLocationGroupId").val($.cookie('VendorConsignmentLocationGroupId'));
            } else {
                $.cookie('VendorConsignmentLocationGroupId', $("#VendorConsignmentLocationGroupId").val(), { expires: 7, path: "/" });
            }
        ...
        $("#VendorConsignmentLocationGroupId").change(function(){
            var obj = $(this);
            $.cookie('VendorConsignmentLocationGroupId', obj.val(), { expires: 7, path: "/" });
            checkLocationByGroupVendorConsignment();
        });
        ...
        // Company
        if($.cookie('companyIdVendorConsignment') != null || $("#VendorConsignmentCompanyId").find("option:selected").val() != ''){
            if($.cookie('companyIdSales') != null){
                $("#VendorConsignmentCompanyId").val($.cookie('companyIdVendorConsignment'));
            }
            $("#VendorConsignmentBranchId").filterOptions('com', $("#VendorConsignmentCompanyId").val(), '');
            $("#VendorConsignmentBranchId").change();
        }
    ...
    function checkBfSaveVendorConsignment(){
        var formName     = "#VendorConsignmentAddForm";
    ...
    function checkLocationByGroupVendorConsignment(){
        var locationGroup = $("#VendorConsignmentLocationGroupId").val();
        $("#VendorConsignmentLocationId").filterOptions('location-group', locationGroup, '');
    }
    ...
    function backVendorConsignment(){
        ...
        $("#VendorConsignmentAddForm").validationEngine("hideAll");
        var rightPanel = $("#VendorConsignmentAddForm").parent();
    ...
    function changeInputCSSVendorConsignment(){
        ...
        // Label
        $("#VendorConsignmentAddForm").find("label").removeAttr("class");
        $("#VendorConsignmentAddForm").find("label").each(function(){
        ...
        // Input & Select
        $("#VendorConsignmentAddForm").find("input").each(function(){
            $(this).removeClass(cssRemove);
            $(this).addClass(cssStyle);
        });
        $("#VendorConsignmentAddForm").find("select").each(function(){
...
<input type="hidden" value="" name="data[VendorConsignment][currency_center_id]" id="VendorConsignmentCurrencyCenterId" />
                            ...
                            <td>
                                <div class="inputContainer" style="width:100%">
                                    <select name="data[VendorConsignment][branch_id]" id="VendorConsignmentBranchId" class="validate[required]" style="width: 75%;">
                                        ...
                                        ?>
                                        <option value="<?php echo $branch['Branch']['id']; ?>" com="<?php echo $branch['Branch']['company_id']; ?>" mcode="<?php echo $branch['ModuleCodeBranch']['ven_consign_code']; ?>" currency="<?php echo $branch['Branch']['currency_center_id']; ?>" symbol="<?php echo $branch['CurrencyCenter']['symbol']; ?>"><?php echo $branch['Branch']['name']; ?></option>
                                        <?php
                                        }
                                        ?>
                                    </select>
                ...
                <td>
                    <table cellpadding="0" style="width: 100%">
                        <tr>
                            ...
                            <td style="width: 33%"><label for="VendorConsignmentCode"><?php echo TABLE_CONSIGNMENT_CODE; ?></label> <span class="red">*</span></td>
                            <td style="width: 33%"><label for="VendorConsignmentDate"><?php echo TABLE_CONSIGNMENT_DATE; ?></label> <span class="red">*</span></td>
                        </tr>
                        <tr>
                            <td>
                                <div class="inputContainer" style="width:100%">
                                    <?php echo $this->Form->hidden('vendor_id'); ?>
                                    <?php echo $this->Form->text('vendor_name', array('class' => 'validate[required,funcCall[checkVendorVendorConsignment]]', 'style' => 'width:70%')); ?>
                                    &nbsp;&nbsp; <img alt="Search" align="absmiddle" style="cursor: pointer; width:22px; height: 22px;" id="searchVendorVendorConsignment" onmouseover="Tip('<?php echo GENERAL_SEARCH; ?>')" src="<?php echo $this->webroot . 'img/button/search.png'; ?>" />
                                    <img alt="Delete" align="absmiddle" id="deleteVendorVendorConsignment" onmouseover="Tip('<?php echo ACTION_DELETE; ?>')" src="<?php echo $this->webroot . 'img/button/delete.png'; ?>" style="display:none; cursor: pointer;" />
                                </div>
                            </td>
                            <td>
                                <div class="inputContainer" style="width:100%">
    ...
    <table width="100%">
        <tr>
            ...
            <td id="divSearchVendorConsignment" style="width: 200px; text-align: left;">
                <img alt="Search" align="absmiddle" style="cursor: pointer;" id="VendorConsignmentSearchProduct" onmouseover="Tip('<?php echo GENERAL_SEARCH; ?>')" src="<?php echo $this->webroot . 'img/button/search.png'; ?>" />
            </td>
        ...
        <table cellpadding="0" style="width:100%; padding: 0px; margin: 0px;">
            <tr>
                ...
                <td style="width: 250px;">
                    <?php echo $this->Form->text('total_amount', array('name'=>'data[VendorConsignment][total_amount]', 'readonly' => true, 'style' => 'width: 80%; height:15px; font-size:12px; font-weight: bold', 'value'=> '0.00')); ?> <span class="lblSymbolVendorConsignment"></span>
                </td>
            </tr>
        </table>
    </div>
