            ...
            <table class="table_print">
                ...
                ?>
                    <tr><td class="first" style="text-align: right;"><?php echo++$index; ?></td>
                        ...
                        <td><?php echo $purchaseOrderReceipt['Pv']['pv_code']; ?></td>
                        ...
                        <td style="text-align: right;"><?php echo number_format($purchaseOrderReceipt['Pv']['amount_us'],  $rowOption[0]); ?></td>
                        <td style="text-align: right;"><?php echo number_format($purchaseOrderReceipt['Pv']['amount_other'],  $rowOption[0]); ?></td>
                        <td style="text-align: right;"><?php echo number_format($purchaseOrderReceipt['Pv']['balance'],  $rowOption[0]); ?></td>
                    </tr>
                <?php
                }
                ?>
        ...
        <div style="float: right; width: 250px">
            <table align="right">
                <tr>
                    ...
                    <td style="text-align: right;width: 100px;"><b><?php echo number_format($purchaseOrder['PurchaseOrder']['total_amount'],  $rowOption[0]); ?></b> <?php echo $purchaseOrder['CurrencyCenter']['symbol']; ?> </td>
                </tr>
                <tr>
                    <td class="first" style="border-bottom: none; width: 100px; border-left: none; text-align: right;" colspan="5"><?php echo GENERAL_PAID ?></td>
                    <td style="text-align: right;width: 100px;"><b><?php echo number_format(($purchaseOrder['PurchaseOrder']['total_amount'] - $purchaseOrder['PurchaseOrder']['balance']),  $rowOption[0]); ?></b> <?php echo $purchaseOrder['CurrencyCenter']['symbol']; ?> </td>
                </tr>
                <tr>
                    ...
                    <td style="text-align: right;width: 100px;"><b><?php echo number_format($purchaseOrder['PurchaseOrder']['balance'],  $rowOption[0]); ?></b> <?php echo $purchaseOrder['CurrencyCenter']['symbol']; ?> </td>
                </tr>
            </table>
        </div>
