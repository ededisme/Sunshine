...
<script type="text/javascript">
    $(document).ready(function(){ 
        // Prevent Key Enter
        preventKeyEnter();
        $("#CystoscopyServiceAddCystoscopyServiceDoctorForm").validationEngine();
        $("#CystoscopyServiceAddCystoscopyServiceDoctorForm").ajaxForm({
            dataType: 'json',
        ...
        $(".btnBackQueueCystoscopyService").click(function(event) {
            ...
            oTableQueueCystoscopyDoctor.fnDraw(false);
    ...
    function errorSaveData(){
        ...
        $("#dialog").dialog({
            ...
            close: function(){
                $(this).dialog({close: function(){}});
                $(this).dialog("close");
                var rightPanel=$("#CystoscopyServiceAddCystoscopyServiceDoctorForm").parent();
                var leftPanel=rightPanel.parent().find(".leftPanel");
...
<fieldset style="border: 1px dashed #3C69AD;">
    ...
    <table style="width: 100%;" cellspacing="0">
        <tr>
            <td>
                <?php 
                    $queryDataFromDoctor=  mysql_query("SELECT cysq.*,cysq.id as id FROM cystoscopy_service_requests as cysq "
                            . "INNER JOIN other_service_requests as osreq ON osreq.id=cysq.other_service_request_id "
...
<fieldset style="border: 1px dashed #3C69AD;">
    ...
    <table style="width: 100%;">
        <tr>
            ...
            <td>:</td>
            <td colspan="2"><input type="text" id="descriptBeforeSdate" name="data[CystoscopyService][descript_before_sdate]" style="width:26%;"  class ="validate[required]"></td>
        </tr>
        <tr>
            <td><?php echo TABLE_START_DATE; ?></td>
            <td>:</td>
            <td colspan="2"><input type="text" id="startDate" name="data[CystoscopyService][start_date]" style="width:26%;"></td>
        </tr>
        <tr>
            <td><?php echo TABLE_END_DATE; ?> <span class="red">*</span></td>
            <td>:</td>
            <td colspan="2"><input type="text" id="endDate" name="data[CystoscopyService][end_date]" style="width:26%;" class ="validate[required]"></td>
        </tr>
        <tr>            
            <td><?php echo 'Urethra'; ?></td>
            <td>:</td>
            <td style="width: 200px;">
                <img id="uploadPreview1" class="uploadPreview" style="width: 120px; height: 120px;" data="uploadPreview1"/>
            ...
            <td><?php echo $this->Form->textarea('urethra',array('name'=>'data[CystoscopyService][urethra]','class'=>'mceEditor','style'=>'height:100px;width:650px;')); ?></td>
        </tr>
        <tr style="<?php if ($patient['Patient']['sex'] == "F") { echo 'display:none;';}?>">            
            <td><?php echo 'Prostate'; ?></td>
            <td>:</td>
            <td style="width: 200px;">
                <img id="uploadPreview5" class="uploadPreview" style="width: 120px; height: 120px;" data="uploadPreview5"/>
            ...
            <td><?php echo $this->Form->textarea('prostate',array('name'=>'data[CystoscopyService][prostate]','class'=>'mceEditor','style'=>'height:100px;width:650px;')); ?></td>
        </tr>
        <tr>            
            <td><?php echo 'Bladder neck'; ?></td>
            <td>:</td>
            <td style="width: 200px;">
                <img id="uploadPreview2" class="uploadPreview" style="width: 120px; height: 120px;" data="uploadPreview2"/>
            ...
            <td><?php echo $this->Form->textarea('bladder_neck',array('name'=>'data[CystoscopyService][bladder_neck]','class'=>'mceEditor','style'=>'height:100px;width:650px;')); ?></td>
        </tr>
        <tr>            
            <td><?php echo 'Bladder'; ?></td>
            <td>:</td>
            <td style="width: 200px;">
                <img id="uploadPreview3" class="uploadPreview" style="width: 120px; height: 120px;" data="uploadPreview3"/>
            ...
            <td><?php echo $this->Form->textarea('bladder',array('name'=>'data[CystoscopyService][bladder]','class'=>'mceEditor','style'=>'height:100px;width:650px;')); ?></td>
        </tr>
        <tr style="<?php if ($patient['Patient']['sex'] == "M") { echo 'display:none;';}?>">            
            <td><?php echo 'After 5 minutes <br/>cysto-hydrodistention'; ?></td>
            <td>:</td>
            <td style="width: 200px;">
                <img id="uploadPreview4" class="uploadPreview" style="width: 120px; height: 120px;" data="uploadPreview4"/>
            ...
            <td><?php echo $this->Form->textarea('after_five_minute',array('name'=>'data[CystoscopyService][after_five_minute]','class'=>'mceEditor','style'=>'height:100px;width:650px;')); ?></td>
        </tr>
        <tr>
            <td><?php echo TABLE_CONCLUSION; ?></td>
            <td>:</td>
            <td colspan="2"><?php echo $this->Form->textarea('conclusion',array('name'=>'data[CystoscopyService][conclusion]','class'=>'mceEditor','style'=>'height:100px;width:650px;')); ?></td>
        </tr>        
    </table>
</fieldset>
<div class="clear"></div>
