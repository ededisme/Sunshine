...
<table style="width: 99%;">
    <tr>
        ...
        <td>
            <div class="inputContainer" style="width: 100%;">
                <?php echo $this->Form->text('customer_code', array('class' => 'validate[required]', 'style' => 'width: 90%; text-align: left;', 'value' => $code)); ?>
            </div>
        </td>
    </tr>
    <tr>
    ...
    <tr>
        ...
        <td>
            <div class="inputContainer" style="width: 100%;">
                <?php echo $this->Form->text('name_kh', array('class' => 'validate[required]', 'style' => 'width: 90%; text-align: left;')); ?>
            </div>
        </td>
    </tr>
    <tr>
