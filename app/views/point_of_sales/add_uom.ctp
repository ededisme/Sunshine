...
<fieldset style="width: 440px; float: left;">
    ...
    <table style="width: 100%;" cellpadding="5">
        ...
        <tr>
            ...
            <td>
                <div class="inputContainer" style="width: 100%;">
                    <?php echo $this->Form->text('name', array('class'=>'validate[required]', 'id' => 'UomName', 'name' => 'data[Uom][name]', 'style' => 'width: 250px; text-align: left;')); ?>
                </div>
            </td>
        </tr>
        <tr>
            ...
            <td>
                <div class="inputContainer" style="width: 100%;">
                    <?php echo $this->Form->text('abbr', array('class'=>'validate[required]', 'id' => 'UomAbbr', 'name' => 'data[Uom][abbr]', 'style' => 'width: 250px; text-align: left;')); ?>
                </div>
            </td>
        </tr>
        <tr>
            ...
            <td>
                <div class="inputContainer" style="width: 100%;">
                    <?php echo $this->Form->textarea('description', array('id' => 'UomDescription', 'name' => 'data[Uom][description]', 'style' => 'width: 250px; text-align: left;')); ?>
                </div>
            </td>
        </tr>
    </table>
...
<fieldset style="width: 440px; float: right;">
    ...
    <table>
        <tr>
            ...
            <td><?php echo $this->Form->text('value', array('id'=>'UomConversionValueSmallQuick','class'=>'validate[required] float', 'style'=>'width:60px; text-align: left;', 'name' => 'data[UomConversion][value]')); ?></td>
        </tr>
    </table>
    <br/>
    <fieldset>
        ...
        <table id="tblOtherUom">
            ...
            <tr id="otherUom" class="otherUom">
                ...
                <td>
                    ...
                    <?php echo $this->Form->text('value', array('name'=>'data[other_value][]', 'id'=>'UomConversionValueOtherQuick', 'class'=>'UomConversionValueOtherQuick validate[required] float', 'style'=>'width:60px; text-align: left;')); ?></td>
                <td>
