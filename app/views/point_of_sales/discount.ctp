...
<div style="overflow: auto;width: 100%; padding: 0px; margin: 0px; " >
    <table class="table" style="" cellspacing="0" >
        <thead>
            <tr>
                <th style="text-align: center;" class="first" style="width:8%"></th>
                <th style="width:23%; text-align: center;"><?php echo TABLE_NAME; ?></th>
                <th style="width:23%; text-align: center;"><?php echo GENERAL_DESCRIPTION; ?></th>
                <th style="width:23%; text-align: center;"><?php echo TABLE_PERCENT; ?> (%)</th>
                <th style="width:23%; text-align: center;"><?php echo GENERAL_AMOUNT; ?> <?php echo TABLE_CURRENCY_DEFAULT; ?></th>
            </tr>
        </thead>
        <tbody style="width: 774px; ">
            ...
            ?>">
                    <input type="radio" name="chkPOSDiscount" value="<?php echo $discount['Discount']['id']; ?>" />
                    <input type="hidden" name="POSDiscountAmount" value="<?php echo $discount['Discount']['amount']; ?>" />
                    <input type="hidden" name="POSDiscountPercent" value="<?php echo $discount['Discount']['percent']; ?>" />
                </td>
