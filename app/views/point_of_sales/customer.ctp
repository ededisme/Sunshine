...
<script type="text/javascript">
    $(document).ready(function(){
        ...
        var oSOCustomerTable = $("#<?php echo $tblName; ?>").dataTable({
            "bProcessing": true,
            "bServerSide": true,
    ...
    <table id="<?php echo $tblName; ?>" class="table" cellspacing="0" width="100%">
        <thead>
            <tr>
                ...
                <th style="text-align: center;"><?php echo TABLE_CUSTOMER_NUMBER; ?></th>
                <th style="text-align: center;"><?php echo TABLE_NAME_IN_KHMER; ?></th>
                <th style="text-align: center;"><?php echo TABLE_NAME; ?></th>
                <th style="text-align: center;"><?php echo TABLE_SEX; ?></th>
                <th style="text-align: center;"><?php echo TABLE_TELEPHONE; ?></th>
            </tr>
        </thead>
        <tbody>
            <tr>
