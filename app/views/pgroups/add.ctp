...
<script type="text/javascript">
    ...
    $(document).ready(function(){
        ...
        $("#PgroupAddForm").validationEngine('attach', {
            isOverflown: true,
            overflownDIV: ".ui-tabs-panel"
        });
        $("#PgroupAddForm").ajaxForm({
            ...
            success: function(result) {
                ...
                if(result != '<?php echo MESSAGE_DATA_HAS_BEEN_SAVED; ?>' && result != '<?php echo MESSAGE_DATA_COULD_NOT_BE_SAVED; ?>' && result != '<?php echo MESSAGE_DATA_ALREADY_EXISTS_IN_THE_SYSTEM; ?>'){
                    createSysAct('Pgroup', 'Add', 2, result);
                    $("#dialog").html('<p><span class="ui-icon ui-icon-info" style="float:left; margin:0 7px 20px 0;"></span><?php echo MESSAGE_PROBLEM; ?></p>');
                }else {
                    createSysAct('Pgroup', 'Add', 1, '');
                    // alert message
            ...
            <tr>
                ...
                <td>
                    <div class="inputContainer" style="width: 100%;">
                        <select name="data[Pgroup][user_apply]" id="PgroupUserApply" style="width: 200px;">
...
<table cellpadding="0" cellspacing="0" width="100%">
    <tr>
                ...
                <table style="width: 100%;">
                    ...
                    <tr>
                        ...
                        <td style="vertical-align: top;">
                            <select class="pgroupProducts" id="pgroupProductId" name="data[Pgroup][product_id][]" multiple="multiple" style="width: 420px; height: 150px;"></select>
                        </td>
                    </tr>
                    <tr>
                        <td></td>
        ...
        <td style="width: 50%; display: none;" id="formUserApplyPgroup">
            <fieldset>
                ...
                <table>
                    ...
                    <tr>
                        ...
                        <td style="vertical-align: top;">
                            <select id="userPgroupSelected" name="data[Pgroup][user_id][]" multiple="multiple" style="width: 300px; height: 200px;"></select>
                        </td>
                    </tr>
                </table>
            </fieldset>
