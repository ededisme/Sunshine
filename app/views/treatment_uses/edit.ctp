...
<script type="text/javascript">
    $(document).ready(function(){
        // Prevent Key Enter
        preventKeyEnter();
        $("#TreatmentUseEditForm").validationEngine();
        $("#TreatmentUseEditForm").ajaxForm({
...
<br />
<?php 
echo $this->Form->create('TreatmentUse'); ?>
<fieldset>
    <legend><?php __(MENU_FREQUENCY); ?></legend>
    <table>
        <input type="hidden" name="data[TreatmentUse][id]" value="<?php echo $this->data['TreatmentUse']['id']; ?>">
        <tr>
            <td><label for="TreatmentUseName"><?php echo TABLE_NAME; ?> <span class="red">*</span> :</label></td>
            <td>
