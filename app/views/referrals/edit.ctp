...
<script type="text/javascript">
    ...
    $(document).ready(function(){
        // Prevent Key Enter
        preventKeyEnter();
        $("#ReferralEditForm").validationEngine('attach', {
            isOverflown: true,
            overflownDIV: ".ui-tabs-panel"
        });
        $("#ReferralEditForm").ajaxForm({
            ...
            success: function(result) {
                ...
                if(result != '<?php echo MESSAGE_DATA_HAS_BEEN_SAVED; ?>' && result != '<?php echo MESSAGE_DATA_COULD_NOT_BE_SAVED; ?>' && result != '<?php echo MESSAGE_DATA_ALREADY_EXISTS_IN_THE_SYSTEM; ?>'){
                    createSysAct('Referral', 'Edit', 2, result);
                    $("#dialog").html('<p><span class="ui-icon ui-icon-info" style="float:left; margin:0 7px 20px 0;"></span><?php echo MESSAGE_PROBLEM; ?></p>');
                }else {
                    createSysAct('Referral', 'Edit', 1, '');
                    // alert message
...
<br />
<?php 
echo $this->Form->create('Referral', array('inputDefaults' => array('div' => false, 'label' => false))); 
    ...
    <fieldset>
        ...
        <table style="height: 100px;">
            <tr>
                ...
                <td>
                    <div class="inputContainer">
                        <?php echo $this->Form->text('name', array('class' => 'validate[required]','value' => $referral['Referral']['name'])); ?>
                    </div>
                </td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td>
                    <div class="inputContainer">
                        <?php echo $this->Form->text('telephone',array('class' => 'validate[required]', 'value' => $referral['Referral']['telephone'])); ?>
                    </div>
                </td>
            </tr>
            <tr>
