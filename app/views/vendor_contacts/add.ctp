...
<script type="text/javascript">
    ...
    $(document).ready(function(){
        ...
        // Action Save
        $("#VendorContactAddForm").validationEngine();
        $("#VendorContactAddForm").ajaxForm({
...
<br />
<?php echo $this->Form->create('VendorContact', array('inputDefaults' => array('div' => false, 'label' => false))); 
...
<fieldset>
    ...
    <table>
        ...
        <tr>
            <td><label for="VendorContactUserSex"><?php echo TABLE_SEX; ?> <span class="red">*</span> :</label></td>
            <td>
