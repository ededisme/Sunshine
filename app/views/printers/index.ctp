...
<script type="text/javascript">
    ...
    $(document).ready(function(){
        ...
        oTablePrinter = $("#<?php echo $tblName; ?>").dataTable({
            "bProcessing": true,
            "bServerSide": true,
            ...
            "fnInfoCallback": function( oSettings, iStart, iEnd, iMax, iTotal, sPre ) {
                ...
                $(".btnViewPrinter").click(function(event){
                ...
                $(".btnEditPrinter").click(function(event){
                    event.preventDefault();
                    var id = $(this).attr('rel');
                    var leftPanel=$(this).parent().parent().parent().parent().parent().parent().parent();
                    var rightPanel=leftPanel.parent().find(".rightPanel");
                ...
                $(".btnDeletePrinter").click(function(event){
                    event.preventDefault();
                    var id = $(this).attr('rel');
        ...
        $(".btnAddPrinter").click(function(event){
            event.preventDefault();
...
<div class="leftPanel">
    <div style="padding: 5px;border: 1px dashed #bbbbbb;">
        <?php if($allowAdd){ ?>
        <div class="buttons">
            <a href="" class="positive btnAddPrinter">
                <img src="<?php echo $this->webroot; ?>img/button/plus.png" alt=""/>
                <?php echo MENU_PRINTER_ADD; ?>
            </a>
        </div>
        <?php } ?>
        <div class="buttons">
            <a href="<?php echo $this->webroot; ?>public/js_print_setup.xpi" class="positive">
                <img src="<?php echo $this->webroot; ?>img/button/plus.png" alt=""/>
                <?php echo ACTION_SET_JS_PRINTER; ?>
            </a>
        </div>
        ...
        <table id="<?php echo $tblName; ?>" class="table" cellspacing="0">
            <thead>
                <tr>
                    ...
                    <th><?php echo TABLE_PRINTER_NAME; ?></th>
                    <th><?php echo TABLE_SILENT; ?></th>
