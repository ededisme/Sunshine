...
<script type="text/javascript">
    ...
    $(document).ready(function(){
        ...
        $(".chzn-select").chosen();
        $("#CustomerEditForm").validationEngine('attach', {
            isOverflown: true,
            overflownDIV: ".ui-tabs-panel"
        });
        // Action Save
        $("#CustomerEditForm").ajaxForm({
            ...
            success: function(result) {
                ...
                if(result != '<?php echo MESSAGE_DATA_HAS_BEEN_SAVED; ?>' && result != '<?php echo MESSAGE_DATA_COULD_NOT_BE_SAVED; ?>' && result != '<?php echo MESSAGE_DATA_ALREADY_EXISTS_IN_THE_SYSTEM; ?>'){
                    createSysAct('Customer', 'Edit', 2, result);
                    $("#dialog").html('<p><span class="ui-icon ui-icon-info" style="float:left; margin:0 7px 20px 0;"></span><?php echo MESSAGE_PROBLEM; ?></p>');
                }else {
                    createSysAct('Customer', 'Edit', 1, '');
                    // alert message
...
<fieldset>
    ...
    ?>
    <?php echo $this->Form->input('id', array('value' => $this->data['Customer']['id'], 'type' => 'hidden')); ?>
    <input type="hidden" id="<?php echo $this->data['Customer']['sys_code']; ?>" name="data[Customer][sys_code]" />
    <input type="hidden" id="<?php echo $photoNameHidden; ?>" name="data[Customer][new_photo]" />
    <input type="hidden" name="data[Customer][old_photo]" value="<?php echo $this->data['Customer']['photo']; ?>" />
    <div style="width: 40%; vertical-align: top; float: left;">
        <table style="width: 99%;">
            ...
            <tr>
                ...
                <td>
                    <div class="inputContainer" style="width: 100%;">
                        <?php echo $this->Form->text('customer_code', array('class' => 'validate[required]', 'style' => 'width: 90%;')); ?>
                    </div>
                </td>
            </tr>
            <tr>
            ...
            <tr>
                <td style="width: 30%;"><label for="CustomerNameKh"><?php echo TABLE_NAME_IN_KHMER; ?> <span class="red">*</span> :</label></td>
                <td>
                    <div class="inputContainer" style="width: 100%;">
            ...
            <tr>
                ...
                <td>
                    <div class="inputContainer" style="width: 100%;">
                        <?php echo $this->Form->input('cgroup_id', array('selected' => $cgroupsSellected, 'label' => false, 'empty' => INPUT_SELECT)); ?>
                    </div>
                </td>
            </tr>
            <tr>
                ...
                <td>
                    <div class="inputContainer" style="width: 100%;">
                        <select name="data[Customer][type]" id="CustomerType" class="validate[required]" style="width: 93%;">
                            ...
                            <option value="1" <?php if($this->data['Customer']['type'] == 1){ ?>selected="selected"<?php } ?>><?php echo TABLE_CAMBODIA; ?></option>
                            <option value="2" <?php if($this->data['Customer']['type'] == 2){ ?>selected="selected"<?php } ?>><?php echo TABLE_CUSTOMER_OVERSEA; ?></option>
                        </select>
                    </div>
                </td>
            </tr>
            <tr id="addressOverSea" style="display: none;">
                <td colspan="2">
                    <fieldset>
                        ...
                        <div class="inputContainer" style="width: 100%;">
                            <?php echo $this->Form->textarea('address', array('value' => $this->data['Customer']['address'], 'style' => 'width: 90%; height: 80px;')); ?>
                        </div>
                    </fieldset>
                </td>
            </tr>
                                ...
                                <td>
                                    <div class="inputContainer" style="width: 100%;">
                                        <select name="data[Customer][province_id]" class="province" id="CustomerProvinceId" style="width: 95%;">
                                            ...
                                            ?>
                                            <option value="<?php echo $province['Province']['id']; ?>" <?php if($province['Province']['id'] == $this->data['Customer']['province_id']){ ?>selected="selected"<?php } ?> abbr="<?php echo $province['Province']['abbr']; ?>"><?php echo $province['Province']['name']; ?></option>
                                            <?php
                                            }
                                            ?>
                                        </select>
    ...
    <div style="width: 30%; vertical-align: top; float: left;">
        <table style="width: 100%;">
            ...
            <tr>
                ...
                <td>
                    <div class="inputContainer" style="width: 100%;">
                        <?php echo $this->Form->text('limit_balance', array('style' => 'width: 90%;')); ?>
                    </div>
                </td>
            </tr>
            <tr>
                ...
                <td>
                    <div class="inputContainer" style="width: 100%;">
                        <?php echo $this->Form->text('limit_total_invoice', array('style' => 'width: 90%;')); ?>
                    </div>
                </td>
            </tr>
            <tr>
                ...
                <tr>
                    <td colspan="2" style="text-align: center;">
                        ...
                        if($this->data['Customer']['photo'] != ''){
                            $photo = "public/customer_photo/".$this->data['Customer']['photo'];
                        }else{
