...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        // Prevent Key Enter
        preventKeyEnter();
        $("#ServicesPriceInsuranceCloneServicePriceForm").validationEngine();
        $("#ServicesPriceInsuranceCloneServicePriceForm").ajaxForm({
            ...
            success: function(result) {
                ...
                $(".btnBackServicePriceInsurance").dblclick();
                // alert message
        ...
        $(".btnBackServicePriceInsurance").dblclick(function(event) {
...
<fieldset>
    ...
    <table style="width: 100%;" cellspacing="0">              
        <tr>
            ...
            <td>To :</td>
            <td><label for="ServicesPriceInsuranceCompanyInsuranceIdTo"><?php echo TABLE_COMPANY_INSURANCE_NAME; ?> <span class="red">*</span> </label></td>
            <td>                
                <select id="ServicesPriceInsuranceCompanyInsuranceIdTo" class="validate[required]" name="data[ServicesPriceInsurance][company_insurance_id_to]">
