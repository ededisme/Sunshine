        ...
        <div>
            <table class="table_print">
                <tr>
                    ...
                    <th style="width: 240px !important;"><?php echo TABLE_VENDOR; ?></th>
                ...
                $queryDetail=mysql_query("  SELECT
                                                (SELECT name AS vendor_name FROM vendors WHERE id=vendor_id) AS vendor_name,
                                                paid,
                                                memo
                                            FROM ap_aging_details WHERE ap_aging_id=".$data['id']);
                ...
                <tr>
                    ...
                    <td><?php echo $dataDetail['vendor_name']; ?></td>
