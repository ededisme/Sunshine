...
<script type="text/javascript">
    $(document).ready(function(){
        // Prevent Key Enter
        preventKeyEnter();
        $("#BudgetPlAddForm").validationEngine('attach', {
            isOverflown: true,
            overflownDIV: ".ui-tabs-panel"
        });
        $("#BudgetPlAddForm").ajaxForm({
            ...
            success: function(result) {
                ...
                var rightPanel=$("#BudgetPlAddForm").parent().parent();
...
<div style="padding: 5px;border: 1px dashed #bbbbbb;" id="header_<?php echo $rnd; ?>">
    <div class="buttons">
...
<fieldset id="info_<?php echo $rnd; ?>">
...
<fieldset>
    ...
    <table class="table" cellspacing="0" id="table_<?php echo $rnd; ?>">
        <tr>
            <th class="first" style="width: 22%;">
            ...
            <?php for($i=0;$i<12;$i++){ ?>
            <th style="text-align: center; width: 6%;"><?php echo $monthName[$i]; ?></th>
            <?php } ?>
        ...
        <tr class="groupDetail" chart_account_group_id="<?php echo $dataGroupIncome['id']; ?>" style="display: none;">
            ...
            <td>
                <div class="inputContainer">
                    <input type="text" value="" id="c<?php echo $dataGroupDetail['id']; ?>m<?php echo $i; ?>" name="m<?php echo $i; ?>[]" class="number validate[optional,custom[number]] incomeDetail<?php echo $i; ?>" onkeyup="calcIncomeDetail(<?php echo $i; ?>)" style="width: 45px;" />
                </div>
            </td>
            <?php } ?>
        ...
        <tr class="groupDetail" chart_account_group_id="<?php echo $dataGroupCOGS['id']; ?>" style="display: none;">
            ...
            <td>
                <div class="inputContainer">
                    <input type="text" value="" id="c<?php echo $dataGroupDetail['id']; ?>m<?php echo $i; ?>" name="m<?php echo $i; ?>[]" class="number validate[optional,custom[number]] cogsDetail<?php echo $i; ?>" onkeyup="calcCogsDetail(<?php echo $i; ?>)" style="width: 45px;" />
                </div>
            </td>
            <?php } ?>
        ...
        <tr class="groupDetail" chart_account_group_id="<?php echo $dataGroupExpense['id']; ?>" style="display: none;">
            ...
            <td>
                <div class="inputContainer">
                    <input type="text" value="" id="c<?php echo $dataGroupDetail['id']; ?>m<?php echo $i; ?>" name="m<?php echo $i; ?>[]" class="number validate[optional,custom[number]] expenseDetail<?php echo $i; ?>" onkeyup="calcExpenseDetail(<?php echo $i; ?>)" style="width: 45px;" />
                </div>
            </td>
            <?php } ?>
        ...
        <tr class="groupDetail" chart_account_group_id="<?php echo $dataGroupOtherIncome['id']; ?>" style="display: none;">
            ...
            <td>
                <div class="inputContainer">
                    <input type="text" value="" id="c<?php echo $dataGroupDetail['id']; ?>m<?php echo $i; ?>" name="m<?php echo $i; ?>[]" class="number validate[optional,custom[number]] incomeOtherDetail<?php echo $i; ?>" onkeyup="calcIncomeOtherDetail(<?php echo $i; ?>)" style="width: 45px;" />
                </div>
            </td>
            <?php } ?>
        ...
        <tr class="groupDetail" chart_account_group_id="<?php echo $dataGroupOtherExpense['id']; ?>" style="display: none;">
            ...
            <td>
                <div class="inputContainer">
                    <input type="text" value="" id="c<?php echo $dataGroupDetail['id']; ?>m<?php echo $i; ?>" name="m<?php echo $i; ?>[]" class="number validate[optional,custom[number]] expenseOtherDetail<?php echo $i; ?>" onkeyup="calcExpenseOtherDetail(<?php echo $i; ?>)" style="width: 45px;" />
                </div>
            </td>
            <?php } ?>
        ...
        <tr class="groupDetail" chart_account_group_id="<?php echo $dataGroupExpense['id']; ?>" style="display: none;">
            ...
            <td>
                <div class="inputContainer">
                    <input type="text" value="" id="c<?php echo $dataGroupDetail['id']; ?>m<?php echo $i; ?>" name="m<?php echo $i; ?>[]" class="number validate[optional,custom[number]] expenseInterestDetail<?php echo $i; ?>" onkeyup="calcExpenseInterestDetail(<?php echo $i; ?>)" style="width: 45px;" />
                </div>
            </td>
            <?php } ?>
        ...
        <tr class="groupDetail" chart_account_group_id="<?php echo $dataGroupExpense['id']; ?>" style="display: none;">
            ...
            <td>
                <div class="inputContainer">
                    <input type="text" value="" id="c<?php echo $dataGroupDetail['id']; ?>m<?php echo $i; ?>" name="m<?php echo $i; ?>[]" class="number validate[optional,custom[number]] expenseTaxDetail<?php echo $i; ?>" onkeyup="calcExpenseTaxDetail(<?php echo $i; ?>)" style="width: 45px;" />
                </div>
            </td>
            <?php } ?>
    ...
    <table id="<?php echo $rnd; ?>_head" class="table" style="position: fixed; padding: 0px; margin: 0px; display: none;" cellspacing="0">
        <thead>
            <tr></tr>
        </thead>
    </table>
