        ...
        <div>
            <table class="table_print">
                <tr>
                    ...
                    <th style="width: 240px !important;"><?php echo TABLE_CUSTOMER; ?></th>
                ...
                $queryDetail=mysql_query("  SELECT
                                                (SELECT CONCAT_WS(' ', customer_code, '-', name) AS customer_name FROM customers WHERE id=customer_id) AS customer_name,
                                                paid,
                                                memo
                ...
                <tr>
                    ...
                    <td><?php echo $dataDetail['customer_name']; ?></td>
