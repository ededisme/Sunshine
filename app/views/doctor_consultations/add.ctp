...
<script type="text/javascript">
    $(document).ready(function() {
        // Prevent Key Enter
        preventKeyEnter();
        $("#sex_doctor").chosen({width: 410});
        $("#DoctorConsultationAddForm").validationEngine('attach', {
            isOverflown: true,
            overflownDIV: ".ui-tabs-panel"
        });
        $("#DoctorConsultationAddForm").ajaxForm({
...
<fieldset>
    ...
    <table style="width: 50%;">
        ...
        <tr>
            <td style="width: 30%;"><label for="Sex"> <?php echo TABLE_SEX; ?> : </label></td>
            <td style="width: 70%;">
                <div class="inputContainer" style="width: 100%;">
                    <?php echo $this->Form->input('sex', array('label' => false, 'data-placeholder' => INPUT_SELECT, 'id' => 'sex_doctor', 'style'=>'width: 73%;')); ?>
                </div>
            </td>
        </tr>
        <tr>
            ...
            <td style="width: 70%;">
                <div class="inputContainer" style="width: 100%;">
                    <?php echo $this->Form->text('phone_number', array('id' => 'PhoneNumber')); ?>
                </div>
            </td>
        </tr>
        <tr>
            ...
            <td style="width: 70%;">
                <div class="inputContainer" style="width: 100%;">
                    <?php echo $this->Form->text('email', array('id' => 'Email', 'class' => 'validate[optional,custom[email]]')); ?>
                </div>
            </td>
        </tr>
    </table>
