...
<script type="text/javascript">
    var oTableDoctorConsultation;
    $(document).ready(function(){
        // Prevent Key Enter
        preventKeyEnter();
        $("#<?php echo $tblName; ?> td:first-child").addClass('first');
        oTableDoctorConsultation = $("#<?php echo $tblName; ?>").dataTable({
            "bProcessing": true,
            "bServerSide": true,
            ...
            "fnInfoCallback": function( oSettings, iStart, iEnd, iMax, iTotal, sPre ) {
                ...
                $(".btnViewDoctorConsultation").click(function(event){
                ...
                $(".btnEditDoctorConsultation").click(function(event){
                    event.preventDefault();
                    var id = $(this).attr('rel');
                    var leftPanel=$(this).parent().parent().parent().parent().parent().parent().parent();
                    var rightPanel=leftPanel.parent().find(".rightPanel");
                ...
                $(".btnDeleteDoctorConsultation").click(function(event){
                    event.preventDefault();
                    var id = $(this).attr('rel');
        ...
        $(".btnAddDoctorConsltation").click(function(event){
            event.preventDefault();
...
<div class="leftPanel">
    <div style="padding: 5px;border: 1px dashed #bbbbbb;">
        <?php if($allowAdd){ ?>
        <div class="buttons">
            <a href="" class="positive btnAddDoctorConsltation">
                <img src="<?php echo $this->webroot; ?>img/button/plus.png" alt=""/>
                <?php echo MENU_DOCTOR_CONSULTATION_ADD_NEW; ?>
                <img src="<?php echo $this->webroot; ?>img/button/doctor_4.png" alt=""/>
            </a>
        </div>
        <?php } ?>
