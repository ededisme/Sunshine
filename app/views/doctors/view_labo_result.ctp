...
?>
<h1 class="title"><?php __(OTHER_BLOOD_TEST); ?></h1>
                                        ...
                                        if (in_array($i['LaboItem']['id'], $item_requests) || in_array($i['LaboItem']['parent_id'], $item_requests)) {
                                            ...
                                            if ($i['LaboItem']['id'] == "182" || $i['LaboItem']['id'] == "161" || $i['LaboItem']['id'] == "196") {
                                                ...
                                                if ($i['LaboItem']['title_item'] != NULL) {
                                                    ...
                                                    echo '<tr>';
                                                    echo '<td style="white-space: nowrap;font-family:monospace;width: 450px;padding-left:30px">' . ($i['LaboItem']['parent_id'] != NULL ? '&nbsp;&nbsp;&nbsp;&nbsp;' : '') . mb_str_pad($i['LaboItem']['name'], 70, '.', STR_PAD_RIGHT) . ':' . '</td>';
                                                    if ($i['LaboItem']['normal_value_type'] == "Positive / Negative") {
                                                        ...
                                                        echo '<td style="color:#000;white-space: nowrap;font-family:monospace;width: 200px;font-size: 14px">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>';
                                                        ...
                                                        if ($i['LaboItem']['item_unit'] == "/mm3") {
                                                            ...
                                                            if ($var == "<" || $var == ">") {
                                                                ...
                                                                if ($var == "<=") {
                                                                    if ($result > $newVar) {
                                                                        echo '<td style="white-space: nowrap;font-family:monospace;width: 194px;font-weight: bold">' . $result . '</td>';
                                                                    } else {
                                                                ...
                                                                echo '<td style="white-space: nowrap;font-family:monospace;width: 194px;font-weight: bold">' . (isset($item_results[$i['LaboItem']['id']]) ? $item_results[$i['LaboItem']['id']] : '') . '</td>';
                                                            } else {
                                                            ...
                                                            echo '<td style="white-space: nowrap;font-family:monospace;width: 200px;">' . $type . '</td>';
                                                        } else {
                                                            if ($var == "<" || $var == ">") {
                                                                if ($min != "") {
                                                                    $code = trim($min);
                                                            ...
                                                            echo '<td style="white-space: nowrap;font-family:monospace;width: 200px;">' . $i['LaboItem']['item_unit'] . '</td>';
                                                        }
                                                    }
                                                    if (trim($min) == '') {
                                                        echo ' <td style="white-space: nowrap;font-family:monospace;width: 190px;">' . ($i['LaboItem']['normal_value_type'] != 'Positive / Negative' ? $max : '') . '</td>';
                                                    } else if (trim($max) == '') {
                                                        echo ' <td style="white-space: nowrap;font-family:monospace;width: 190px;">' . ($i['LaboItem']['normal_value_type'] != 'Positive / Negative' ? $min : '') . '</td>';
                                                    } else {
                                                        echo ' <td style="white-space: nowrap;font-family:monospace;width: 190px;">' . ($i['LaboItem']['normal_value_type'] != 'Positive / Negative' ? ' (' . $min . ' - ' . $max . ')' : '') . '</td>';
                                                    }
                                                    echo '</tr>';
                                                    $oldLaboTitle = $i['LaboItem']['title_item'];
                                                } else {
                                                    echo '<tr>';
                                                    echo '<td style="white-space: nowrap;font-family:monospace;width: 450px;padding-left:15px">' . ($i['LaboItem']['parent_id'] != NULL ? '&nbsp;&nbsp;&nbsp;&nbsp;' : '') . mb_str_pad($i['LaboItem']['name'], 72, '.', STR_PAD_RIGHT) . ':' . '</td>';
                                                    if ($i['LaboItem']['normal_value_type'] == "Positive / Negative") {
                                                        echo '<td style="white-space: nowrap;font-family:monospace;width: 400px;font-weight: bold">' . ($item_results[$i['LaboItem']['id']][0] == 'Positive' ? '<b>Positive</b> &nbsp;' . $item_results[$i['LaboItem']['id']][1] : "<b>" . $item_results[$i['LaboItem']['id']][0] . "</b>" ) . '</td>';
                                                    } else if ($i['LaboItem']['normal_value_type'] == "Free Style") {
                                                        if (isset($item_results[$i['LaboItem']['id']])) {
