...
<script type="text/javascript">
    ...
    $(document).ready(function(){
        ...
        $("#btnSalesOrderInfo").click(function(){
            $("#CMTopOrderDoctor").hide(900);
            $("#showSaleOrderInfo").show();
        });
        
        $("#btnSalesOrderInfoShow").click(function(){
            $("#CMTopOrderDoctor").show(900);
            $("#showSaleOrderInfo").hide();
        });
    ...
    function loadOrderDetailOrder(){
        ...
        $.ajax({
            type: "POST",
            url: "<?php echo $this->base . '/' . $this->params['controller']; ?>/orderDetails/"+patientId,
            beforeSend: function(){
                $(".orderDetailOrderDoctor").html('<img alt="Loading" src="<?php echo $this->webroot; ?>img/ajax-loader.gif" />');
                $("#tblOrder").html("");
            ...
            success: function(msg){
                $(".orderDetailOrderDoctor").html(msg);
                $(".footerSaveOrderDoctor").show();
//                // Action VAT Status
//                $("#OrderStatus").removeAttr("disabled");
//                $("#OrderStatus").change(function(){
//                    var vatPercent = $(this).val();
//                    var vatStatus  = $(this).find("option:selected").attr("data-s");
//                    $("#OrderVatStatus").val(vatStatus);
//                    $("#OrderVatPercent").val(vatPercent);
//                    getTotalAmountOrder();
//                });
            }
        });
...
<?php echo $this->Form->create('Doctor', array('id' => 'DoctorAddForm', 'url' => '/doctors/tabPrescription/' . $this->params['pass'][0].'/'.$this->params['pass'][1], 'enctype' => 'multipart/form-data')); ?>
<?php 
...
<legend id="showSaleOrderInfo" style="display:none;"><a href="#" id="btnSalesOrderInfoShow" style="background: #CCCCCC; font-weight: bold;"><?php __(MENU_ORDER_INFO); ?> [ Show ] </a> </legend>
<fieldset id="CMTopOrderDoctor">
...
<div class="orderDetailOrderDoctor" style=" margin-top: 5px; text-align: center;"></div>
<br><br>
