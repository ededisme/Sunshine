    ...
    foreach ($consultation as $consultation):
            ...
            <table border="0" cellspacing='0' cellpadding='2' style="padding: 0; margin: 0;">
                <tr>
                    <td style="text-align: left">
                        <h2 style="font-size: 12px; line-height: 0px; text-transform: uppercase;"><?php echo $this->data['Branch']['name'] ?></h2>         
                    </td>
                </tr>
                <tr>
                    <td>
                        Doctor <b>UNG VISOTH MONY</b>, Senior Pediatrician
                    </td>
                </tr>
                <tr>
                    <td>
                        Specialize Doctor Diploma in Pediatric
                    </td>
                </tr>
                <tr>
                    <td>
        ...
        <div style="width: 100%;">
            <table border="0" cellspacing='0' cellpadding='3' style="padding: 0; margin: 0;">
                <tr>
                    <td style="text-align: left; padding-left: 30%;"><h2 style="font-size: 14px;"><?php echo TITLE_MEDICAL_CERTIFICATE; ?></h2></td>
                </tr>
                <tr>
        ...
        <div style="width: 80%; float: right; padding-top: 20%;">
            <table class="table" cellspacing='0' cellpadding='0' style="padding: 0; margin: 0;">
                ...
                <tr>
                    <td style="text-align: center; border: none;">UNG VISOTH MONY, Pediatrician</td>
                </tr>
                <tr>
