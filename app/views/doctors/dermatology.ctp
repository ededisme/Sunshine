...
<script type="text/javascript">
    $(document).ready(function(){
        ...
        $("#btnSubmit").click(function(){
            $.ajax({
                type: "POST",
                url: "<?php echo $absolute_url.$this->params['controller']; ?>/dermatologyResult",
                data: $("#frmdermatology").serialize(),
                beforeSend: function(){
                    $("#loading").show();
                },
...
<div class="legend">
    <div class="legend_title"><?php echo MENU_REPORT_DERMATOLOGY; ?></div>
    <div class="legend_content">
        <form id="frmdermatology" action="" method="post">
