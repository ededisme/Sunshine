...
<script type="text/javascript">
    ...
    $(document).ready(function(){
        ...
        preventKeyEnter();
        // Hide Branch
        $("#InventoryPhysicalBranchId").filterOptions('com', '<?php echo $this->data['InventoryPhysical']['company_id']; ?>', '<?php echo $this->data['InventoryPhysical']['branch_id']; ?>');
        ...
        $.cookie('InventoryPhysicalLocationGroupId', $("#InventoryPhysicalLocationGroupId").val(), { expires: 7, path: "/" });
        ...
        // Company Action
        $.cookie('companyIdInventoryPhysical', $("#InventoryPhysicalCompanyId").val(), { expires: 7, path: "/" });
        ...
        // Action Branch
        $.cookie('branchIdInventoryPhysical', $("#InventoryPhysicalBranchId").val(), { expires: 7, path: "/" });
    ...
    function loadDetailInventoryAdj(invAdjId){
        $.ajax({
            type: "POST",
            url: "<?php echo $this->base . '/' . $this->params['controller']; ?>/editDetail/"+invAdjId+"/<?php echo $this->data['InventoryPhysical']['location_group_id']; ?>",
            beforeSend: function(){
...
<?php echo $this->Form->create('InventoryPhysical', array('id' => 'InventoryPhysicalForm', 'url' => '/inventory_physicals/saveEdit/')); ?>
<input type="hidden" value="<?php echo $id; ?>" name="data[InventoryPhysical][id]" />
        ...
        <tr>
            ...
            <td style="width: 17%; vertical-align: top;">
                <div class="inputContainer" style="width:100%">
                    <?php echo $this->Form->text('date', array('value' => dateShort($this->data['InventoryPhysical']['date']), 'empty' => INPUT_SELECT, 'label' => false, 'class' => 'validate[required]', 'style' => 'width:70%')); ?>
                </div>
            </td>
            <td rowspan="2" style="width: 5%; vertical-align: top;"><label for="InventoryPhysicalNote"><?php echo TABLE_MEMO; ?> :</label></td>
            <td rowspan="2">
                <div class="inputContainer" style="width:100%;">
                    <textarea style="width: 90%; height: 70px;" id="InventoryPhysicalNote" name="data[InventoryPhysical][note]"><?php echo $this->data['InventoryPhysical']['note']; ?></textarea>
                </div>
            </td>
            ...
            <td style="width: 15%; vertical-align: top;">
                <div class="inputContainer" style="width:100%; <?php if(count($companies) == 1){ ?>display: none;<?php } ?>">
                    <select name="data[InventoryPhysical][company_id]" id="InventoryPhysicalCompanyId" class="validate[required]" style="width: 75%;">
                        <?php
                        ...
                        ?>
                        <option <?php if($this->data['InventoryPhysical']['company_id'] == $company['Company']['id']){ ?>selected="selected"<?php } ?> value="<?php echo $company['Company']['id']; ?>"><?php echo $company['Company']['name']; ?></option>
                        <?php
                        }
                        ?>
                    </select>
            ...
            <td style="width: 25%; vertical-align: top;">
                <div class="inputContainer" style="width:100%; <?php if(count($locationGroups) == 1){ ?>display: none;<?php } ?>">
                    <?php echo $this->Form->input('location_group_id', array('selected' => $this->data['InventoryPhysical']['location_group_id'], 'empty' => INPUT_SELECT, 'label' => false, 'class' => 'validate[required]', 'style' => 'width:280px')); ?>
                </div>
            </td>
        </tr>
        <tr>
            ...
            <td>
                <div class="inputContainer" style="width:100%">
                    <?php echo $this->Form->input('code', array('value' => $this->data['InventoryPhysical']['code'], 'empty' => INPUT_SELECT, 'label' => false, 'class' => 'validate[required]', 'style' => 'width:70%', 'readonly' => true)); ?>
                </div>
            </td>
            ...
            <td>
                <div class="inputContainer" style="width:100%; <?php if(count($branches) == 1){ ?>display: none;<?php } ?>">
                    <select name="data[InventoryPhysical][branch_id]" id="InventoryPhysicalBranchId" class="validate[required]" style="width: 75%;">
                        <?php
                        if(count($branches) != 1){
                        ?>
                        <option value=""><?php echo INPUT_SELECT; ?></option>
                        ...
                        ?>
                        <option <?php if($this->data['InventoryPhysical']['branch_id'] == $branch['Branch']['id']){ ?>selected="selected"<?php } ?> value="<?php echo $branch['Branch']['id']; ?>" com="<?php echo $branch['Branch']['company_id']; ?>" mcode="IVM"><?php echo $branch['Branch']['name']; ?></option>
                        <?php
                        }
                        ?>
                    </select>
