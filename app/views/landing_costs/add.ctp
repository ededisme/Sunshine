...
<script type="text/javascript">
    $(document).ready(function(){
        ...
        // Hide Branch
        $("#LandingCostBranchId").filterOptions('com', '0', '');
        $("#LandingCostAddForm").validationEngine();
        ...
        $("#LandingCostAddForm").ajaxForm({
            ...
            error: function (result) {
                ...
                createSysAct('Landed Cost', 'Add', 2, result.responseText);
            ...
            success: function(result) {
                ...
                if(result.code == "1" || result.code == "4"){
                    ...
                    createSysAct('Landed Cost', 'Add', 1, '');
        ...
        if($.cookie('companyIdLandingCost') != null || $("#LandingCostCompanyId").find("option:selected").val() != ''){
            if($.cookie('companyIdLandingCost') != null){
                $("#LandingCostCompanyId").val($.cookie('companyIdLandingCost'));
            }
            $("#LandingCostBranchId").filterOptions('com', $("#LandingCostCompanyId").val(), '');
            $("#LandingCostBranchId").change();
        }
        // Reset Form
        resetFormLandingCost();
        // Load Detail
        loadOrderDetailLandingCost();
    ...
    function backLandingCost(){
        ...
        $("#LandingCostAddForm").validationEngine("hideAll");
        var rightPanel = $("#LandingCostAddForm").parent();
    ...
    function loadOrderDetailLandingCost(){
        if($("#LandingCostDate").val() != ''){
            $.ajax({
                type: "POST",
    ...
    function checkBfSaveLandingCost(){
        var formName = "#LandingCostAddForm";
    ...
    function changeInputCSSLandingCost(){
        ...
        // Label
        $("#LandingCostAddForm").find("label").removeAttr("class");
        $("#LandingCostAddForm").find("label").each(function(){
        ...
        // Input & Select
        $("#LandingCostAddForm").find("input").each(function(){
            $(this).removeClass(cssRemove);
            $(this).addClass(cssStyle);
        });
        $("#LandingCostAddForm").find("select").each(function(){
...
<input type="hidden" value="0" id="LandingCostCurrencyCenterId" name="data[LandingCost][currency_center_id]" />
            ...
            <td style="width: 50%; vertical-align: top;">
                <table cellpadding="0" style="width: 100%">
                    ...
                    <tr>
                        <td>
                            <div class="inputContainer" style="width:100%">
                                <?php echo $this->Form->text('vendor_name', array('class' => 'validate[required,funcCall[checkVendorAddLandingCost]]', 'style' => 'width:70%')); ?>
                                <?php echo $this->Form->hidden('vendor_id'); ?>
                                <img alt="Search" align="absmiddle" style="cursor: pointer; width: 22px; height: 22px;" class="searchVendorLandingCost" onmouseover="Tip('<?php echo GENERAL_SEARCH; ?>')" src="<?php echo $this->webroot . 'img/button/search.png'; ?>" />
                                <img alt="Delete" align="absmiddle" style="display: none; cursor: pointer;" class="deleteVendorLandingCost" onmouseover="Tip('<?php echo ACTION_DELETE; ?>')" src="<?php echo $this->webroot . 'img/button/delete.png'; ?>" />
                            </div>
                        </td>
                        <td>
                            <div class="inputContainer" style="width:100%">
                                <?php echo $this->Form->hidden('purchase_order_id'); ?>
                                <?php echo $this->Form->text('purchase_bill', array('style' => 'width:70%')); ?>
                                <img alt="Search" align="absmiddle" style="cursor: pointer; width: 22px; height: 22px;" class="searchLandingCostPurchaseBill" onmouseover="Tip('<?php echo GENERAL_SEARCH; ?>')" src="<?php echo $this->webroot . 'img/button/search.png'; ?>" />
                                <img alt="Delete" align="absmiddle" style="display: none; cursor: pointer;" class="deleteLandingCostPurchaseBill" onmouseover="Tip('<?php echo ACTION_DELETE; ?>')" src="<?php echo $this->webroot . 'img/button/delete.png'; ?>" />
                            </div> 
                        </td>
                        <td>
                            <?php
        ...
        <table style="width:100%">
            <tr>
                ...
                <td style="width: 250px;">
                    <div class="inputContainer" style="width:100%">
                        <?php echo $this->Form->text('total_amount', array('readonly' => true, 'class' => 'float validate[required]', 'style' => 'width: 85%; height:15px; font-size:12px; font-weight: bold', 'value' => '0.00')); ?> <span class="lblSymbolLandingCost"></span>
                    </div>
                </td>
            </tr>
        </table>
