...
<fieldset>
    ...
    <table>
        ...
        <tr>
            <td><label for="choice1"><?php echo TABLE_VENDOR; ?> :</label></td>
            <td>
                <div class="inputContainer">
                    <?php 
                    $disDelVendor = '';
                    ...
                    echo $this->Form->text('vendor_name', array('class' => 'validate[required]', 'style' => 'width: 250px;', 'value' => $this->data['Vendor']['name'])); ?>
