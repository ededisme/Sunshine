...
<style type="text/css" media="print">
    ...
    h2{ font-size: 18px;}
    #footerTablePrint { display: block; width: 100%; position: fixed; bottom: 0px; }
    ...
    <div>
        <table class="table_print" style="width:100%; float: left; margin:0px;padding-left:10px;border: none;" align='center' id="print">
            <thead>
                <tr>
                    <td>
                        <?php echo $this->element('print_header_labo'); ?><br/>
...
//                                                        echo '<td style="color:#000;white-space: nowrap;font-family:monospace;width: 600px;padding-left:30px;font-size: 14px">' . ($i['LaboItem']['parent_id'] != NULL ? '&nbsp;&nbsp;&nbsp;&nbsp;' : '') . mb_str_pad($i['LaboItem']['name'], 30, '.', STR_PAD_RIGHT) . ':' . '<p>' . $i['LaboItem']['description'] . '</p></td>';
                                                        if ($i['LaboItem']['normal_value_type'] == "Positive / Negative") {
                                                            echo '<td valign="top" style="color:#000;white-space: nowrap;font-family:monospace;width: 394px;font-size: 14px;font-weight: bold">' . ($item_results[$i['LaboItem']['id']][0] == 'Positive' ? 'Positive &nbsp;' . $item_results[$i['LaboItem']['id']][1] : "" . $item_results[$i['LaboItem']['id']][0] . "" ) . '</td>';
                                                            ...
                                                            echo '<td valign="top" style="color:#000;white-space: nowrap;font-family:monospace;width: 394px;font-size: 14px">' . $test . '</td>';
                                                            ...
                                                            if ($i['LaboItem']['item_unit'] == "/mm3") {
                                                                ...
                                                                if ($var == "<" || $var == ">") {
                                                                    ...
                                                                    if ($var == "<=") {
                                                                        if ($result > $newVar) {
                                                                            echo '<td valign="top" style="white-space: nowrap;font-family:monospace;width: 394px;font-weight: bold; color: red; font-size: 14px;vertical-align: top;">' . wordwrap($result, 16, "<br />\n") . '</td>';
                                                                        } else {
                                                                            echo '<td valign="top" style="white-space: nowrap;font-family:monospace;width: 394px;font-size: 14px">' . wordwrap($result, 16, "<br />\n") . '</td>';
                                                                        }
                                                                    } else if ($var == ">=") {
                                                                        if ($result < $newVar) {
                                                                    ...
                                                                    $flag = "";
                                                                    if($item_results[$i['LaboItem']['id']] > $max){
                                                                        $flag = "H";
                                                                    }else if($item_results[$i['LaboItem']['id']] < $min){
                                                                        $flag = "L";
                                                                    }
                                                                    echo '<td style="white-space: nowrap;font-family:monospace;width: 394px;font-weight: bold; color: red; font-size: 14px;vertical-align: top;">' . (isset($item_results[$i['LaboItem']['id']]) ? $item_results[$i['LaboItem']['id']] : '') . '   '.  $flag . '</td>';
                                                                } else {
                                                                ...
                                                                if ($var == "<" || $var == ">") {
                                                                    ...
                                                                    echo '<td valign="top" style="white-space: nowrap;font-family:monospace;width: 394px;font-size: 14px;">' . (isset($item_results[$i['LaboItem']['id']]) ? $item_results[$i['LaboItem']['id']] : '') . '</td>';
                                                                }
                                                        ...
                                                        if (trim($min) == '') {
                                                            echo ' <td style="color:#000;white-space: nowrap;font-family:monospace;width: 550px;font-size: 14px;vertical-align: top;">' . ($i['LaboItem']['normal_value_type'] != 'Positive / Negative' && $i['LaboItem']['normal_value_type'] != 'Free Style'  ?  '('.$max .')' : '') .'</td>';
                                                        } else if (trim($max) == '') {
                                                            echo ' <td style="color:#000;white-space: nowrap;font-family:monospace;width: 550px;font-size: 14px;vertical-align: top;">' . ($i['LaboItem']['normal_value_type'] != 'Positive / Negative'&& $i['LaboItem']['normal_value_type'] != 'Free Style' ? '(' .$min.')' : '') . '</td>';
                                                        } else {
                                                            echo ' <td style="color:#000;white-space: nowrap;font-family:monospace;width: 550px;font-size: 14px;vertical-align: top;">' . ($i['LaboItem']['normal_value_type'] != 'Positive / Negative' && $i['LaboItem']['normal_value_type'] != 'Free Style'? ' (' . $min . ' - ' . $max . ')' : '') . '</td>';
                                                        }
                                                        echo '</tr>';
                                                        if($i['LaboItem']['description']!=""){
                                                            echo '<tr><td colspan="4" style="font-family:monospace; font-weight: bold; text-decoration: underline;">Comment Test:</td></tr>';
                                                            echo '<tr>'
                                                                    . '<td colspan="4">'
...
//                                                        echo '<td style="color:#000;white-space: nowrap;font-family:monospace;width: 600px;padding-left:15px;font-size: 14px">' . ($i['LaboItem']['parent_id'] != NULL ? '&nbsp;&nbsp;&nbsp;&nbsp;' : '') . mb_str_pad($i['LaboItem']['name'], 32, '.', STR_PAD_RIGHT) . ':' . '<p>' . $i['LaboItem']['description'] . '</p></td>';
                                                        ...
                                                        if($i['LaboItem']['description']!=""){
                                                            echo '<tr><td colspan="4" style="font-family:monospace; font-weight: bold; text-decoration: underline;">Comment Test:</td></tr>';
                                                            echo '<tr>'
                                                                    . '<td colspan="4" class="description" style="font-family:monospace">'
                                                                    . nl2br($i['LaboItem']['description'])
                                                                    . '</td>'
                                                                . '</tr>';
                                                        }
                                                        $oldLaboTitle = $i['LaboItem']['title_item'];
                        ...
                        $query = mysql_query("SELECT comment FROM comment_category_results WHERE category_id = $categoryId AND labo_id=" . $laboId);
            ...
            <tfoot>
                <tr>
                    <td style="height : 80px ; padding-top:80px">
                        <div id="footerTablePrint" style=" width: 100%;">
                            <div style="float:right; margin-right:50px;margin-bottom:50px;">
                                <table id="signature">
                                    ...
                                    <tr>
                                        <td style="text-align: center;">
                                            <img alt="" <?php echo $user['User']['signature_photo'] != '' ? 'src="' . $this->webroot . 'public/signature_photo/' . $user['User']['signature_photo'] . '"' : ''; ?> style="width: 100px; height: 50px;" />
                                        </td>
                                    </tr>
                                    <?php }else { ?>
                                    <tr>
                            ...
                            <center style="font-size: 11px;">
                                <table style="width:100%;">
                                    <tr>
                                        <td style="font-size:10px ; width: 70% ;font-family:'Times New Roman'"><?php echo $this->data['Branch']['address'] ?></td>
