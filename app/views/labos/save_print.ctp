...
<div class="print_doc">
    ...
    <div>        
        <table class="table_print"  style="width:100%; float: left; margin:0px;padding-left:10px;border: none;" align='center' id="print" class="print_labo">
            <thead></thead>
            <tbody>
            <tr>
                <td valign="top">
                                                ...
                                                if (in_array($i['LaboItem']['id'], $item_requests) || in_array($i['LaboItem']['parent_id'], $item_requests)) {
                                                    ...
                                                    if ($item_results[$i['LaboItem']['id']] != "") {
                                                        ...
                                                        if ($i['LaboItem']['title_item'] != NULL) {
                                                            ...
                                                            if ($i['LaboItem']['normal_value_type'] == "Positive / Negative") {
                                                                ...
                                                                if ($i['LaboItem']['item_unit'] == "/mm3") {
                                                                    ...
                                                                    if ($var == "<" || $var == ">") {
                                                                        ...
                                                                        if ($var == "<=") {
                                                                            if ($result > $newVar) {
                                                                                echo '<td style="white-space: nowrap;font-family:monospace;width: 394px;font-weight: bold;font-size: 14px">' . wordwrap($result, 16, "<br />\n") . '</td>';
                                                                            } else {
                                                                        ...
                                                                        echo '<td style="white-space: nowrap;font-family:monospace;width: 394px;font-weight: bold;font-size: 14px">' . (isset($item_results[$i['LaboItem']['id']]) ? $item_results[$i['LaboItem']['id']] : '') . '</td>';
                                                                    } else {
                                                            ...
                                                            if (trim($min) == '') {
                                                                echo ' <td style="color:#000;white-space: nowrap;font-family:monospace;width: 550px;font-size: 14px">' . ($i['LaboItem']['normal_value_type'] != 'Positive / Negative' && $i['LaboItem']['normal_value_type'] != 'Free Style' ? '(' .$max.  ')' : '') . '</td>';
                                                            } else if (trim($max) == '') {
                                                                echo ' <td style="color:#000;white-space: nowrap;font-family:monospace;width: 550px;font-size: 14px">' . ($i['LaboItem']['normal_value_type'] != 'Positive / Negative' && $i['LaboItem']['normal_value_type'] != 'Free Style' ? '('. $min .')' : '') . '</td>';
                                                            } else {
                                                                echo ' <td style="color:#000;white-space: nowrap;font-family:monospace;width: 550px;font-size: 14px">' . ($i['LaboItem']['normal_value_type'] != 'Positive / Negative' && $i['LaboItem']['normal_value_type'] != 'Free Style' ? ' (' . $min . ' - ' . $max . ')' : '') . '</td>';
                                                            }
                                                            echo '</tr>';
                        ...
                        <div id="footerTablePrint" style=" width: 100%;">
                            ...
                            <center style="font-size: 11px;">
                                <table style="width:100% ; ">
                                    <tr>
                                        <td style="font-size:10px ; width: 70% ;font-family:'Khmer OS Metal Chrieng'"><?php echo $this->data['Branch']['address_other'] ?></td>
