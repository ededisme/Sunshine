                                        ...
                                        if (in_array($i['LaboItem']['id'], $item_requests) || in_array($i['LaboItem']['parent_id'], $item_requests)) {
                                            ...
                                            if ($i['LaboItem']['id'] == "182" || $i['LaboItem']['id'] == "161" || $i['LaboItem']['id'] == "196") {
                                                ...
                                                if ($i['LaboItem']['title_item'] != NULL) {
                                                    ...
                                                    echo '<tr>';
                                                    echo '<td style="white-space: nowrap;font-family:monospace;width: 450px;padding-left:30px">' . ($i['LaboItem']['parent_id'] != NULL ? '&nbsp;&nbsp;&nbsp;&nbsp;' : '') . mb_str_pad($i['LaboItem']['name'], 70, '.', STR_PAD_RIGHT) . ':';
                                                    ...
                                                    if (trim($min) == '') {
                                                        echo ' <td style="white-space: nowrap;font-family:monospace;width: 190px; vertical-align: top;">' . ($i['LaboItem']['normal_value_type'] != 'Positive / Negative' ? $max : '') . '</td>';
                                                    } else if (trim($max) == '') {
                                                        echo ' <td style="white-space: nowrap;font-family:monospace;width: 190px; vertical-align: top;">' . ($i['LaboItem']['normal_value_type'] != 'Positive / Negative' ? $min : '') . '</td>';
                                                    } else {
                                                        echo ' <td style="white-space: nowrap;font-family:monospace;width: 190px; vertical-align: top;">' . ($i['LaboItem']['normal_value_type'] != 'Positive / Negative' ? ' (' . $min . ' - ' . $max . ')' : '') . '</td>';
                                                    }
                                                    echo '</tr>';
