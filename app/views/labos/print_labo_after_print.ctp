                                                            ...
                                                            if ($i['LaboItem']['normal_value_type'] == "Positive / Negative") {
                                                                ...
                                                                if ($i['LaboItem']['item_unit'] == "/mm3") {
                                                                    ...
                                                                    if ($var == "<" || $var == ">") {
                                                                        ...
                                                                        if ($var == "<=") {
                                                                            if ($result > $newVar) {
                                                                                echo '<td style="white-space: nowrap;font-family:monospace;width: 394px;font-weight: bold;font-size: 14px;vertical-align: top;">' . wordwrap($result, 16, "<br />\n") . '</td>';
                                                                            } else {
                                                                        ...
                                                                        echo '<td style="white-space: nowrap;font-family:monospace;width: 394px;font-weight: bold;font-size: 14px;vertical-align: top;">' . (isset($item_results[$i['LaboItem']['id']]) ? $item_results[$i['LaboItem']['id']] : '') . '</td>';
                                                                    } else {
