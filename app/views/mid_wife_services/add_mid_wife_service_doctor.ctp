...
<script type="text/javascript">
    $(document).ready(function(){ 
        // Prevent Key Enter
        preventKeyEnter();
        $("#MidWifeServiceAddMidWifeServiceDoctorForm").validationEngine();
        $("#MidWifeServiceAddMidWifeServiceDoctorForm").ajaxForm({
            ...
            success: function(result) {                
                ...
                $(".btnBackQueueMidWifeService").click();               
                // alert message
        ...
        $(".btnBackQueueMidWifeService").click(function(event) {
            ...
            oTableQueueMidWifeDoctor.fnDraw(false);
    ...
    <legend><a href="#" id="btnHidePatientInfo<?php echo $tblNameRadom;?>" style="background: #CCCCCC; font-weight: bold;"> <?php echo MENU_PATIENT_MANAGEMENT_INFO; ?> [ Hide ] </a></legend>
        <table style="width: 100%;" cellspacing="3">
            ...
            <tr>
                ...
                <td><?php echo TABLE_NATIONALITY; ?> :</td>
                <td>
                    <?php
            ...
            <tr>            
                <td><?php echo TABLE_OCCUPATION; ?> :</td>
                <td>
            ...
            <tr>
                <td><?php echo TABLE_ADDRESS; ?> :</td>
                <td>
                    <?php echo $patient['Patient']['address']; ?>
                </td>
                <td ><?php echo TABLE_CITY_PROVINCE; ?> :</td>
                <td>
                    <?php                
            ...
            <div>
                    ...
                    <table cellspacing='2' cellpadding='2' style="width: 100%;">
                        <tr>
                            ...
                            <td style="width:90%;">
                                ...
                                ?>
                                <label><?php echo TABLE_EDEMA; ?></label>                                
                            </td>                           
                        </tr>
                        <tr>
                            <td></td>
                            <td>
                                ...
                                ?>
                                <label><?php echo TABLE_ALBUMINURIA; ?></label>
                            </td>                            
                        </tr>
                        <tr>
                            <td></td>
                            <td>
                                ...
                                ?>
                                <label><?php echo TABLE_CADIOJATHIE; ?></label>
                            </td>                           
                        </tr>
                        <tr>
                            <td></td>
                            <td>
                                ...
                                ?>
                                <label><?php echo TABLE_ASTHMA; ?></label>                                
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td colspan="5" style="padding-left: 5px;">
                                <?php 
                                    echo nl2br($patient['MidWifeService']['other']);
                                ?>
                            </td>
                        </tr>
                    </table>
                ...
                <fieldset>
                    ...
                    <div class="accordionDetail">
                        ...
                        <div>
                            <table cellspacing='2' cellpadding='2' class="defualtTable1">
                                <tr>
                                ...
                                <tr>
                                    ...
                                    <td colspan="3"><?php echo $data['blood_pressure'] ?></td>
                                </tr>
                                <tr>
                                    <td><?php echo TABLE_PULE.':'; ?></td>
                                    <td><?php echo $data['pulse'] ?></td>
                                    <td><?php echo TABLE_TEMPERATURE.':'; ?></td>
                                    <td colspan="3"><?php echo $data['temperature']. '  &#8451' ?></td>                            
                                </tr>
                                <tr>
                                    <td><?php echo TABLE_PRESENTATION.':'; ?></td>
                                    <td colspan="3"><?php echo $data['presentation'] ?></td>
                                </tr>
                                <tr>
                                    <td><?php echo TABLE_UTERUS_HEIGHT.':'; ?></td>
                                    <td colspan="3"><?php echo $data['uterus_height'] ?></td>
                                </tr>
                                <tr>
                                    <td><?php echo TABLE_BABY_HEART_RATE.':'; ?></td>
                                    <td colspan="3"><?php echo $data['baby_heart_rate'] ?></td>
                                </tr>
                                <tr>
                                    <td><?php echo TABLE_IRON.':'; ?></td>
                                    <td colspan="3"><?php echo $data['iron'] ?></td>
                                </tr>                                               
                                <tr>
                                    <td width="15%"><?php echo PATIENT_MADIE_DES_REINS; ?></td>
                                    <td>                                        
                                        <input type="checkbox" disabled="disabled" <?php if ($data['edema']=="1"){?> checked="checked" <?php }?> />
                                ...
                                <tr>              
                                    <td></td>
                                    <td>                                        
                                        <input type="checkbox" disabled="disabled" <?php if ($data['albuminuria']=="1"){?> checked="checked" <?php }?>/>  
                                ...
                                <tr>
                                    <td></td>
                                    <td>                                        
                                        <input type="checkbox" disabled="disabled" <?php if ($data['asthma']=="1"){?>checked="checked" <?php }?>/>    
                                ...
                                <tr>
                                    ...
                                    <td colspan="3"><?php echo dateShort($data['next_appointment']); ?></td>
                                </tr>
