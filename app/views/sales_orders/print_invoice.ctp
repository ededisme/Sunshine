...
<div class="print_doc">
    ...
    $companyTitleKH = $salesOrder['Branch']['name_other'];
    echo $this->element('/print/header-invoice', array('msg' => $msg, 'barcode' => $salesOrder['SalesOrder']['so_code'], 'vat' => $vatInvoice, 'address' => $salesOrder['Branch']['address'], 'telephone' => $telTitle.$salesOrder['Branch']['telephone'], 'logo' => $salesOrder['Company']['photo'], 'title' => $companyTitle, 'titleKH' => $companyTitleKH, 'mail' => $salesOrder['Branch']['email_address']));
    ?>
    <div style="height: 10px"></div>
    <table width="100%" cellpadding="0" cellspacing="0" style="line-height:20px;">
        <tr>
            <td style="width: 15%; font-size: 12px;">Patient ID :</td>
            <td style="width: 35%; font-size: 12px;"><?php echo $salesOrder['Patient']['patient_code'];  ?></td>
            <td style="width: 15%; font-size: 12px;">Invoice No :</td>
            <td style="width: 35%; font-size: 12px;">
                <?php echo $salesOrder['SalesOrder']['so_code']; ?>
            </td>
        </tr>
        <tr>
            <td style="width: 15%; font-size: 12px;">Patient Name :</td>
            <td style="width: 35%; font-size: 12px;"><?php echo $salesOrder['Patient']['patient_name'];  ?></td>
            <td style="width: 15%; font-size: 12px;">Invoice Date :</td>
            <td style="width: 35%; font-size: 12px;">
                <?php echo dateShort($salesOrder['SalesOrder']['order_date'], "d/M/Y"); ?>
            </td>
        </tr>
        <tr>
            <td style="width: 15%; font-size: 12px;">Address : </td>
            <td style="width: 35%; font-size: 12px;"><?php echo $salesOrder['Patient']['address']; ?></td>
        </tr>
    </table>
    <table width="100%" cellpadding="0" cellspacing="0" style="display: none;">
        <tr>
            ...
            <td class="titleHeader"><?php echo $salesOrder['Patient']['patient_name']; ?></td>
        </tr>
        <tr>
            ...
            <table class="table_print" style="border: none;">
                    ...
                    ?>
                        <tr class="rowListDN">
                            ...
                            <td style="text-align: center; font-size: 10px; padding-top: 0px; padding-bottom: 0px;">
                                ...
                                <?php 
                                echo number_format($salesOrderDetail['SalesOrderDetail']['unit_price'], 3);
                                ?>
                            </td>
                            <td style="text-align: center; font-size: 10px; padding-top: 0px; padding-bottom: 0px;">
                                <span style="float: left; width: 12px; font-size: 11px;"><?php echo $salesOrder['CurrencyCenter']['symbol']; ?></span>
                                <?php 
                                echo number_format($salesOrderDetail['SalesOrderDetail']['discount_amount'], 3);
                                ?>
                            </td>
                            <td style="text-align: right; font-size: 10px; padding-top: 0px; padding-bottom: 0px;">
                                <span style="float: left; width: 12px; font-size: 11px;"><?php echo $salesOrder['CurrencyCenter']['symbol']; ?></span>
                                <?php echo number_format($salesOrderDetail['SalesOrderDetail']['total_price'] - $salesOrderDetail['SalesOrderDetail']['discount_amount'], 3); ?>
                            </td>
                        </tr>
                    <?php
                    }
                    ...
                    ?>
                        <tr class="rowListDN">
                            ...
                            <td style="text-align: center; font-size: 10px; padding-top: 0px; padding-bottom: 0px;">
                                <span style="float: left; width: 12px; font-size: 11px;"><?php echo $salesOrder['CurrencyCenter']['symbol']; ?></span>
                                <?php 
                                echo number_format($salesOrderService['SalesOrderService']['unit_price'], 3);
                                ?>
                            </td>
                            <td style="text-align: center; font-size: 10px; padding-top: 0px; padding-bottom: 0px;">
                                <span style="float: left; width: 12px; font-size: 11px;"><?php echo $salesOrder['CurrencyCenter']['symbol']; ?></span>
                                <?php 
                                echo number_format($salesOrderService['SalesOrderService']['discount_amount'], 3);
                                ?>
                            </td>
                            <td style="text-align: right; font-size: 10px; padding-top: 0px; padding-bottom: 0px;">
                                <span style="float: left; width: 12px; font-size: 11px;"><?php echo $salesOrder['CurrencyCenter']['symbol']; ?></span>
                                <?php echo number_format($salesOrderService['SalesOrderService']['total_price'] - $salesOrderService['SalesOrderService']['discount_amount'], 3); ?>
                            </td>
                        </tr>
                    <?php
                        }
                    ...
                    ?>
                        <tr class="rowListDN">
                            ...
                            <td style="text-align: center; font-size: 10px; padding-top: 0px; padding-bottom: 0px;">
                                <span style="float: left; width: 12px; font-size: 11px;"><?php echo $salesOrder['CurrencyCenter']['symbol']; ?></span>
                                <?php 
                                echo number_format($salesOrderMisc['SalesOrderMisc']['unit_price'], 3);
                                ?>
                            </td>
                            <td style="text-align: center; font-size: 10px; padding-top: 0px; padding-bottom: 0px;">
                                <span style="float: left; width: 12px; font-size: 11px;"><?php echo $salesOrder['CurrencyCenter']['symbol']; ?></span>
                                <?php 
                                echo number_format($salesOrderMisc['SalesOrderMisc']['discount_amount'], 3);
                                ?>
                            </td>
                            <td style="text-align: right; font-size: 10px; padding-top: 0px; padding-bottom: 0px;">
                                <span style="float: left; width: 12px; font-size: 11px;"><?php echo $salesOrder['CurrencyCenter']['symbol']; ?></span>
                                <?php echo number_format($salesOrderMisc['SalesOrderMisc']['total_price'] - $salesOrderMisc['SalesOrderMisc']['discount_amount'], 3); ?>
                            </td>
                        </tr>
                    <?php
                        }
                    ...
                    ?>
                        <tr>
                            ...
                            <td style="text-align: right; font-size: 10px; padding-top: 0px; padding-bottom: 0px;"><span style="float: left; width: 12px; font-size: 11px;"><?php echo $salesOrder['CurrencyCenter']['symbol']; ?></span><?php echo number_format(($salesOrder['SalesOrder']['total_amount']), 3); ?></td>
                        </tr>
                        <?php
                        if($salesOrder['SalesOrder']['discount'] > 0){
                        ?>
                        <tr>
                            ...
                            <td style="text-align: right; font-size: 10px; padding-top: 0px; padding-bottom: 0px;"><span style="float: left; width: 12px; font-size: 11px;"><?php echo $salesOrder['CurrencyCenter']['symbol']; ?></span><?php echo number_format(($salesOrder['SalesOrder']['discount']), 3); ?></td>
                        </tr>
                        <?php
                        }
                        if($salesOrder['SalesOrder']['total_vat'] > 0){
                        ...
                        <tr>
                            ...
                            <td style="text-align: right; font-size: 10px; padding-top: 0px; padding-bottom: 0px;"><span style="float: left; width: 12px; font-size: 11px;"><?php echo $salesOrder['CurrencyCenter']['symbol']; ?></span><?php echo number_format(($salesOrder['SalesOrder']['total_vat']), 3); ?></td>
                        </tr>
                        <?php
                        }
                        ?>
                        <tr>
                            ...
                            <td style="text-align: right; font-size: 10px; padding-top: 0px; padding-bottom: 0px;"><span style="float: left; width: 12px; font-size: 11px;"><?php echo $salesOrder['CurrencyCenter']['symbol']; ?></span><?php echo number_format(($salesOrder['SalesOrder']['total_amount'] - $salesOrder['SalesOrder']['discount'] + $salesOrder['SalesOrder']['total_vat']), 3); ?></td>
                        </tr>
            </table>
        </div>
        <?php
