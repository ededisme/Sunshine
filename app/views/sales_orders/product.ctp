...
<script type="text/javascript">
    $(document).ready(function(){
        var oTable<?php echo $rand; ?> = $("#<?php echo $tblName; ?>").dataTable({
            "bProcessing": true,
            "bServerSide": true,
            "sAjaxSource": "<?php echo $this->base . '/' . $this->params['controller']; ?>/product_ajax/<?php echo $companyId; ?>/<?php echo $locationGroupId; ?>/<?php echo $branchId; ?>/<?php echo $orderDate; ?>/?sale_order_id=<?php echo $saleOderId; ?>",
        ...
        $("#changeCategorySaleOrderSelectProduct").change(function(){
            ...
            Tablesetting.sAjaxSource = "<?php echo $this->base . '/' . $this->params['controller']; ?>/product_ajax/<?php echo $companyId; ?>/<?php echo $locationGroupId; ?>/<?php echo $branchId; ?>/<?php echo $orderDate; ?>/"+valueId+"/?sale_order_id=<?php echo $saleOderId; ?>";
