...
<script type="text/javascript">
    $(document).ready(function(){
        ...
        $("#<?php echo $tblName; ?>").dataTable({
            "bProcessing": true,
            "bServerSide": true,
            "sAjaxSource": "<?php echo $this->base . '/' . $this->params['controller']; ?>/quotationAjax/<?php echo $companyId; ?>/<?php echo $branchId; ?>/<?php echo $customerId; ?>?sale_id=<?php echo $saleId; ?>",
            ...
            "fnInfoCallback": function( oSettings, iStart, iEnd, iMax, iTotal, sPre ) {
                ...
                $(".table tr").click(function(){
                    $(this).find("input[name='chkQuotation']").attr("checked", true);
                });
                return sPre;
            },
            "aoColumnDefs": [{
