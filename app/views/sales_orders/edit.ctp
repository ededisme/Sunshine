...
<script type="text/javascript">
    ...
    $(document).ready(function(){
        ...
        $("#SalesOrderCustomerName").autocomplete("<?php echo $this->base . "/sales_orders/searchCustomer"; ?>", {
            ...
            var paymentTermId = "";
            $("#queueId").val(queueId);
            $("#queueDoctorId").val(queueDoctorId);
...
<input type="hidden" value="<?php echo $this->data['SalesOrder']['total_deposit']; ?>" name="data[total_deposit]" id="SalesOrderTotalDeposit" />
...
<input type="hidden" id="queueId" value="<?php echo $this->data['SalesOrder']['queue_id']; ?>" name="data[SalesOrder][queue_id]"/>
<input type="hidden" id="queueDoctorId" value="<?php echo $this->data['SalesOrder']['queue_doctor_id']; ?>" name="data[SalesOrder][queue_doctor_id]"/>
            ...
            <td style="width: 50%; vertical-align: top;">
                <table cellpadding="0" style="width: 100%">
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="inputContainer" style="width:100%">
                                <?php echo $this->Form->text('customer_po_number', array('style' => 'width:80%')); ?>
                            </div>
                        </td>
                    </tr>
                </table>
                ...
                <table cellpadding="0" style="width: 100%">
                    ...
                    <tr>
                        <td colspan="2">
                            <div class="inputContainer" style="width:100%">
                                <?php
                                echo $this->Form->hidden('patient_group_id', array('value' => $this->data['Patient']['patient_group_id']));
                                echo $this->Form->hidden('customer_id', array('value' => $this->data['Patient']['id']));
                                if($allowAddCustomer){
                                ?>
                                <div class="addnewSmall" style="float: left;">
                                    <?php echo $this->Form->text('customer_name', array('value' => $this->data['Patient']['patient_code']." - ".$this->data['Patient']['patient_name'], 'readonly' => true, 'class' => 'validate[required]', 'style' => 'width: 285px; border: none;')); ?>
                                ...
                                <?php
                                    ...
                                    echo $this->Form->text('customer_name', array('value' => $this->data['Patient']['patient_code']." - ".$this->data['Patient']['patient_name'], 'readonly' => true, 'class' => 'validate[required]', 'style' => 'width:320px'));
                                }
                                ?>
    ...
    <div style="float: right; width: 80%;">
        <table style="width:100%">
            <tr>
                ...
                <td style="width:8%; text-align: right;"><label for="SalesOrderDiscountPercent"><?php echo GENERAL_DISCOUNT; ?>:</label></td>
                <td style="width:18%;">
                    <div class="inputContainer" style="width:100%">
