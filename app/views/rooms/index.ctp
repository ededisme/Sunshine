...
<script type="text/javascript">
    ...
    $(document).ready(function(){
        ...
        oTableRoom = $("#<?php echo $tblName; ?>").dataTable({
            "bProcessing": true,
            "bServerSide": true,
            ...
            "fnInfoCallback": function( oSettings, iStart, iEnd, iMax, iTotal, sPre ) {
                ...
                $(".btnViewRoom").click(function(event){
        ...
        $(".btnAddRoom").click(function(event){
            event.preventDefault();
...
<div class="leftPanel">
    <div style="padding: 5px;border: 1px dashed #bbbbbb;">
        <?php if($allowAdd){ ?>
        <div class="buttons">
            <a href="" class="positive btnAddRoom">
                <img src="<?php echo $this->webroot; ?>img/button/plus.png" alt=""/>
                <?php echo MENU_ROOM_MANAGEMENT_ADD; ?>
            </a>
        </div>
        <?php } ?>       
