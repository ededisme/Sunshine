...
$allowAdd=checkAccess($user['User']['id'], $this->params['controller'], 'addEchoServiceDoctor');
?>
<?php $tblName = "tbl" . rand(); ?>
<script type="text/javascript" src="<?php echo $this->webroot; ?>js/pipeline.js"></script>
<script type="text/javascript">
    var oTableEchoService;
    $(document).ready(function(){
        // Prevent Key Enter
        preventKeyEnter();
        $("#example td:first-child").addClass('first');
        oTableEchoService = $("#example").dataTable({
            "bProcessing": true,
            "bServerSide": true,
            ...
            "fnInfoCallback": function( oSettings, iStart, iEnd, iMax, iTotal, sPre ) {
                ...
                $(".btnEchoServiceDoctor").click(function(event){
                    ...
                    rightPanel.load("<?php echo $this->base; ?>/<?php echo $this->params['controller']; ?>/addEchoServiceDoctor/" + queueDoctorId+"/"+queueId);
                });
                return sPre;
            },
            "aoColumnDefs": [{
