...
<script type="text/javascript">
    $(document).ready(function() {
        $(".print<?php echo $rand; ?>, .btnPrint<?php echo $rand; ?>").click(function(event) {
            ...
            $.ajax({
                type: "POST",
                url: "<?php echo $this->base . '/' . $this->params['controller']; ?>/printEchoService/" + $(this).attr("rel"),
                beforeSend: function() {
        ...
        $(".btnBackEcho").click(function(event) {
            event.preventDefault();
...
<div style="padding: 5px;border: 1px dashed #3C69AD;">
    <div class="buttons">
        <a href="" class="positive btnBackEcho">
...
<fieldset style="border: 1px dashed #3C69AD;">
    ...
    <div style="float: right; width:30px;">
        <?php
        if ($allowPrint) {
            echo "<a href='#' class='btnPrint$rand' rel='{$dataService['EchoService']['id']}' ><img alt='Print'  onmouseover='Tip(\"" . ACTION_PRINT . "\")'  src='{$this->webroot}img/button/printer.png' /></a>";
        }
        ?>
    </div>
    <div>
        <table class="table" >
            <tr>
                ...
                <td valign="top" style="border-top:1px solid #C1DAD7;"><?php echo dateShort($dataService['EchoService']['echo_date']); ?></td>
            </tr>
            <tr>
                <td class="first">
                    <span class="title-report"><?php echo TABLE_DESCRIPTION;?> </span>
                </td>
                <td valign="top"><?php echo $dataService['EchoService']['description']; ?></td>
            </tr>
            <tr>
                <td class="first">
                    <span class="title-report"><?php echo TABLE_CONCLUSION;?> </span>
                </td>
                <td><?php echo $dataService['EchoService']['conclusion']; ?></td>
            </tr>
            <tr>
                <td class="first">
                ...
                <td>
                    ...
                    if(@mysql_num_rows($queryImage)){
                        ...
                        <img src="<?php echo $this->webroot; ?>/img/echo/<?php echo $dataImage['src_name']; ?>" alt="<?php echo $dataImage['src_name']; ?>" width="150px" height="150px" vspace='2px' style="margin-left:5px;">
                    <?php } 
                    }?>
                </td>
            </tr>
