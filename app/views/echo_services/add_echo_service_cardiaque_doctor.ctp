...
<script type="text/javascript">
    $(document).ready(function(){ 
        // Prevent Key Enter
        preventKeyEnter();
        $("#EchoServiceAddEchoServiceCardiaqueDoctorForm").validationEngine();
        $("#EchoServiceAddEchoServiceCardiaqueDoctorForm").ajaxForm({
            dataType: 'json',
            ...
            success: function(result) {                
                ...
                $(".btnBackQueueEchoServiceCardia").click(); 
                if(result.code == "1"){
                    errorSaveData();
                }else{                                        
                    $("#dialog").html('<div><br/><center><div class="buttons" style="display: inline-block;"><button type="submit" class="positive printEchoServiceCardiaDoctor" ><img src="<?php echo $this->webroot; ?>img/button/printer.png" alt=""/><span class="txtPrintInvoice"><?php echo ACTION_PRINT; ?></span></button></div></center></div>');
                    $(".printEchoServiceCardiaDoctor").click(function(){
                        $.ajax({
                            type: "POST",
                            url: "<?php echo $this->base; ?>/echo_service_cardias/printEchoServiceCardia/"+result.id,                            
                            beforeSend: function(){
                                $(".loader").attr('src','<?php echo $this->webroot; ?>img/layout/spinner.gif');
                            },
        ...
        $(".btnBackQueueEchoServiceCardia").click(function(event) {
    ...
    function errorSaveData(){
        ...
        $("#dialog").dialog({
            ...
            close: function(){
                $(this).dialog({close: function(){}});
                $(this).dialog("close");
                var rightPanel=$("#EchoServiceAddEchoServiceCardiaDoctorForm").parent();
                var leftPanel=rightPanel.parent().find(".leftPanel");
...
<div style="padding: 5px;border: 1px dashed #3C69AD;">
    <div class="buttons">
        <a href="" class="positive btnBackQueueEchoServiceCardia">
...
<fieldset style="border: 1px dashed #3C69AD;">
    ...
    <table style="width: 100%;">
        <tr>
            ...
            <td>:</td>
            <td><input type="text" id="effecture" name="data[EchoService][effecture]" style="width:26%;"></td>
        </tr>
        <tr style="display:none;">
            <td><?php echo TABLE_PAR_DOCTOR; ?> </td>
            <td>:</td>
            <td><input type="text" id="doctor_name" name="data[EchoService][doctor_name]" style="width:26%;"></td>
        </tr>
        <tr>
            <td><?php echo TABLE_MOTIF; ?> </td>
            <td>:</td>
            <td><input type="text" id="motif_exam" name="data[EchoService][motif_exam]" style="width:26%;"></td>
        </tr>
        <tr>
            <td colspan="3">
                <table style="width: 100%;" cellspacing="0">
                    <tr>
                        ...
                        <td colspan="2" style="border:1px solid #aaaaaa;border-left:none;"><input type="text" id="vd_dtd" name="data[EchoService][vd_dtd]" style="width:95%;border: none;"></td>
                    </tr>
                    <tr>
                        ...
                        <td colspan="2" style="border:1px solid #aaaaaa;border-left:none;border-top: none;"><input type="text" id="ao_ascend" name="data[EchoService][ao_ascend]" style="width:95%;border: none;"></td>
                    </tr>
                    <tr>
                        ...
                        <td style="border:1px solid #aaaaaa;border-left:none;border-top: none;width:25%;"><input type="text" id="og_1" name="data[EchoService][og_1]" style="width:95%;border: none;"></td>
                        <td style="border:1px solid #aaaaaa;border-left:none;border-top: none;width:25%;"><input type="text" id="og_2" name="data[EchoService][og_2]" style="width:95%;border: none;"></td>
                    </tr>
                    <tr>
                        ...
                        <td style="border:1px solid #aaaaaa;border-left:none;border-top: none;"><input type="text" id="siv_1" name="data[EchoService][siv_1]" style="width:95%;border: none;"></td>
                        <td style="border:1px solid #aaaaaa;border-left:none;border-top: none;"><input type="text" id="siv_2" name="data[EchoService][siv_2]" style="width:95%;border: none;"></td>
                    </tr>
                    <tr>
                        <td style="border:1px solid #aaaaaa;border-top: none;border-right: none;padding-left: 10px;">VGDTD-DTS</td>
                        <td style="border:1px solid #aaaaaa;border-left:none;border-top: none;">(mm)</td>
                        <td style="border:1px solid #aaaaaa;border-left:none;border-top: none;"><input type="text" id="vgdtd_dts_1" name="data[EchoService][vgdtd_dts_1]" style="width:95%;border: none;"></td>
                        <td style="border:1px solid #aaaaaa;border-left:none;border-top: none;"><input type="text" id="vgdtd_dts_2" name="data[EchoService][vgdtd_dts_2]" style="width:95%;border: none;"></td>
                    </tr>
                    <tr>
                        ...
                        <td style="border:1px solid #aaaaaa;border-left:none;border-top: none;">(mm)</td>
                        <td style="border:1px solid #aaaaaa;border-left:none;border-top: none;"><input type="text" id="pp_vg_1" name="data[EchoService][pp_vg_1]" style="width:95;border: none;"></td>
                        <td style="border:1px solid #aaaaaa;border-left:none;border-top: none;"><input type="text" id="pp_vg_2" name="data[EchoService][pp_vg_2]" style="width:95%;border: none;"></td>
                    </tr>
                    <tr>
                        ...
                        <td style="border:1px solid #aaaaaa;border-left:none;border-top: none;"><input type="text" id="frvg_fevg_1" name="data[EchoService][frvg_fevg_1]" style="width:95%;border: none;"></td>
                        <td style="border:1px solid #aaaaaa;border-left:none;border-top: none;"><input type="text" id="frvg_fevg_2" name="data[EchoService][frvg_fevg_2]" style="width:95%;border: none;"></td>
                    </tr>
                </table>
            </td>
        </tr>
        <tr>
            ...
            <td>:</td>
            <td><?php echo $this->Form->textarea('description',array('name'=>'data[EchoService][description]','class'=>'mceEditor','style'=>'height:100px;width:999px;')); ?></td>
        </tr>
        <tr>
            <td><?php echo TABLE_CONCLUSION; ?></td>
            <td>:</td>
            <td><?php echo $this->Form->textarea('conclusion',array('name'=>'data[EchoService][conclusion]','class'=>'mceEditor','style'=>'height:100px;width:999px;')); ?></td>
        </tr>
        <tr>
           <td>
