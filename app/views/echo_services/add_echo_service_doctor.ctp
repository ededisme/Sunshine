...
<script type="text/javascript">
    $(document).ready(function(){ 
        // Prevent Key Enter
        preventKeyEnter();
        $("#EchoServiceAddEchoServiceDoctorForm").validationEngine();
        $("#EchoServiceAddEchoServiceDoctorForm").ajaxForm({
            dataType: 'json',
            ...
            success: function(result) {                
                ...
                if(result.code == "1"){
                    ...
                    $("#dialog").html('<div><br/><center><div class="buttons" style="display: inline-block;"><button type="submit" class="positive printEchoServiceDoctor" ><img src="<?php echo $this->webroot; ?>img/button/printer.png" alt=""/><span class="txtPrintInvoice"><?php echo ACTION_PRINT; ?></span></button></div></center></div>');
                    $(".printEchoServiceDoctor").click(function(){
                        $.ajax({
                            type: "POST",
                            url: "<?php echo $this->base . '/' . $this->params['controller']; ?>/printEchoService/"+result.id,                            
                            beforeSend: function(){
                                $(".loader").attr('src','<?php echo $this->webroot; ?>img/layout/spinner.gif');
                            },
    ...
    $(function()
    {
        ...
        {            
            ...
            .html('<img style="width: 20px; height: 20px;" src="<?php echo $this->webroot; ?>img/button/trash.png" alt=""/>');
            remove();
            });
    ...
    function errorSaveData(){
        ...
        $("#dialog").dialog({
            ...
            close: function(){
                $(this).dialog({close: function(){}});
                $(this).dialog("close");
                var rightPanel=$("#EchoServiceAddEchoServiceDoctorForm").parent();
                var leftPanel=rightPanel.parent().find(".leftPanel");
...
<fieldset style="border: 1px dashed #3C69AD;">
    ...
    <table style="width: 100%;">
        <tr>
            ...
            <td>:</td>
            <td><input type="text" id="dataDate" name="data[EchoService][echo_date]" style="width:26%;" class ="validate[required]"></td>
        </tr>
        <tr>
