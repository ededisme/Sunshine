...
<script type="text/javascript">
    ...
    $(document).ready(function(){
        ...
        oTableEcho = $("#<?php echo $tblName; ?>").dataTable({
            "bProcessing": true,
            "bServerSide": true,
            ...
            "fnInfoCallback": function( oSettings, iStart, iEnd, iMax, iTotal, sPre ) {
                ...
                $(".btnPrintEcho").click(function(event){
                    ...
                    $(".printEcho").click(function(){
                        $.ajax({
                            type: "POST",
                            url: "<?php echo $this->base.'/'.$this->params['controller']; ?>/printEchoService/"+id,
                            beforeSend: function(){
                ...
                $(".btnViewEcho").click(function(event){
                    event.preventDefault();
                    var id = $(this).attr('rel');
                ...
                $(".btnEditEcho").click(function(event){
                    event.preventDefault();
                    var id = $(this).attr('rel');
                    var leftPanel  = $(this).parent().parent().parent().parent().parent().parent().parent();
                    var rightPanel = leftPanel.parent().find(".rightPanel");
