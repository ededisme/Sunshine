...
<script type="text/javascript">
    ...
    $(document).ready(function(){
        ...
        <?php echo $oTable; ?> = $("#<?php echo $tblName; ?>").dataTable({
            ...
            "bProcessing": true,
            "bServerSide": true,
            "sAjaxSource": "<?php echo $this->base.'/'.$this->params['controller']; ?>/ajaxByGroup/<?php echo $chart_account_group_id; ?>/<?php echo $dateAsOf; ?>/<?php echo $companyId; ?>/<?php echo $branchId; ?>/<?php echo $customerId; ?>/<?php echo $vendorId; ?>/<?php echo $otherId; ?>/<?php echo $classId; ?>",
        ...
        $("#<?php echo $btnGo; ?>").click(function(event){
            if($("#<?php echo $dateFrom; ?>").val()=="" || $("#<?php echo $dateTo; ?>").val()==""){
                ...
                Tablesetting.sAjaxSource = "<?php echo $this->base . '/' . $this->params['controller']; ?>/ajaxByGroup/<?php echo $chart_account_group_id; ?>/<?php echo $dateAsOf; ?>/<?php echo $companyId; ?>/<?php echo $customerId; ?>/<?php echo $vendorId; ?>/<?php echo $otherId; ?>/<?php echo $classId; ?>" + "/" + $("#<?php echo $dateFrom; ?>").val() + "/" + $("#<?php echo $dateTo; ?>").val() + "/" + $("#<?php echo $status; ?>").val() + "/" + $("#<?php echo $createdBy; ?>").val();
