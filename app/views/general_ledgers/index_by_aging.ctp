    ...
    $(document).ready(function(){
        ...
        $("#<?php echo $btnGo; ?>").click(function(event){
            if($("#<?php echo $dateFrom; ?>").val()=="" || $("#<?php echo $dateTo; ?>").val()==""){
                ...
                Tablesetting.sAjaxSource = "<?php echo $this->base . '/' . $this->params['controller']; ?>/ajaxByAging/<?php echo $type; ?>/<?php echo $typeId; ?>/<?php echo $dateType; ?>/<?php echo $date; ?>/<?php echo $from; ?>/<?php echo $to; ?>/<?php echo $through; ?>/<?php echo $glIdList; ?>" + "/" + $("#<?php echo $dateFrom; ?>").val() + "/" + $("#<?php echo $dateTo; ?>").val() + "/" + $("#<?php echo $status; ?>").val() + "/" + $("#<?php echo $createdBy; ?>").val();
