...
/* Customize condition */
$condition = "gl.is_approve=1 AND gl.is_active=1 AND gld.branch_id IN (SELECT company_id FROM user_companies WHERE user_id = ".$user['User']['id'].")";
...
$condition .= " AND gl.date BETWEEN '" . $dateFrom . "' AND '" . $dateTo . "' AND gld.id IN (" . implode(",", $arrGeleralLedgerDetailIdListByCoAId) . ")";
