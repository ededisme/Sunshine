            ...
            <table class="table_report">
                <thead>
                    <tr>
                        ...
                        <th style="width: 80px !important;"><?php echo TABLE_NAME; ?></th>
                ...
                <tbody>
                    ...
                    while($dataDetail=mysql_fetch_array($queryDetail)){
                        $totalAmount+=$dataDetail['debit']!=0?$dataDetail['debit']:$dataDetail['credit']*-1;
                    ?>
                    <tr>
                        <td class="first" style="text-align: right;"><?php echo $index++; ?></td>
                        <td><?php echo $dataDetail['chart_account_name']; ?></td>
                        <td style="text-align: right;"><?php echo $dataDetail['debit']!=0?number_format($dataDetail['debit'],2):number_format($dataDetail['credit']*-1,2); ?></td>
