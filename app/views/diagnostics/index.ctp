...
<script type="text/javascript">
    var oTableDiagnostic;
    $(document).ready(function(){
        // Prevent Key Enter
        preventKeyEnter();
        $("#<?php echo $tblName; ?> td:first-child").addClass('first');
        oTableDiagnostic = $("#<?php echo $tblName; ?>").dataTable({
            "bProcessing": true,
            "bServerSide": true,
            ...
            "fnInfoCallback": function( oSettings, iStart, iEnd, iMax, iTotal, sPre ) {
                ...
                $(".btnViewDiagnostic").click(function(event){
                ...
                $(".btnEditDiagnostic").click(function(event){
                    event.preventDefault();
                    var id = $(this).attr('rel');
                    var leftPanel=$(this).parent().parent().parent().parent().parent().parent().parent();
                    var rightPanel=leftPanel.parent().find(".rightPanel");
                ...
                $(".btnDeleteDiagnostic").click(function(event){
                    event.preventDefault();
                    var id = $(this).attr('rel');
        ...
        $(".btnAddDiagnostic").click(function(event){
            event.preventDefault();
...
<div class="leftPanel">
    ...
    <div style="padding: 5px;border: 1px dashed #bbbbbb;">
        <div class="buttons">
            <a href="" class="positive btnAddDiagnostic">
                <img src="<?php echo $this->webroot; ?>img/button/plus.png" alt=""/>
                <?php echo MENU_DIAGNOSTIC_ADD; ?>
            </a>
        </div>
