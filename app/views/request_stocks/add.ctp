...
<script type="text/javascript">
    ...
    $(document).ready(function(){
        ...
        preventKeyEnter();
        // Hide Branch
        $("#RequestStockBranchId").filterOptions('com', '0', '');
        ...
        // Form Validate
        $("#RequestStockAddForm").validationEngine('detach');
        $("#RequestStockAddForm").validationEngine('attach');
        ...
        $("#RequestStockAddForm").ajaxForm({
            ...
            error: function (result) {
                ...
                createSysAct('Request Stock', 'Add', 2, result.responseText);
            ...
            success: function(result) {
                $(".loader").attr("src", "<?php echo $this->webroot; ?>img/layout/spinner-placeholder.gif");
                if(result.error == 0){
                    createSysAct('Request Stock', 'Add', 1, '');
                    backRequestStock();
                    var id = result.id;
        ...
        // Company Action
        if($.cookie('companyIdRequestStock')!=null || $("#RequestStockCompanyId").find("option:selected").val() != ''){
            if($.cookie('companyIdRequestStock') != null){
                $("#RequestStockCompanyId").val($.cookie('companyIdRequestStock'));
            }
            $("#RequestStockBranchId").filterOptions('com', $("#RequestStockCompanyId").val(), '');
            $("#RequestStockBranchId").change();
        }
        changeInputCSSRequestStock();
        loadAutoCompleteOff();
    ...
    function checkBfSaveRs(){
        var formName     = "#RequestStockAddForm";
    ...
    function backRequestStock(){
        $('#RequestStockAddForm').validationEngine('hideAll');
    ...
    function changeInputCSSRequestStock(){
        ...
        // Label
        $("#RequestStockAddForm").find("label").removeAttr("class");
        $("#RequestStockAddForm").find("label").each(function(){
        ...
        // Input & Select
        $("#RequestStockAddForm").find("input").each(function(){
            $(this).removeClass(cssRemove);
            $(this).addClass(cssStyle);
        });
        $("#RequestStockAddForm").find("select").each(function(){
    ...
    <fieldset>
        ...
        <table style="width: 100%;">
                ...
                <td>
                    <div class="inputContainer" style="width: 100%;">
                        <select name="data[RequestStock][branch_id]" id="RequestStockBranchId" class="validate[required]" style="width: 55%;">
                            ...
                            ?>
                            <option value="<?php echo $branch['Branch']['id']; ?>" com="<?php echo $branch['Branch']['company_id']; ?>" mcode="<?php echo $branch['ModuleCodeBranch']['request_code']; ?>"><?php echo $branch['Branch']['name']; ?></option>
                            <?php
                            }
                            ?>
                        </select>
            ...
            <tr>
                ...
                <td>
                    <div class="inputContainer" style="width: 100%;">
                        <?php echo $this->Form->text('date', array('value' => date("d/m/Y"), 'class'=>'validate[required]', 'style' => 'width: 53%;')); ?>
                    </div>
                </td>
