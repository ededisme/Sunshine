...
<script type="text/javascript">
    $(document).ready(function(){
        ...
        // Hide Branch
        $("#ConsignmentReturnBranchId").filterOptions('com', '0', '');
        $("#ConsignmentReturnLocationGroupToId").chosen();
        $("#ConsignmentReturnAddForm").validationEngine();
        ...
        $("#ConsignmentReturnAddForm").ajaxForm({
            dataType: 'json',
            ...
            error: function (result) {
                ...
                createSysAct('Consignment Return', 'Add', 2, result.responseText);
            ...
            success: function(result) {
                ...
                if(result.code == "1" || result.code == "4"){
                    ...
                    createSysAct('Consignment Return', 'Add', 1, '');
        ...
        $(".deleteCustomerConsignmentReturn").click(function(){
            if($("#ConsignmentReturnConsignmentCode").val() == "" && $("#ConsignmentReturnCustomerName").val() == ""){
        ...
        $("#ConsignmentReturnCustomerName").autocomplete("<?php echo $this->base . "/consignment_returns/searchCustomer"; ?>", {
            ...
            formatItem: function(data, i, n, value) {
                if(checkCompanyConsignmentReturn(value.toString().split(".*")[4])){
        ...
        $("#ConsignmentReturnCompanyId").change(function(){
            ...
            if($(".tblConsignmentReturnList").find(".product_id").val() == undefined){
                ...
                checkVatCompanyConsignmentReturn();
        ...
        if($.cookie('companyIdConsignmentReturn') != null || $("#ConsignmentReturnCompanyId").find("option:selected").val() != ''){
            if($.cookie('companyIdConsignmentReturn') != null){
                $("#ConsignmentReturnCompanyId").val($.cookie('companyIdConsignmentReturn'));
            }
            $("#ConsignmentReturnBranchId").filterOptions('com', $("#ConsignmentReturnCompanyId").val(), '');
            $("#ConsignmentReturnBranchId").change();
        }
        // Reset Form
        resetFormConsignmentReturn();
        // Load Detail
        loadOrderDetailConsignmentReturn();
    ...
    function backConsignmentReturn(){
        ...
        $("#ConsignmentReturnAddForm").validationEngine("hideAll");
        var rightPanel = $("#ConsignmentReturnAddForm").parent();
    ...
    function loadOrderDetailConsignmentReturn(){
        if($("#ConsignmentReturnDate").val() != ''){
            $.ajax({
                type: "POST",
                            ...
                            '<?php echo ACTION_OK; ?>': function() {
                                if($("input[name='chkReturnConConsignment']:checked").val()){
                                    ...
                                    $.ajax({
                                        dataType: "json",
                                        type:   "POST",
                                        url:    "<?php echo $this->base . '/' . $this->params['controller']; ?>/getConsignmentReturn/"+$("input[name='chkReturnConConsignment']:checked").val()+"/"+orderDate,
                                        beforeSend: function(){
                                            $(".loader").attr('src','<?php echo $this->webroot; ?>img/layout/spinner.gif');
                                        },
                                        success: function(msg){
                        ...
                        buttons: {
                            '<?php echo ACTION_OK; ?>': function() {
                                if($("input[name='chkCustomer']:checked").val()){
                                    ...
                                    var warehouseId    = $("input[name='chkCustomer']:checked").attr("warehouse_id");
                                    // Set Customer
                                    $("#ConsignmentReturnProduct").attr("disabled", false);
                                    $("#ConsignmentReturnCustomerId").val(customerId);
    ...
    function checkBfSaveConsignmentReturn(){
        var formName = "#ConsignmentReturnAddForm";
    ...
    function changeInputCSSConsignmentReturn(){
        ...
        // Label
        $("#ConsignmentReturnAddForm").find("label").removeAttr("class");
        $("#ConsignmentReturnAddForm").find("label").each(function(){
        ...
        // Input & Select
        $("#ConsignmentReturnAddForm").find("input").each(function(){
            $(this).removeClass(cssRemove);
            $(this).addClass(cssStyle);
        });
        $("#ConsignmentReturnAddForm").find("select").each(function(){
...
<input type="hidden" value="0" id="ConsignmentReturnCurrencyCenterId" name="data[ConsignmentReturn][currency_center_id]" />
<input type="hidden" value="0" id="ConsignmentReturnLocationGroupId" name="data[ConsignmentReturn][location_group_id]" />
            ...
            <td style="width: 50%; vertical-align: top;">
                <table cellpadding="0" style="width: 100%">
                    <tr>
                        ...
                        <td style="width: 33%"><label for="ConsignmentReturnLocationGroupToId"><?php echo TABLE_LOCATION_GROUP; ?> <span class="red">*</span></td>
                    </tr>
                    <tr>
                        <td>
                            <div class="inputContainer" style="width:100%">
                                <select name="data[ConsignmentReturn][company_id]" id="ConsignmentReturnCompanyId" class="validate[required]" style="width: 75%;">
                                    <?php
                        ...
                        <td>
                           <div class="inputContainer" style="width:100%">
                                <select name="data[ConsignmentReturn][branch_id]" id="ConsignmentReturnBranchId" class="validate[required]" style="width: 75%;">
                                    ...
                                    ?>
                                    <option value="<?php echo $branch['Branch']['id']; ?>" com="<?php echo $branch['Branch']['company_id']; ?>" mcode="<?php echo $branch['ModuleCodeBranch']['cus_consign_return_code']; ?>" currency="<?php echo $branch['Branch']['currency_center_id']; ?>" symbol="<?php echo $branch['CurrencyCenter']['symbol']; ?>"><?php echo $branch['Branch']['name']; ?></option>
                                    <?php
                                    }
                                    ?>
                                </select>
            ...
            <td style="vertical-align: top;" rowspan="2" colspan="2">
                <table cellpadding="0" style="width: 100%">
                    ...
                    <tr>
                        <td>
                            <div class="inputContainer" style="width:100%">
                                <?php echo $this->Form->input('note', array('style' => 'width:90%; height: 70px;')); ?>
                            </div>
                        </td>
                    </tr>
                </table>
            ...
            <td style="width: 50%; vertical-align: top;">
                <table cellpadding="0" style="width: 100%">
                    ...
                    <tr>
                        <td>
                            <div class="inputContainer" style="width:100%">
                                <?php echo $this->Form->text('customer_name', array('class' => 'validate[required,funcCall[checkCustomerAddConsignmentReturn]]', 'style' => 'width:70%')); ?>
                                <?php echo $this->Form->hidden('customer_id'); ?>
                                <img alt="Search" align="absmiddle" style="cursor: pointer; width: 22px; height: 22px;" class="searchCustomerConsignmentReturn" onmouseover="Tip('<?php echo GENERAL_SEARCH; ?>')" src="<?php echo $this->webroot . 'img/button/search.png'; ?>" />
                                <img alt="Delete" align="absmiddle" style="display: none; cursor: pointer;" class="deleteCustomerConsignmentReturn" onmouseover="Tip('<?php echo ACTION_DELETE; ?>')" src="<?php echo $this->webroot . 'img/button/delete.png'; ?>" />
                            </div>
                        </td>
                        <td>
                            <div class="inputContainer" style="width:100%">
                        ...
                        <td>
                            <div class="inputContainer" style="width:100%">
                                ...
                                <?php echo $this->Form->text('consignment_code', array('style' => 'width:70%')); ?>
                                <img alt="Search" align="absmiddle" style="cursor: pointer; width: 22px; height: 22px;" class="searchConsignmentReturnConsignment" onmouseover="Tip('<?php echo GENERAL_SEARCH; ?>')" src="<?php echo $this->webroot . 'img/button/search.png'; ?>" />
                                <img alt="Delete" align="absmiddle" style="display: none; cursor: pointer;" class="deleteConsignmentReturnConsignment" onmouseover="Tip('<?php echo ACTION_DELETE; ?>')" src="<?php echo $this->webroot . 'img/button/delete.png'; ?>" />
                            </div>
                        </td>
                    </tr>
                </table>
            ...
            <td style="width: 17%; vertical-align: top;">
                <table cellpadding="0" style="width: 100%">
                    ...
                    <tr>
                        <td>
                            <div class="inputContainer" style="width:100%">
                                <?php echo $this->Form->text('date', array('value' => date("d/m/Y"),'class' => 'validate[required]', 'readonly' => 'readonly', 'style' => 'width:70%')); ?>
                            </div>
                        </td>
                    </tr>
                </table>
...
<div class="orderDetailConsignmentReturn" style=" margin-top: 5px; text-align: center;">
</div>
<div class="footerFormConsignmentReturn">
