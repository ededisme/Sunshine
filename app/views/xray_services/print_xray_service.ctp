    ...
    <div class="print_doc">
     ...
     <!--<h2 style="color: #03bbc8; text-align: center; font-size: 14px; line-height:18px; font-family: 'Khmer OS Metal Chrieng';">Tel : <?php echo $this->data['Branch']['telephone']; ?></h2>-->
                ...
                <td valign="middle" style="text-align: center; width: 20%;">                
                    <img style="width: 80px; height: 80px;" alt="" src="<?php echo $this->webroot; ?>img/imgxray.jpg" /> 
                </td>
            </tr>
            <tr>
                <td colspan="3">
            ...
            <tr >
                <td colspan="3"><p class="medicalImagine" style="margin-top: 10px ; color: #03bbc8; text-align: center; line-height:18px; font-family: 'Khmer OS Bokor';"><?php echo MEDICAL_IMAGING_KH; ?> - Medical Imaging</p></td>
            </tr>
        </table>

        <table style="float: left; width: 100%; padding-top: 10px;font-family: 'Khmer OS'">
            <tr>
                ...
                <td style="width: 5%;"> : </td>
                <td style="width: 25%;"> <?php echo date("d/m/Y H:i:s", strtotime($dataService['XrayService']['created'])); ?></td>
            </tr>   
            <tr>
        ...
        <table style="width: 100%;padding-bottom: 50px">
            <tr>
                <td style="width: 45%;" valign="top">
                    <?php
                        $i = 0 ; 
                        $queryImage = mysql_query("SELECT * FROM xray_service_images as esim WHERE is_active=1 AND xray_srv_id=" . $dataService['XrayService']['id']);
                        if (@mysql_num_rows($queryImage)) {
                            while ($dataImage = mysql_fetch_array($queryImage)) {
                                $i++ ; 
                                ?>
                                <p>
                                    <img src="<?php echo $this->webroot; ?>/img/x-ray/<?php echo $dataImage['src_name']; ?>" alt="<?php echo $dataImage['src_name']; ?>" width="200px" height="200px" vspace='2px' style="margin-left:5px;">
                                </p>
                                <?php
                            }
                        }
                ...
                <td style="width: 55%;" valign="top">
                    <div>
                        <b><?php echo TABLE_DESCRIPTION; ?> :</b>
                        <?php echo $dataService['XrayService']['description']; ?>
                    </div><br>
                    <div>
                       <b><?php echo TABLE_CONCLUSION;?> :</b>
                       <?php echo $dataService['XrayService']['conclusion']; ?>
                   </div>
                </td>
            </tr>
            <tr>
