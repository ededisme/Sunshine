...
<script type="text/javascript">
    ...
    $(document).ready(function(){
        ...
        // Action Save
        $("#CustomerContactAddForm").validationEngine();
        $("#CustomerContactAddForm").ajaxForm({
...
<br />
<?php echo $this->Form->create('CustomerContact', array('inputDefaults' => array('div' => false, 'label' => false))); 
...
<fieldset>
    ...
    <table>
        ...
        <tr>
            <td><label for="CustomerContactUserSex"><?php echo TABLE_SEX; ?> <span class="red">*</span> :</label></td>
            <td>
