...
<fieldset>
    ...
    <table class="info">
        <tr>
            ...
            <td style="width: 35%;">: <?php echo date("d/m/Y H:i:s", strtotime($patient['PatientEmergency']['date_ipd'])); ?></td>        
        ...
        <tr>
            <th><?php __(TABLE_DIAGNOSIS);?></th>
            <td>: <span style="text-transform: capitalize;"><?php echo $patient['PatientEmergency']['diagnostic']; ?></span></td>            
        </tr>
        <tr>
            <td colspan="3">
