...
<script type="text/javascript">
    var oTableEchographyInfom;
    $(document).ready(function(){
        // Prevent Key Enter
        preventKeyEnter();
        $("#<?php echo $tblName; ?> td:first-child").addClass('first');
        oTableEchographyInfom = $("#<?php echo $tblName; ?>").dataTable({
            "bProcessing": true,
            "bServerSide": true,
            ...
            "fnInfoCallback": function( oSettings, iStart, iEnd, iMax, iTotal, sPre ) {
                ...
                $(".btnViewEchographyInfom").click(function(event){
                ...
                $(".btnEditEchographyInfom").click(function(event){
                    event.preventDefault();
                    var id = $(this).attr('rel');
                ...
                $(".btnDeleteEchographyInfom").click(function(event){
                    event.preventDefault();
                    var id = $(this).attr('rel');
                    var name = $(this).attr('name');
        ...
        $(".btnAddEchographyInfom").click(function(event){
            event.preventDefault();
...
<div class="leftPanel">
    <div style="padding: 5px;border: 1px dashed #3C69AD;">
        <?php if($allowAdd){ ?>
        <div class="buttons">
            <a href="" class="positive btnAddEchographyInfom">
                <img src="<?php echo $this->webroot; ?>img/button/plus.png" alt=""/>
                <?php echo MENU_ECHOGRAPHY_MANAGEMENT_ADD; ?>
            </a>
        </div>
        <?php } ?>       
