...
<fieldset>
    ...
    <table style="width: 100%;" cellpadding="5">
        <tr>
            ...
            <td style="font-size: 12px;"><?php echo $this->data['Examination']['name']; ?></td>
        </tr>
<!--        <tr>
            <th style="font-size: 12px; width: 10%;"><?php __(TABLE_NAME_IN_KHMER); ?> :</th>
            <td style="font-size: 12px;">
             <?php 
//                if($this->data['Examination']['type'] == 1){
//                    echo MAN_DISEASE; 
//                } else {
...
//                }
        ...
        <tr>
            ...
            <td style="font-size: 12px;"><?php echo $this->data['Examination']['description']; ?></td>
        </tr>
        </tr>
        <tr>
            <th style="font-size: 12px;"><?php echo TABLE_CREATED; ?> :</th>
            <td style="font-size: 12px;" colspan="5"><?php echo $this->data['Examination']['created']; ?></td>
        </tr>
    </table>
</fieldset>
<br />   