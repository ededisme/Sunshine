...
<script type="text/javascript">
    var oTableCompanyInsurance;
    $(document).ready(function(){
        // Prevent Key Enter
        preventKeyEnter();
        $("#<?php echo $tblName; ?> td:first-child").addClass('first');
        oTableCompanyInsurance = $("#<?php echo $tblName; ?>").dataTable({
            "bProcessing": true,
            "bServerSide": true,
            ...
            "fnInfoCallback": function( oSettings, iStart, iEnd, iMax, iTotal, sPre ) {
                ...
                $(".btnViewCompanyInsurance").click(function(event){
                ...
                $(".btnEditCompanyInsurance").click(function(event){
                    event.preventDefault();
                    var id = $(this).attr('rel');
                    var name = $(this).attr('name');
                    var leftPanel=$(this).parent().parent().parent().parent().parent().parent().parent();
                ...
                $(".btnDeleteCompanyInsurance").click(function(event){
                    event.preventDefault();
                    var id = $(this).attr('rel');
                    var name = $(this).attr('name');
        ...
        $(".btnAddCompanyInsurance").click(function(event){
            event.preventDefault();
...
<div class="leftPanel">
    ...
    <div style="padding: 5px;border: 1px dashed #3C69AD;">
        <div class="buttons">
            <a href="" class="positive btnAddCompanyInsurance">
                <img src="<?php echo $this->webroot; ?>img/icon/plus.png" alt=""/>
                <?php echo MENU_COMPANY_INSURANCE_MANAGEMENT_ADD; ?>
                <img src="<?php echo $this->webroot; ?>img/icon/heart_insurance.png" alt=""/>
            </a>
        </div>
        ...
        <table id="<?php echo $tblName; ?>" class="table" cellspacing="0">
            <thead>
                <tr>
                    ...
                    <th style="width: 150px;"><?php echo TABLE_COMPANY; ?></th>                
                    <th style="width: 150px;"><?php echo MENU_COMPANY_INSURANCE_GROUP_MANAGEMENT; ?></th>                 
