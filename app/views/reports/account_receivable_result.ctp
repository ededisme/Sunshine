...
<div id="<?php echo $printArea; ?>">
    ...
    $excelContent .= TABLE_CUSTOMER."\t".TABLE_CLASS."\tCurrent";
    ?>
    <table class="table_report">
        <tr>
            <th class="first"><?php echo TABLE_CUSTOMER; ?></th>
        ...
        ?>
        <tr class="listARAgin">
            <td class="first" style="white-space: nowrap;" typeId="<?php echo $dataCustomer['id']; ?>"><?php echo $dataCustomer['customer_name']; ?></td>
            ...
            $query1=mysql_query("   SELECT SUM(debit) AS amount,GROUP_CONCAT(sales_order_id) AS arr_sales_order_id,GROUP_CONCAT(main_gl_id) AS arr_main_gl_id,
                                    ...
                                    WHERE is_active=1
                                        ...
                                        ".$accCon."
                                        AND customer_id=" . $dataCustomer['id'] . $conClass . "
            ...
            ?>
            <td class="totalARAgin" style="text-align: right;"><?php echo $total_row!=0 && $total_row!=''?$total_row:'-'; ?></td>
        </tr>
        <?php
            }
        }
        ...
        ?>
        <tr>
            <td class="first" style="white-space: nowrap;" typeId="all" colspan="2"><b>Total</b></td>
