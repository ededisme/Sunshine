 ...
 * export to excel
 */
$filename="public/report/sales_by_item_type_detail_" . $this->Session->id(session_id()) . ".csv";
...
<script type="text/javascript">
    $(document).ready(function(){
        ...
        $(".btnPrintSalesByType").click(function(event){
        ...
        $("#<?php echo $btnExport; ?>").click(function(){
            window.open("<?php echo $this->webroot; ?>public/report/sales_by_item_type_detail_<?php echo $this->Session->id(session_id()); ?>.csv", "_blank");
        });
    });
</script>
<div id="<?php echo $printArea; ?>">
    ...
    $excelContent .= TABLE_NO."\t".TABLE_TYPE."\t".TABLE_DATE."\t".TABLE_INVOICE_CODE."\t".TABLE_CUSTOMER."\t".TABLE_LOCATION_GROUP."\t".TABLE_QTY."\t".TABLE_UOM."\t".TABLE_PRICE."\t".GENERAL_AMOUNT;
    ?>
    <table id="<?php echo $tblName; ?>" class="table_report">
        ...
        while($data=mysql_fetch_array($query)){
            ...
            $excelContent .= "\n".$index."\t".$data['trans_type']."\t".$data['order_date']."\t".$data['code']."\t".$data['customer_name']."\t".$data['location_name']."\t".$data['qty']."\t".$data['qty_uom_name']."\t".$data['unit_price']."\t".number_format(($data['qty'] * $data['unit_price']), 2); ?>
            <tr>
                <td class="first"><?php echo $index++; ?></td>
                <td><?php echo $data['trans_type']; ?></td>
                <td><?php echo $data['order_date']; ?></td>
                <td><a href="" class="btnPrintSalesByType" rel="<?php echo $data[0]; ?>" trans_type="<?php echo $data['trans_type']; ?>"><?php echo $data['code']; ?></a></td>
        ...
        <tr style="font-weight: bold;"><td class="first" colspan="6" style="font-size: 14px;">Total Product</td><td style="text-align: center;"><?php echo number_format($totalQty, 2); ?></td><td></td><td></td><td style="text-align: right;font-size: 14px;text-decoration: underline;"><?php echo number_format($totalAmount, 2); ?></td></tr>
        <?php 
        } 
        if($col[6] == '' && $col[7] == '' && $col[8] == ''){ 
            ...
            <tr style="font-weight: bold;">
                <td class="first" colspan="6" style="font-size: 14px;">Total Miscellaneous</td>
                <td style="text-align: center;"><?php echo number_format($totalQty, 2); ?></td>
                <td colspan="2"></td>
                <td style="text-align: right;font-size: 14px;text-decoration: underline;"><?php echo number_format($totalAmount, 2); ?></td>
            </tr>
