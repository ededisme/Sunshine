...
$customerCode = "customer_code" . $rnd;
$other = "other" . $rnd;
...
<div class="legend">
    <div class="legend_title">
        <?php echo MENU_REPORT_CUSTOMER_ADDRESS_DETAIL; ?> <span class="btnShowHide" id="<?php echo $btnShowHide; ?>">[<?php echo TABLE_HIDE; ?>]</span>
    ...
    <div class="legend_content <?php echo $formFilter; ?>">
        <table style="width: 100%;">
            <tr>
                ...
                <td style="width: 6%;"><label for="<?php echo $customerCode; ?>"><?php echo TABLE_CODE; ?>:</label></td>
                <td style="width: 15%;">
                    <div class="inputContainer">
                        <input type="text" id="<?php echo $customerCode; ?>" name="customer_code" />
                    </div>
                </td>
                <td>
                    <div class="buttons">
    ...
    <div class="legend_content <?php echo $formFilter; ?>">
        <table style="width: 100%;">
            <tr>
                ...
                <td style="width: 8%;"><label for="<?php echo $cgroup; ?>"><?php echo PRICING_RULE_CUSTOMER_GROUP; ?>:</label></td>
                <td style="width: 15%;">
                    <div class="inputContainer">
                        <input type="hidden" name="customer_group" id="<?php echo $cgroupId; ?>" />
