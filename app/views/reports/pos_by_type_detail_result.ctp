 ...
 * export to excel
 */
$filename="public/report/sales_by_item_type_detail_pos_" . $this->Session->id(session_id()) . ".csv";
...
<script type="text/javascript">
    $(document).ready(function(){
        ...
        $(".btnPrintPosByType").click(function(event){
        ...
        $("#<?php echo $btnExport; ?>").click(function(){
            window.open("<?php echo $this->webroot; ?>public/report/sales_by_item_type_detail_pos_<?php echo $this->Session->id(session_id()); ?>.csv", "_blank");
        });
    });
</script>
    ...
    <table id="<?php echo $tblName; ?>" class="table_report">
        ...
        while($data=mysql_fetch_array($query)){
            ...
            <?php
                ...
                $excelContent .= "\n".$data['product_name']; ?>
            <tr>
                <td class="first" colspan="8" style="font-weight: bold;"><?php echo $data['product_name']; ?></td>
            </tr>
            <?php 
            } 
            if($col[9] == 1){
            ...
            <tr>
                ...
                <td><a href="" class="btnPrintPosByType" rel="<?php echo $data[0]; ?>"><?php echo $data['code']; ?></a></td>
