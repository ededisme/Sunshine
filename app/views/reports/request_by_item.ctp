    ...
    $(document).ready(function(){
        ...
        $("#<?php echo $btnSearch; ?>").click(function(){
            ...
            if($("#<?php echo $columns; ?>").val()==1){
                url="<?php echo $this->base; ?>/<?php echo $this->params['controller']; ?>/requestByItemParentResult";
            }else if($("#<?php echo $columns; ?>").val()==2){
                url="<?php echo $this->base; ?>/<?php echo $this->params['controller']; ?>/requestByItemResult";
            }else{
                url="<?php echo $this->base; ?>/<?php echo $this->params['controller']; ?>/requestByItemDetailResult";
            }
...
<div class="legend">
    <div class="legend_title">
        <?php echo MENU_REPORT_REQUEST_STOCK_BY_ITEM; ?> <span class="btnShowHide" id="<?php echo $btnShowHide; ?>">[<?php echo TABLE_HIDE; ?>]</span>
    ...
    <div class="legend_content <?php echo $formFilter; ?>">
        <table style="width: 100%;">
            <tr>
                ...
                <td style="width: 10%;"><label for="<?php echo $locationTo; ?>"><?php echo TABLE_TO_WAREHOUSE; ?>:</label></td>
                <td style="width: 25%;">
                    <div class="inputContainer">
    ...
    <div class="legend_content <?php echo $formFilter; ?>">
        <table style="width: 100%;">
            <tr>
                <td style="width: 10%;"><label for="<?php echo $parent; ?>"><?php echo PRODUCT_PARENT; ?>:</label></td>
                <td style="width: 25%;">
                    <div class="inputContainer">
                ...
                <td style="width: 10%;"><label for="<?php echo $product; ?>"><?php echo TABLE_PRODUCT; ?>:</label></td>
                <td style="width: 25%;">
                    <div class="inputContainer">
