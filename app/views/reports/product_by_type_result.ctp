...
<script type="text/javascript">
    ...
    $(document).ready(function(){
        ...
        <?php echo $oTable; ?> = $("#<?php echo $tblName; ?>").dataTable({
            ...
            "bProcessing": true,
            "bServerSide": true,
            "sAjaxSource": "<?php echo $this->base.'/'.$this->params['controller']; ?>/productByTypeAjax/<?php echo str_replace("/", "|||", implode(',', $_POST)); ?>",
            ...
            "fnInfoCallback": function( oSettings, iStart, iEnd, iMax, iTotal, sPre ) {
                ...
                <?php if(!$allowViewCost){ ?>
                    $("#<?php echo $tblName; ?> th:nth-child(6)").hide();
                    $("#<?php echo $tblName; ?> td:nth-child(6)").hide();
                    $("#<?php echo $tblName; ?> th:nth-child(7)").hide();
                    $("#<?php echo $tblName; ?> td:nth-child(7)").hide();
                <?php } ?>
                return sPre;
            },
        ...
        $("#<?php echo $btnExport; ?>").click(function(){
            window.open("<?php echo $this->webroot; ?>public/report/global_inventory_by_type_<?php echo $user['User']['id']; ?>.csv", "_blank");
        });
    });
</script>
<div id="<?php echo $printArea; ?>">
    ...
    if($_POST['company_id']!='' || $_POST['location_id']!='' || $_POST['pgroup_id']!='' || $_POST['created_by']!='') {
        $msg .= '<br /><br />';
    }
    if($_POST['company_id']!='') {
