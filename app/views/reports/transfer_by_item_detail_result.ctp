 ...
 * Export to Excel
 */
$filename="public/report/transfer_by_item_detail_" . $this->Session->id(session_id()) . ".csv";
...
<script type="text/javascript">
    $(document).ready(function(){
        ...
        $(".btnPrintTransferByItemReport").click(function(event){
        ...
        $("#<?php echo $btnExport; ?>").click(function(){
            window.open("<?php echo $this->webroot; ?>public/report/transfer_by_item_detail_<?php echo $this->Session->id(session_id()); ?>.csv", "_blank");
        });
    });
</script>
<div id="<?php echo $printArea; ?>">
    ...
    $excelContent .= TABLE_NO."\t".TABLE_TO_DATE."\t".TABLE_TO_NUMBER."\t".TABLE_FROM_WAREHOUSE."\t".TABLE_TO_WAREHOUSE."\t".TABLE_QTY."\t".TABLE_UOM;
    ?>
    <table id="<?php echo $tblName; ?>" class="table_report">
        ...
        $query=mysql_query("SELECT
                                ...
                                (SELECT cost FROM inventory_valuations WHERE is_active=1 AND pid=product_id AND date <= order_date ORDER BY date DESC,created DESC,id DESC LIMIT 1) AS unit_price
        ...
        while($data=mysql_fetch_array($query)){
            ...
            $excelContent .= "\n".$index."\t".dateShort($data['order_date'])."\t".$data['code']."\t".$data['location_from_name']."\t".$data['location_to_name']."\t".$data['qty']."\t".$data['qty_uom_name']; ?>
            <tr>
                <td class="first"><?php echo $index++; ?></td>
                <td><?php echo dateShort($data['order_date']); ?></td>
                <td><a href="" class="btnPrintTransferByItemReport" rel="<?php echo $data[0]; ?>"><?php echo $data['code']; ?></a></td>
