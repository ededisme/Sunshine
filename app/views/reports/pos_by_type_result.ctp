 ...
 * export to excel
 */
$filename="public/report/sales_by_item_type_pos_" . $this->Session->id(session_id()) . ".csv";
...
<script type="text/javascript">
    $(document).ready(function(){
        ...
        $("#<?php echo $btnExport; ?>").click(function(){
            window.open("<?php echo $this->webroot; ?>public/report/sales_by_item_type_pos_<?php echo $this->Session->id(session_id()); ?>.csv", "_blank");
        });
    });
</script>
<div id="<?php echo $printArea; ?>">
    ...
    $excelContent .= TABLE_NO."\t".TABLE_NAME."\t".TABLE_INVOICE_CODE."\t".TABLE_LOCATION."\t".TABLE_QTY."\t".GENERAL_AMOUNT;
    ?>
    ...
    ?>
        ...
        while($data=mysql_fetch_array($query)){
            ...
            <tr style="font-weight: bold;">
                <td class="first" colspan="4">Total <?php echo $oldPgroupName; ?></td>
            ...
            $excelContent .= "\n".$data['pgroup_name']; 
            ?>
            <tr><td class="first" colspan="6" style="font-weight: bold;"><?php echo $data['pgroup_name']; ?></td></tr>
            <?php 
            }
            // Smallest Uom
