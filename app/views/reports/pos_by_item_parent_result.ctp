 ...
 * export to excel
 */
$filename="public/report/sales_by_item_parent_pos_" . $this->Session->id(session_id()) . ".csv";
...
<script type="text/javascript">
    $(document).ready(function(){
        ...
        $("#<?php echo $btnExport; ?>").click(function(){
            window.open("<?php echo $this->webroot; ?>public/report/sales_by_item_parent_pos_<?php echo $this->Session->id(session_id()); ?>.csv", "_blank");
        });
    });
</script>
    ...
    <?php
        ...
        while($data=mysql_fetch_array($query)){
            ...
            if($data['parent_id']!=$oldParentId){ 
                if($oldParentName!=''){ 
                    $excelContent .= "\n".$index."\t".$oldParentName."\t\t\t".$subTotalParentQty."\t".number_format($subTotalParentAmount, 2); ?>
            <tr>
                <td class="first"><?php echo $index++; ?></td>
                <td colspan="3"><?php echo $oldParentName; ?></td>
        ...
        <tr>
            <td class="first"><?php echo $index++; ?></td>
            <td colspan="3"><?php echo $oldParentName; ?></td>
            <td style="text-align: center;"><?php echo $subTotalParentQty; ?></td>
            <td style="text-align: right;"><?php echo number_format($subTotalParentAmount,2); ?></td>
        </tr>
        <?php $excelContent .= "\n".'Total Product'."\t\t\t\t".$totalQty."\t".number_format($totalAmount,2); ?>
        <tr style="font-weight: bold;">
            <td class="first" colspan="4" style="font-size: 14px;">Total Product</td>
            <td style="text-align: center;font-size: 14px;text-decoration: underline;"><?php echo $totalQty; ?></td>
        ...
        <tr style="font-weight: bold;">
            ...
            <td style="text-align: center;font-size: 14px;text-decoration: underline;"><?php echo $grandTotalQty; ?></td>
