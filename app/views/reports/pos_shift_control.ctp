    ...
    $(document).ready(function(){
        ...
        $("#<?php echo $btnSearch; ?>").click(function(){
            ...
            if(isFormValidated){
                $.ajax({
                    type: "POST",
                    url: "<?php echo $this->base; ?>/<?php echo $this->params['controller']; ?>/posShiftControlResult",
...
<div class="legend">
    <div class="legend_title">
        <?php echo MENU_REPORT_SHIFT_CONTROL; ?> <span class="btnShowHide" id="<?php echo $btnShowHide; ?>">[<?php echo TABLE_HIDE; ?>]</span>
                ...
                <td style="width: 15%;">
                    <div class="inputContainer">
                        <select id="<?php echo $status; ?>" name="status">
                            <option value="" selected="selected"><?php echo TABLE_ALL; ?></option>
                            <option value="1"><?php echo TABLE_STATUS_OPEN; ?></option>
                            <option value="2"><?php echo TABLE_STATUS_CLOSE; ?></option>
                            <option value="3"><?php echo TABLE_STATUS_COLLECT; ?></option>
                        </select>
                    </div>
                </td>
                <td>
