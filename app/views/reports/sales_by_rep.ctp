    ...
    $(document).ready(function(){
        ...
        $("#<?php echo $btnSearch; ?>").click(function(){
            if($("#<?php echo $columns; ?>").val() == 2){
                var url="<?php echo $this->base; ?>/<?php echo $this->params['controller']; ?>/salesByRepResult";
            }else{
                var url="<?php echo $this->base; ?>/<?php echo $this->params['controller']; ?>/salesByRepDetailResult";
            }
...
<div class="legend">
    <div class="legend_title">
        <?php echo MENU_REPORT_SALES_ORDER_BY_REP; ?> <span class="btnShowHide" id="<?php echo $btnShowHide; ?>">[<?php echo TABLE_HIDE; ?>]</span>
    ...
    <div class="legend_content <?php echo $formFilter; ?>">
        <table style="width: 100%;">
            <tr>
                ...
                <td style="width: 8%;"><label for="<?php echo $cgroup; ?>"><?php echo MENU_CUSTOMER_GROUP_MANAGEMENT; ?>:</label></td>
                <td style="width: 15%;">
                    <div class="inputContainer">
