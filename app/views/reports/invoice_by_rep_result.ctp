...
<script type="text/javascript">
    ...
    $(document).ready(function(){
        ...
        <?php echo $oTable; ?> = $("#<?php echo $tblName; ?>").dataTable({
            ...
            "bProcessing": true,
            "bServerSide": true,
            "sAjaxSource": "<?php echo $this->base.'/'.$this->params['controller']; ?>/invoiceByRepAjax/<?php echo str_replace("/", "|||", implode(',', $_POST)); ?>",
            ...
            "fnInfoCallback": function( oSettings, iStart, iEnd, iMax, iTotal, sPre ) {
                ...
                $(".btnPrintCustomerInvoiceByRep").click(function(event){
                ...
                $(".rowInvoiceByRep").delay(10).each(function(){
                    $(this).closest("tr").hide();
                });
                $(".btnPlusMinusInvoiceByRep").click(function(){
                    if($(this).attr("src") == "<?php echo $this->webroot; ?>img/minus.gif"){
                        $(this).attr("src", "<?php echo $this->webroot; ?>img/plus.gif");
                    }else{
                        $(this).attr("src", "<?php echo $this->webroot; ?>img/minus.gif");
                    }
                    $(".rowInvoiceByRep[rel='" + $(this).attr("rel") + "']").closest("tr").toggle();
                });
                return sPre;
            },
        ...
        $("#<?php echo $btnExport; ?>").click(function(){
            $.ajax({
                type: "POST",
                url: "<?php echo $this->base; ?>/<?php echo $this->params['controller']; ?>/invoiceByRep/<?php echo str_replace("/", "|||", implode(',', $_POST)); ?>",
                data: "action=export",
                beforeSend: function(){
                    $(".loader").attr("src", "<?php echo $this->webroot; ?>img/layout/spinner.gif");
                },
                success: function(){
                    $(".loader").attr("src", "<?php echo $this->webroot; ?>img/layout/spinner-placeholder.gif");
                    window.open("<?php echo $this->webroot; ?>public/report/invoice_by_rep.csv", "_blank");
                }
            });
        });
    });
...
<div id="<?php echo $printArea; ?>">
    <?php
    $msg = '<b style="font-size: 18px;">' . MENU_REPORT_INVOICE_REP . '</b><br /><br />';
    if($_POST['date_from']!='') {
        ...
        <table id="<?php echo $tblName; ?>" class="table_report">
            <thead>
                <tr>
                    ...
                    <th style="width: 220px !important;"><?php echo TABLE_CUSTOMER; ?></th>
