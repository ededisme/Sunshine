...
<script type="text/javascript">
    $(document).ready(function(){
        ...
        $("#<?php echo $btnSearch; ?>").click(function(){
            var url="<?php echo $this->base; ?>/<?php echo $this->params['controller']; ?>/salesBySalesmanDetailResult";
...
<div class="legend">
    <div class="legend_title">
        <?php echo MENU_REPORT_SALES_BY_REP; ?> <span class="btnShowHide" id="<?php echo $btnShowHide; ?>">[<?php echo TABLE_HIDE; ?>]</span>
    </div>
    <div class="legend_content <?php echo $formFilter; ?>">
        <table style="width: 100%;">
            <tr>
                ...
                <td style="width: 9%;"><label for="<?php echo $dateTo; ?>"><?php echo REPORT_TO; ?>:</label></td>
                <td style="width: 15%;">
                    <div class="inputContainer">
                ...
                <td style="width: 15%;">
                    <div class="inputContainer">
                        <select id="<?php echo $status; ?>" name="status" style="width: 85%;">
    ...
    <div class="legend_content <?php echo $formFilter; ?>">
        <table style="width: 100%;">
            <tr>
                ...
                <td style="width: 15%;">
                    <div class="inputContainer">
                        <?php echo $this->Form->select($location, $locationGroups, null, array('escape' => false, 'name' => 'location_group_id', 'empty' => TABLE_ALL)); ?>
                    </div>
                </td>
                <td style="width: 9%;"><label for="<?php echo $salesman; ?>"><?php echo TABLE_SALES_REP; ?>:</label></td>
                <td style="width: 15%;">
                    <div class="inputContainer">
                        <?php echo $this->Form->select($salesman, $salesmans, null, array('escape' => false, 'name' => 'salesman', 'class' => 'chzn-select', 'style' => 'width: 190px;', 'empty' => TABLE_ALL)); ?>
                    </div>
                </td>
    ...
    <div class="legend_content <?php echo $formFilter; ?>">
        <table style="width: 100%;">
            <tr>
                ...
                <td style="width: 9%;"><label for="<?php echo $createdBy; ?>"><?php echo TABLE_CREATED_BY; ?>:</label></td>
                <td style="width: 15%;">
                    <div class="inputContainer">
                        <select id="<?php echo $createdBy; ?>" class="createdBy chzn-select" name="created_by" style="width: 190px;">
                            <option value=""><?php echo TABLE_ALL ?></option>
                            <?php
