 ...
 * export to excel
 */
$filename="public/report/sales_by_rep_" . $this->Session->id(session_id()) . ".csv";
...
<script type="text/javascript">
    $(document).ready(function(){
        ...
        $("#<?php echo $btnExport; ?>").click(function(){
            window.open("<?php echo $this->webroot; ?>public/report/sales_by_rep_<?php echo $this->Session->id(session_id()); ?>.csv", "_blank");
        });
    });
</script>
<div id="<?php echo $printArea; ?>">
    ...
    $excelContent .= TABLE_NO."\t".TABLE_NAME."\t".TABLE_INVOICE_CODE."\t".TABLE_PRODUCT_NAME."\t".TABLE_CUSTOMER."\t".TABLE_LOCATION."\t".GENERAL_AMOUNT;
    ?>
    <table id="<?php echo $tblName; ?>" class="table_report">
        <tr>
            ...
            <th style="width: 120px !important;"><?php echo TABLE_LOCATION; ?></th>
        ...
        while($data=mysql_fetch_array($query)){
            ...
            if($data['cgroup_id']!=$oldCustomerGroupId){ 
                if($oldCustomerGroupName!=''){ 
                    $excelContent .= "\n".$index."\t".$oldCustomerGroupName."\t\t\t\t\t".number_format($subTotalAmount, 2); ?>
            <tr>
                <td><?php echo $index++; ?></td>
                <td colspan=5"><?php echo $oldCustomerGroupName; ?></td>
