...
<script type="text/javascript">
    $(document).ready(function(){
        ...
        $("#<?php echo $btnSearch; ?>").click(function(){
            if($("#<?php echo $columns; ?>").val() == 2){
                var url="<?php echo $this->base; ?>/<?php echo $this->params['controller']; ?>/salesByCustomerResult";
            }else{
                var url="<?php echo $this->base; ?>/<?php echo $this->params['controller']; ?>/salesByCustomerDetailResult";
            }
...
<div class="legend">
    <div class="legend_title">
        <?php echo MENU_REPORT_SALES_ORDER_BY_CUSTOMER; ?> <span class="btnShowHide" id="<?php echo $btnShowHide; ?>">[<?php echo TABLE_HIDE; ?>]</span>
    ...
    <div class="legend_content <?php echo $formFilter; ?>">
        <table style="width: 100%;">
            <tr>
                <td style="width: 8%;"><label for="<?php echo $columns; ?>">Show Total only:</label></td>
                <td style="width: 15%;">
                    <div class="inputContainer">
                ...
                <td style="width: 7%;"><label for="<?php echo $location; ?>"><?php echo TABLE_LOCATION_GROUP; ?>:</label></td>
                <td style="width: 15%;">
                    <div class="inputContainer">
    ...
    <div class="legend_content <?php echo $formFilter; ?>">
        <table style="width: 100%;">
            <tr>
                ...
                <td style="width: 7%;"><label for="<?php echo $free; ?>"><?php echo TABLE_FREE_ITEM; ?>:</label></td>
                <td style="width: 15%;">
                    <div class="inputContainer">
    ...
    <div class="legend_content <?php echo $formFilter; ?>">
        <table style="width: 100%;">
            <tr>
                ...
                <td style="width: 9%;"><label for="<?php echo $customer; ?>"><?php echo TABLE_CUSTOMER; ?>:</label></td>
                <td style="width: 25%;">
                    <div class="inputContainer">
