...
<script type="text/javascript">
    ...
    $(document).ready(function(){
        ...
        <?php echo $oTable; ?> = $("#<?php echo $tblName; ?>").dataTable({
            ...
            "bProcessing": true,
            "bServerSide": true,
            "sAjaxSource": "<?php echo $this->base.'/'.$this->params['controller']; ?>/purchaseInvoiceCreditAjax/<?php echo str_replace("/", "|||", implode(',', $_POST)); ?>",
            ...
            "fnInfoCallback": function( oSettings, iStart, iEnd, iMax, iTotal, sPre ) {
                ...
                $(".btnPrintBillReturnReport").click(function(event){
                ...
                $("#<?php echo $tblName; ?> tr:gt(0)").each(function(){
                    total += replaceNum($(this).find(".btnPrintBillReturnReport").attr("total"));
                    totalRemaining += replaceNum($(this).find(".btnPrintBillReturnReport").attr("total"));
                });
                $('#<?php echo $tblName; ?> > tbody:last').append('<tr><td class="first" style="font-weight: bold;" colspan="5"><?php echo TABLE_TOTAL; ?>:</td><td class="formatCurrency" style="text-align: right;font-weight: bold;">' + (total) + '</td><td class="formatCurrency" style="text-align: right;font-weight: bold;">' + (totalRemaining) + '</td><td colspan="2"></td></tr>');
...
<div id="<?php echo $printArea; ?>">
    <?php
    $msg = '<b style="font-size: 18px;">' . MENU_PURCHASE_INVOICE_CREDIT . '</b><br /><br />';
    if($_POST['date_from']!='') {
