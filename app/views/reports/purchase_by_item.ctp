    ...
    $(document).ready(function(){
        ...
        $("#<?php echo $btnSearch; ?>").click(function(){
            if($("#<?php echo $columns; ?>").val()==1){
                var url="<?php echo $this->base; ?>/<?php echo $this->params['controller']; ?>/purchaseByItemParentResult";
            }else if($("#<?php echo $columns; ?>").val()==2){
                var url="<?php echo $this->base; ?>/<?php echo $this->params['controller']; ?>/purchaseByItemResult";
            }else{
                var url="<?php echo $this->base; ?>/<?php echo $this->params['controller']; ?>/purchaseByItemDetailResult";
            }
...
<div class="legend">
    <div class="legend_title">
        <?php echo MENU_PURCHASE_BY_ITEM; ?> <span class="btnShowHide" id="<?php echo $btnShowHide; ?>">[<?php echo TABLE_HIDE; ?>]</span>
    ...
    <div class="legend_content <?php echo $formFilter; ?>">
        <table style="width: 100%;">
            <tr>
                ...
                <td style="width: 6%;"><label for="<?php echo $warehouse; ?>"><?php echo TABLE_LOCATION_GROUP; ?>:</label></td>
                <td style="width: 15%;">
                    <div class="inputContainer">
                        <?php echo $this->Form->select($warehouse, $warehouses, null, array('escape' => false, 'name' => 'location_group_id', 'empty' => TABLE_ALL)); ?>
                    </div>
                </td>
                <td></td>
            </tr>
