    ...
    $(document).ready(function(){
        ...
        $("#<?php echo $btnSearch; ?>").click(function(){
            ...
            if($("#<?php echo $show; ?>").val() == 1){
                url = 'salesTopItemResult';
            } else {
                url = 'salesTopItemGraph';
            }
            if(isFormValidated){
                $.ajax({
                    type: "POST",
...
<div class="legend">
    <div class="legend_title">
        <?php echo MENU_SALES_TOP_ITEM; ?> <span class="btnShowHide" id="<?php echo $btnShowHide; ?>">[<?php echo TABLE_HIDE; ?>]</span>
                ...
                <td style="width: 15%;">
                    <div class="inputContainer">
                        <select id="<?php echo $view; ?>" name="view_by">
                            <option value="1">Total Quantity</option>
