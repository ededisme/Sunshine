 ...
 * export to excel
 */
$filename="public/report/sales_by_item_type_parent_" . $this->Session->id(session_id()) . ".csv";
...
<script type="text/javascript">
    $(document).ready(function(){
        ...
        $("#<?php echo $btnExport; ?>").click(function(){
            window.open("<?php echo $this->webroot; ?>public/report/sales_by_item_type_parent_<?php echo $this->Session->id(session_id()); ?>.csv", "_blank");
        });
    });
</script>
<div id="<?php echo $printArea; ?>">
    ...
    $excelContent .= TABLE_NO."\t".TABLE_NAME."\t".TABLE_INVOICE_CODE."\t".TABLE_CUSTOMER."\t".TABLE_LOCATION."\t".GENERAL_AMOUNT;
    ?>
    <table id="<?php echo $tblName; ?>" class="table_report">
        ...
        while($data=mysql_fetch_array($query)){
            ...
            if($data['pgroup_id']!=$oldPgroupId){ 
                if($oldPgroupName!=''){ 
                    $excelContent .= "\n".$index."\t".$oldPgroupName."\t\t\t\t".number_format($subTotalParentAmount, 2); ?>
            <tr>
                <td class="first"><?php echo $index++; ?></td>
                <td colspan="4"><?php echo $oldPgroupName; ?></td>
