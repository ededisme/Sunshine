    ...
    $(document).ready(function(){
        ...
        $("#<?php echo $btnSearch; ?>").click(function(){
            ...
            if($("#<?php echo $columns; ?>").val()==1){
                url="<?php echo $this->base; ?>/<?php echo $this->params['controller']; ?>/inventoryAdjustmentByItemParentResult";
            }else if($("#<?php echo $columns; ?>").val()==2){
                url="<?php echo $this->base; ?>/<?php echo $this->params['controller']; ?>/inventoryAdjustmentByItemResult";
            }else{
                url="<?php echo $this->base; ?>/<?php echo $this->params['controller']; ?>/inventoryAdjustmentByItemDetailResult";
            }
...
<div class="legend">
    <div class="legend_title">
        <?php echo MENU_INVENTORY_ADJUSTMENT; ?> <span class="btnShowHide" id="<?php echo $btnShowHide; ?>">[<?php echo TABLE_HIDE; ?>]</span>
