    ...
    $(document).ready(function(){
        ...
        $("#<?php echo $btnSearch; ?>").click(function(){
            ...
            if(isFormValidated){
                $.ajax({
                    type: "POST",
                    url: "<?php echo $this->base; ?>/<?php echo $this->params['controller']; ?>/serviceReferralResult",
...
<div class="legend">
    <div class="legend_title">
        <?php echo MENU_REFERRAL_REPORT; ?> <span class="btnShowHide" id="<?php echo $btnShowHide; ?>">[<?php echo TABLE_HIDE; ?>]</span>
    ...
    <div class="legend_content <?php echo $formFilter; ?>">
        <table style="width: 100%;">
            <tr>
                <td style="width: 8%;"><label for="<?php echo $service; ?>"><?php echo SERVICE_SERVICE; ?>:</label></td>
                <td style="width: 15%;">
                    <div class="inputContainer">
                        <?php echo $this->Form->select($service, $services, null, array('escape' => false, 'name' => 'service_id', 'empty' => TABLE_ALL)); ?>
                    </div>
                </td>
                <td style="width: 6%;"><label for="<?php echo $referral; ?>"><?php echo TABLE_REFERRAL; ?>:</label></td>
                <td style="width: 15%;">
                    <div class="inputContainer">
                        <?php echo $this->Form->select($referral, $referrals, null, array('escape' => false, 'name' => 'referral_id', 'empty' => TABLE_ALL)); ?>
                    </div>
                </td>
                <td></td><td></td>
            </tr>
