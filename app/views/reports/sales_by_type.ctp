    ...
    $(document).ready(function(){
        ...
        $("#<?php echo $btnSearch; ?>").click(function(){
            if($("#<?php echo $columns; ?>").val()==1){
                var url="<?php echo $this->base; ?>/<?php echo $this->params['controller']; ?>/salesByTypeParentResult";
            }else if($("#<?php echo $columns; ?>").val()==2){
                var url="<?php echo $this->base; ?>/<?php echo $this->params['controller']; ?>/salesByTypeResult";
            }else{
                var url="<?php echo $this->base; ?>/<?php echo $this->params['controller']; ?>/salesByTypeDetailResult";
            }
...
<div class="legend">
    <div class="legend_title">
        <?php echo MENU_REPORT_SALES_ORDER_BY_ITEM_TYPE; ?> <span class="btnShowHide" id="<?php echo $btnShowHide; ?>">[<?php echo TABLE_HIDE; ?>]</span>
    ...
    <div class="legend_content <?php echo $formFilter; ?>">
        <table style="width: 100%;">
            <tr>
                <td style="width: 9%;"><label for="<?php echo $columns; ?>"><?php echo ACTION_VIEW; ?>:</label></td>
                <td style="width: 15%;">
                    <select id="<?php echo $columns; ?>">
                        <option value="1">Parent Summary</option>
                        <option value="2" selected="selected">Item Type Summary</option>
                        <option value="3">Item Detail</option>
                    </select>
                </td>
                ...
                <td style="width: 7%;"><label for="<?php echo $pgroup; ?>"><?php echo MENU_PRODUCT_GROUP_MANAGEMENT; ?>:</label></td>
                <td style="width: 15%;">
    ...
    <div class="legend_content <?php echo $formFilter; ?>">
        <table style="width: 100%;">
            <tr>
                <td style="width: 9%;"><label for="<?php echo $parent; ?>"><?php echo PRODUCT_PARENT; ?>:</label></td>
                <td style="width: 15%;">
                    <div class="inputContainer">
                ...
                <td style="width: 6%;"><label for="<?php echo $free; ?>"><?php echo TABLE_FREE_ITEM; ?>:</label></td>
                <td style="width: 15%;">
                    <div class="inputContainer">
                        <select id="<?php echo $free; ?>" name="is_free">
                            <option value=""><?php echo TABLE_ALL; ?></option>
                            <option value="1"><?php echo ACTION_NO; ?></option>
                            <option value="2"><?php echo ACTION_YES; ?></option>
                        </select>
                    </div>
                </td>
                <td style="width: 7%;"><label for="<?php echo $createdBy; ?>"><?php echo TABLE_CREATED_BY; ?>:</label></td>
                <td style="width: 15%;">
                    <div class="inputContainer">
    ...
    <div class="legend_content <?php echo $formFilter; ?>">
        <table style="width: 100%;">
            <tr>
                <td style="width: 9%;"><label for="<?php echo $withPos; ?>">Show With POS:</label></td>
                <td style="width: 15%;">
                    <select id="<?php echo $withPos; ?>" name="withPos">
                        <option value="1"><?php echo ACTION_NO; ?></option>
                        <option value="2" selected="selected"><?php echo ACTION_YES; ?></option>
                    </select>
                </td>
                <td></td>
            </tr>
