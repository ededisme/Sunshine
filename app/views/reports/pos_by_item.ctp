    ...
    $(document).ready(function(){
        ...
        $("#<?php echo $btnSearch; ?>").click(function(){
            ...
            if($("#<?php echo $columns; ?>").val()==1){
                url = "<?php echo $this->base; ?>/<?php echo $this->params['controller']; ?>/posByItemParentResult";
            }else if($("#<?php echo $columns; ?>").val()==2){
                url = "<?php echo $this->base; ?>/<?php echo $this->params['controller']; ?>/posByItemResult";
            }else{
                 url = "<?php echo $this->base; ?>/<?php echo $this->params['controller']; ?>/posByItemDetailResult";
            }
...
<div class="legend">
    <div class="legend_title">
        <?php echo MENU_REPORT_POS_BY_ITEM; ?> <span class="btnShowHide" id="<?php echo $btnShowHide; ?>">[<?php echo TABLE_HIDE; ?>]</span>
