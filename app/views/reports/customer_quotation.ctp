    ...
    $(document).ready(function(){
        ...
        $("#<?php echo $btnSearch; ?>").click(function(){
            ...
            if($('#<?php echo $typeView; ?>').val()==1){
                var url="<?php echo $this->base; ?>/<?php echo $this->params['controller']; ?>/customerQuotationProductResult";
            }else if($('#<?php echo $typeView; ?>').val()==2){
                var url="<?php echo $this->base; ?>/<?php echo $this->params['controller']; ?>/customerQuotationProductSummaryResult";
            }else{
                var url="<?php echo $this->base; ?>/<?php echo $this->params['controller']; ?>/customerQuotationResult";
            }
            if(isFormValidated){
                $.ajax({
                    type: "POST",
...
<div class="legend">
    <div class="legend_title">
        <?php echo MENU_QUOTATION; ?> <span class="btnShowHide" id="<?php echo $btnShowHide; ?>">[<?php echo TABLE_HIDE; ?>]</span>
    ...
    <div class="legend_content <?php echo $formFilter; ?>">
        <table style="width: 100%;">
            <tr>
                <td style="width: 7%;"><label for="<?php echo $approve; ?>"><?php echo ACTION_APPROVE; ?>:</label></td>
                <td style="width: 15%;">
                    <div class="inputContainer">
                ...
                <td style="width: 15%;">
                    <div class="inputContainer">
                        <select id="<?php echo $typeView; ?>"  class="typeView"  name="type_view">
                            <option value="all"><?php echo 'Quotation Detail'; ?></option>
                            <option value="1"><?php echo 'Quotation By Product'; ?></option>
                            <option value="2"><?php echo 'Quotation By Product Summary'; ?></option>
                        </select>
                    </div>
                </td>
                <td></td>
