    ...
    $(document).ready(function(){
        ...
        $("#<?php echo $btnSearch; ?>").click(function(){
            ...
            if(isFormValidated){
                $.ajax({
                    type: "POST",
                    url: "<?php echo $this->base; ?>/<?php echo $this->params['controller']; ?>/profitLossResult",
...
<div class="legend">
    <div class="legend_title">
        <?php echo MENU_PROFIT_AND_LOSS; ?> <span class="btnShowHide" id="<?php echo $btnShowHide; ?>">[<?php echo TABLE_HIDE; ?>]</span>
    ...
    <div class="legend_content <?php echo $formFilter; ?>">
        <table style="width: 100%;">
            <tr>
                ...
                <td style="width: 8%;"><label for="<?php echo $columns; ?>">Columns:</label></td>
                <td style="width: 15%;">
                    <div class="inputContainer">
                        <select id="<?php echo $columns; ?>" name="columns">
                            <option value="0">Total only</option>
                            <option value="1">By Day</option>
                            <option value="2" disabled="disabled">By Week</option>
                            <option value="3">By Month</option>
                            <option value="4">By Quarter</option>
                            <option value="5">By Semester</option>
                            <option value="6">By Year</option>
                            <option value="7">By Class</option>
                        </select>
                    </div>
                </td>
                <td>
    ...
    <div class="legend_content <?php echo $formFilter; ?>">
        <table style="width: 100%;">
            <tr>
                <td style="width: 8%;"><label for="<?php echo $empty; ?>"><?php echo TABLE_EMPTY_VALUE ?>:</label></td>
                <td style="width: 15%;">
                    <div class="inputContainer">
                        <select id="<?php echo $empty; ?>" name="empty">
                            <option value="1"><?php echo TABLE_HIDE; ?></option>
                            <option value="2"><?php echo TABLE_SHOW; ?></option>
                        </select>
                    </div>
                </td>
                <td style="width: 42%;">
    ...
    <div class="legend_content <?php echo $formFilter; ?>">
        <table style="width: 100%;">
            <tr>
                ...
                <td style="width: 6%;">
                    <input type="hidden" value="" name="other_id" />
