    ...
    $(document).ready(function(){
        ...
        $("#<?php echo $btnSearch; ?>").click(function(){
            ...
            if(isFormValidated){
                $.ajax({
                    type: "POST",
                    url: "<?php echo $this->base; ?>/<?php echo $this->params['controller']; ?>/customerAddressResult",
...
<div class="legend">
    <div class="legend_title">
        <?php echo MENU_REPORT_CUSTOMER_ADDRESS; ?> <span class="btnShowHide" id="<?php echo $btnShowHide; ?>">[<?php echo TABLE_HIDE; ?>]</span>
    ...
    <div class="legend_content <?php echo $formFilter; ?>">
        <table style="width: 100%;">
            <tr>
                ...
                <td style="width: 6%;"><label for="<?php echo $village; ?>"><?php echo TABLE_VILLAGE; ?>:</label></td>
                <td style="width: 15%;">
                    <div class="inputContainer">
