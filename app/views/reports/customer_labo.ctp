    ...
    $(document).ready(function(){
        ...
        $("#<?php echo $btnSearch; ?>").click(function(){
            ...
            if(isFormValidated){
                $.ajax({
                    type: "POST",
                    url: "<?php echo $this->base; ?>/<?php echo $this->params['controller']; ?>/customerLaboResult",
...
<div class="legend">
    <div class="legend_title">
        <?php echo MENU_LABO_MANAGEMENT; ?> <span class="btnShowHide" id="<?php echo $btnShowHide; ?>">[<?php echo TABLE_HIDE; ?>]</span>
    ...
    <div class="legend_content <?php echo $formFilter; ?>">
        <table style="width: 100%;">
            <tr>
                ...
                <td style="width: 8%;"><label for="<?php echo $laboSubGroup; ?>"><?php echo MENU_SUB_GROUP; ?>:</label></td>
                <td style="width: 15%;">
                    <div class="inputContainer">
                        <?php echo $this->Form->select($laboSubGroup, $laboSubGroups, null, array('escape' => false, 'name' => 'labo_item_group_id', 'empty' => TABLE_ALL)); ?>
                    </div>
                </td>
                <td>
                    <div class="buttons">
    ...
    <div class="legend_content <?php echo $formFilter; ?>">
        <table style="width: 100%;">
            <tr>
                <td style="width: 8%;"><label for="<?php echo $doctor; ?>"><?php echo MENU_DOCTOR; ?>:</label></td>
                <td style="width: 20%;">
                    <div class="inputContainer">
                        <?php echo $this->Form->select($doctor, $doctors ,  null, array('escape' => false, 'name' => 'doctor_id','class' => 'chzn-select' , 'empty' => TABLE_ALL)); ?>
                    </div>
                </td>
                <td style="width: 8%;"><label for="<?php echo $patient; ?>"><?php echo PATIENT_NAME; ?>:</label></td>
                <td style="width: 20%;">
                     <div class="inputContainer">
                         <?php echo $this->Form->select($patient, $patients ,  null, array('escape' => false, 'name' => 'patient_id', 'class' => 'chzn-select' , 'empty' => TABLE_ALL)); ?>
                     </div>
                </td>
                <td></td>
            </tr>
