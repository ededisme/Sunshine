    ...
    $(document).ready(function(){
        ...
        $("#<?php echo $btnSearch; ?>").click(function(){
            if($("#<?php echo $columns; ?>").val()==1){
                var url="<?php echo $this->base; ?>/<?php echo $this->params['controller']; ?>/salesByItemParentResult";
            }else if($("#<?php echo $columns; ?>").val()==2){
                var url="<?php echo $this->base; ?>/<?php echo $this->params['controller']; ?>/salesByItemResult";
            }else{
                var url="<?php echo $this->base; ?>/<?php echo $this->params['controller']; ?>/salesByItemDetailResult";
            }
...
<div class="legend">
    <div class="legend_title">
        <?php echo MENU_REPORT_SALES_ORDER_BY_ITEM; ?> <span class="btnShowHide" id="<?php echo $btnShowHide; ?>">[<?php echo TABLE_HIDE; ?>]</span>
    ...
    <div class="legend_content <?php echo $formFilter; ?>">
        <table style="width: 100%;">
            <tr>
                ...
                <td style="width: 9%;"><label for="<?php echo $dateFrom; ?>"><?php echo REPORT_FROM; ?>:</label></td>
                <td style="width: 15%;">
    ...
    <div class="legend_content <?php echo $formFilter; ?>">
        <table style="width: 100%;">
            <tr>
                <td style="width: 8%;"><label for="<?php echo $columns; ?>"><?php echo ACTION_VIEW; ?>:</label></td>
                <td style="width: 15%;">
                    <select id="<?php echo $columns; ?>">
                        <option value="1">Parent Summary</option>
                        <option value="2" selected="selected">Item Summary</option>
    ...
    <div class="legend_content <?php echo $formFilter; ?>">
        <table style="width: 100%;">
            <tr>
                ...
                <td style="width: 9%;"><label for="<?php echo $withPos; ?>"><?php echo TABLE_SHOW; ?>:</label></td>
                <td style="width: 15%;">
                    <select id="<?php echo $withPos; ?>" name="withPos">
                        <option value=""><?php echo TABLE_ALL; ?></option>
                        <option value="1"><?php echo MENU_SALES_ORDER_MANAGEMENT; ?></option>
                        <option value="2"><?php echo MENU_POS; ?></option>
                    </select>
                </td>
