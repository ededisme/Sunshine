...
<script type="text/javascript">
    ...
    $(document).ready(function(){
        ...
        <?php echo $oTable; ?> = $("#<?php echo $tblName; ?>").dataTable({
            "bProcessing": true,
            "bServerSide": true,
            "sAjaxSource": "<?php echo $this->base.'/'.$this->params['controller']; ?>/productAgingAjax/<?php echo str_replace("/", "|||", implode(',', $_POST)); ?>",
        ...
        $("#<?php echo $btnExport; ?>").click(function(){
            window.open("<?php echo $this->webroot; ?>public/report/product_exp_aging_<?php echo $this->Session->id(session_id()); ?>.csv", "_blank");
        });
    });
</script>
<div id="<?php echo $printArea; ?>">
    <?php
    $msg = '<b style="font-size: 18px;">' . MENU_PRODUCT_AGING . '</b><br /><br />';
    if($_POST['company_id']!='') {
        ...
        <table id="<?php echo $tblName; ?>" class="table_report">
            <thead>
                <tr>
                    ...
                    <th style="width: 120px !important;"><?php echo TABLE_CREATED; ?></th>
                    <th style="width: 120px !important;"><?php echo REPORT_DAYS; ?></th>
                </tr>
            </thead>
            <tbody>
                <tr>
