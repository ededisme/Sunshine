 ...
 * export to excel
 */
$filename="public/report/inventory_adjustment_by_item_parent_" . $this->Session->id(session_id()) . ".csv";
...
<script type="text/javascript">
    $(document).ready(function(){
        ...
        $("#<?php echo $btnExport; ?>").click(function(){
            window.open("<?php echo $this->webroot; ?>public/report/inventory_adjustment_by_item_parent_<?php echo $this->Session->id(session_id()); ?>.csv", "_blank");
        });
    });
</script>
<div id="<?php echo $printArea; ?>">
    ...
    $excelContent .= TABLE_NO."\t".TABLE_NAME."\t".TABLE_REFERENCE."\t".TABLE_CREATED_BY."\t".TABLE_LOCATION."\t".TABLE_TOTAL_COST;
    ?>
    <table id="<?php echo $tblName; ?>" class="table_report">
        ...
        $query=mysql_query("SELECT
                                ...
                                (SELECT CONCAT_WS(' ',code,'-',name) FROM products WHERE id=(SELECT parent_id FROM products WHERE id=cycle_product_details.product_id)) AS parent_name,
                                product_id,
                            ...
                            WHERE "
                                ...
                                . "
                            ORDER BY parent_name,product_name,date") or die(mysql_error());
        ...
        ?>
            ...
            $data['unit_price']=($data['unit_price']*$dataProductUom['conversion']);
